...
public class DistilRecipes {
	...
	private DistilRecipes() {
		...
		addSmelting(Item.getItemFromBlock(TCBlocks.OIL_SAND), new ItemStack(ItemIDs.diesel.item, 2), 0.5F, 1, new ItemStack(ItemIDs.rawPlastic.item, 1));
		addSmelting(Item.getItemFromBlock(TCBlocks.PETROL_ORE), new ItemStack(ItemIDs.diesel.item, 2), 0.5F, 1, new ItemStack(ItemIDs.rawPlastic.item, 1));
