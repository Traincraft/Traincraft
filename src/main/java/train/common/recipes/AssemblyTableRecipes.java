...
public class AssemblyTableRecipes {
	...
	public static void recipes() {
		...
		NonNullList<ItemStack> s1 = OreDictionary.getOres("plankWood");
		NonNullList<ItemStack> s2 = OreDictionary.getOres("logWood");
		NonNullList<ItemStack> ingotSteel = OreDictionary.getOres("ingotSteel");
		NonNullList<ItemStack> dyeRed = OreDictionary.getOres("dyeRed"); //1
		NonNullList<ItemStack> dyeYellow = OreDictionary.getOres("dyeYellow"); //11
		NonNullList<ItemStack> dyeOrange = OreDictionary.getOres("dyeOrange");//14
		NonNullList<ItemStack> dyeGreen = OreDictionary.getOres("dyeGreen"); //2
		NonNullList<ItemStack> dyeBlue = OreDictionary.getOres("dyeBlue"); //4
		NonNullList<ItemStack> dyeBrown = OreDictionary.getOres("dyeBrown"); //3
		NonNullList<ItemStack> dyeGray = OreDictionary.getOres("dyeGray"); //3
		NonNullList<ItemStack> dyeLightGray = OreDictionary.getOres("dyeLightGray"); //7
		NonNullList<ItemStack> dyeBlack = OreDictionary.getOres("dyeBlack");
		NonNullList<ItemStack> dyeWhite = OreDictionary.getOres("dyeWhite");
		NonNullList<ItemStack> coal = NonNullList.create();
		coal.add(new ItemStack(Items.COAL));
		coal.addAll(OreDictionary.getOres("coal"));
		NonNullList<ItemStack> redstone = OreDictionary.getOres("dustRedstone");
		NonNullList<ItemStack> waterbucket = NonNullList.create();//waterContainers();
	...
	/*
	public static NonNullList<ItemStack> waterContainers(){
