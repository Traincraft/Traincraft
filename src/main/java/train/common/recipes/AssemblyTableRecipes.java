...
public class AssemblyTableRecipes {
	...
	public static void recipes() {
		// initialize these in the function because this only ever gets called on
		// startup, gives a lot of space for GC to do its job.
		...
		List<ItemStack> dyeLightBlue = OreDictionary.getOres("dyeLightBlue");
		...
		List<ItemStack> dyePurple = OreDictionary.getOres("dyePurple");
		List<ItemStack> dyeCyan = OreDictionary.getOres("dyeCyan");
		List<ItemStack> dyePink = OreDictionary.getOres("dyePink");
		List<ItemStack> dyeLime = OreDictionary.getOres("dyeLime");
		List<ItemStack> allCoal = OreDictionary.getOres("coal");
		...
		for (ItemStack k : ingotSteel) {
			...
			for (ItemStack coal : allCoal) {
				int coalDmg = getItemDmg(coal);
				cm.addRecipe(1, null, new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 1), new ItemStack(Items.stick, 2), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartTender.item, 1), 1);
			}
			...
			for (ItemStack iron : ingotIron) {
				for (ItemStack dye : dyeGreen) {
					for (ItemStack bucketWater : waterbucket) {
						cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(bucketWater.getItem(), 1, getItemDmg(bucketWater)), dye, new ItemStack(ItemIDs.minecartLocoBR80_DB.item, 1), 1);
					}
				}
				for (ItemStack dye : dyeBlack) {
					for (ItemStack coal : allCoal) {
						int coalDmg = getItemDmg(coal);
						cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 4), new ItemStack(ItemIDs.ironFrame.item, 4), new ItemStack(iron.getItem(), 4), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 3), new ItemStack(ItemIDs.ironFirebox.item, 2), new ItemStack(coal.getItem(), 2, coalDmg), dye, new ItemStack(ItemIDs.minecartShay3Truck.item, 1), 1);
						cm.addRecipe(1, new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 3), null, null, null, null, new ItemStack(coal.getItem(), 2, coalDmg), dye, new ItemStack(ItemIDs.minecartShay3TruckTender.item, 1), 1);
					}
				}
				for (ItemStack coal : allCoal) {
					int coalDmg = getItemDmg(coal);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoSteamShay.item, 1), 1);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 4), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.woodenCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 1), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartVBShay2.item, 1), 1);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 4), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 3), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 2), new ItemStack(coal.getItem(), 2, coalDmg), null, new ItemStack(ItemIDs.minecartClimaxNew.item, 1), 1);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 1), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartSlateWagon.item, 1), 1);

					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 1), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoAlcoSC4.item, 1), 1);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoC41.item, 1), 1);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 6), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoC41_080.item, 1), 1);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoC41T.item, 1), 1);
					cm.addRecipe(1, new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(coal.getItem(), 2, coalDmg), null, new ItemStack(ItemIDs.minecartTenderC41.item, 1), 1);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoC11.item, 1), 1);

					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoSouthern1102.item, 1), 1);
					for (ItemStack dye : dyeGray) {
						cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 1), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 1), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), dye, new ItemStack(ItemIDs.minecartLocoUSATCUS.item, 1), 1);
						cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 1), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 1), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), dye, new ItemStack(ItemIDs.minecartLocoUSATCUK.item, 1), 1);
					}
					cm.addRecipe(1, new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(coal.getItem(), 2, coalDmg), null, new ItemStack(ItemIDs.minecartTenderSouthern1102.item, 1), 1);
				}
			...
			for (ItemStack dye : dyeRed) {
				for (ItemStack coal : allCoal) {
					int coalDmg = getItemDmg(coal);
					cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 1), new ItemStack(Items.stick, 2), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), dye, new ItemStack(ItemIDs.minecartSteamRedTender.item, 1), 1);
					for (ItemStack iron : ingotIron) {
						cm.addRecipe(1, null, new ItemStack(ItemIDs.ironBogie.item, 3), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.ironCab.item, 1), new ItemStack(ItemIDs.ironBoiler.item, 2), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(coal.getItem(), 1, coalDmg), dye, new ItemStack(ItemIDs.minecartLocoForneyRed.item, 1), 1);
					}
				}
			...
			// cm.addRecipe(1, new ItemStack(Block.planks, 4), new
			// ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item,
			// 1), new ItemStack(ingotIron.getItem(), 1), null, new
			// ItemStack(ItemIDs.woodenCab.item, 1), null, new
			// ItemStack(ItemIDs.electmotor.item, 2), new ItemStack(Item.redstone, 4), null,
			// new ItemStack(ItemIDs.minecartTramWood.item, 1), 1);

			for (ItemStack plank : planks) {
				int plankDmg = getItemDmg(plank);

				for (ItemStack log : logs) {
					int logDmg = getItemDmg(log);
					cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), new ItemStack(Items.stick, 2), null, null, null, null, new ItemStack(log.getItem(), 1, logDmg), null, new ItemStack(ItemIDs.minecartWood.item, 1), 1);
					cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 1), new ItemStack(Items.stick, 4), null, null, null, null, new ItemStack(log.getItem(), 2, logDmg), null, new ItemStack(ItemIDs.minecartSkeletonLogCar.item, 1), 1);
				}
				for (ItemStack iron : ingotIron) {
					for (ItemStack dye : dyeGreen) {
						cm.addRecipe(1, new ItemStack(plank.getItem(), 8, plankDmg), new ItemStack(ItemIDs.woodenBogie.item, 3), new ItemStack(ItemIDs.woodenFrame.item, 2), new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.ironChimney.item, 1), null, new ItemStack(ItemIDs.ironBoiler.item, 1), new ItemStack(ItemIDs.ironFirebox.item, 1), new ItemStack(Items.gold_ingot, 2), dye, new ItemStack(ItemIDs.minecartLocoSteamAdler.item, 1), 1);
						for (ItemStack coal : allCoal) {
							int coalDmg = getItemDmg(coal);
							cm.addRecipe(1, new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 1), new ItemStack(iron.getItem(), 1), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), dye, new ItemStack(ItemIDs.minecartTenderAdler.item, 1), 1);
						}
					}
					...
					for (ItemStack dye : dyeBrown) {
						...
						for (ItemStack coal : allCoal) {
							int coalDmg = getItemDmg(coal);
							cm.addRecipe(1, new ItemStack(iron.getItem(), 2), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 1), new ItemStack(iron.getItem(), 1), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), dye, new ItemStack(ItemIDs.minecartStarClassTender.item, 1), 1);
						}
				...
				cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), new ItemStack(Items.stick, 2), null, new ItemStack(ItemIDs.woodenCab.item, 1), null, null, new ItemStack(ItemIDs.seats.item, 1), null, new ItemStack(ItemIDs.minecartPassenger2.item, 1), 1);
				cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), new ItemStack(Items.stick, 2), null, new ItemStack(ItemIDs.woodenCab.item, 1), null, null, new ItemStack(ItemIDs.seats.item, 1), null, new ItemStack(ItemIDs.minecartCaboose.item, 1), 1);
				cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), new ItemStack(Items.stick, 2), null, null, null, null, new ItemStack(Blocks.chest, 1), null, new ItemStack(ItemIDs.minecartFreightCartSmall.item, 1), 1);
				cm.addRecipe(1, new ItemStack(plank.getItem(), 3, plankDmg), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), new ItemStack(Items.stick, 2), null, null, null, null, null, null, new ItemStack(ItemIDs.minecartFlatCart.item, 1), 1);
				for (ItemStack iron : ingotIron) {
					cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 2), null, new ItemStack(ItemIDs.minecartChest.item, 1), 1);
					cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 2), null, new ItemStack(ItemIDs.minecartFreightCart2.item, 1), 1);
					cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.hopper, 2), null, new ItemStack(ItemIDs.minecartFreightCartUS.item, 1), 1);
					for (ItemStack dye : dyeBrown) {
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 2), dye, new ItemStack(ItemIDs.minecart40highcube.item, 1), 1);
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 2), dye, new ItemStack(ItemIDs.minecartMILW40boxcar.item, 1), 1);
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 2), dye, new ItemStack(ItemIDs.minecartPS140.item, 1), 1);
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.hopper, 1), null, new ItemStack(ItemIDs.minecartOreJenny.item, 1), 1);
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 2), dye, new ItemStack(ItemIDs.minecartWWCP40FootBox.item, 1), 1);
					}
					for (ItemStack dye : dyeWhite) {
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 2), dye, new ItemStack(ItemIDs.minecartPS150.item, 1), 1);
					}
					for (ItemStack dye : dyeBlue) {
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 3), dye, new ItemStack(ItemIDs.minecartPS160.item, 1), 1);
					}
					/*
					 * for (ItemStack dye : dyeCyan) { cm.addRecipe(1, new
					 * ItemStack(plank.getItem(), 6, plankDmg), new
					 * ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item,
					 * 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new
					 * ItemStack(Blocks.chest, 4), dye, new
					 * ItemStack(ItemIDs.minecartOWO60Verticube.item, 1), 1); }
					 */
					cm.addRecipe(1, new ItemStack(plank.getItem(), 4, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 4), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.chest, 1), null, new ItemStack(ItemIDs.minecartFreightClosed.item, 1), 1);
					cm.addRecipe(1, new ItemStack(plank.getItem(), 2, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.hopper, 2), null, new ItemStack(ItemIDs.minecartFreightOpen2.item, 1), 1);
					cm.addRecipe(1, new ItemStack(plank.getItem(), 2, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 2), null, new ItemStack(ItemIDs.woodenCab.item, 1), null, null, new ItemStack(ItemIDs.seats.item, 1), null, new ItemStack(ItemIDs.minecartCaboose3.item, 1), 1);
					...
					for (ItemStack rs : redstone) {
						cm.addRecipe(1, new ItemStack(plank.getItem(), 4, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 1), new ItemStack(iron.getItem(), 1), null, new ItemStack(ItemIDs.woodenCab.item, 1), new ItemStack(ItemIDs.transformer.item, 1), new ItemStack(ItemIDs.electmotor.item, 2), new ItemStack(rs.getItem(), 4), null, new ItemStack(ItemIDs.minecartTramWood.item, 1), 1);
					}
					for (ItemStack dye : dyeRed) {
						cm.addRecipe(1, new ItemStack(plank.getItem(), 3, plankDmg), new ItemStack(ItemIDs.woodenBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), new ItemStack(iron.getItem(), 1), null, null, null, null, new ItemStack(Blocks.crafting_table, 1), dye, new ItemStack(ItemIDs.minecartCabooseLogging.item, 1), 1);
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 2), new ItemStack(iron.getItem(), 4), null, null, null, null, new ItemStack(Blocks.hopper, 4), null, new ItemStack(ItemIDs.minecartWoodchipHopper.item, 1), 1);
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 3), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.hopper, 3), null, new ItemStack(ItemIDs.minecartMillGondola.item, 1), 1);
					}
					for (ItemStack dye : dyeBlack) {
						cm.addRecipe(1, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 3), new ItemStack(iron.getItem(), 2), null, null, null, null, new ItemStack(Blocks.hopper, 3), null, new ItemStack(ItemIDs.minecartBNSFGon.item, 1), 1);
					}

				}
				cm.addRecipe(1, new ItemStack(Blocks.crafting_table, 1), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 1), new ItemStack(plank.getItem(), 8, plankDmg), null, new ItemStack(ItemIDs.woodenCab.item, 1), null, null, new ItemStack(Blocks.furnace, 1), null, new ItemStack(ItemIDs.minecartGWRBrakeVan.item, 1), 1);
				cm.addRecipe(1, new ItemStack(plank.getItem(), 2, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), null, new ItemStack(ItemIDs.ironChimney.item, 1), new ItemStack(ItemIDs.woodenCab.item, 1), new ItemStack(ItemIDs.boiler.item, 1), new ItemStack(ItemIDs.firebox.item, 1), null, new ItemStack(plank.getItem(), 4, plankDmg), new ItemStack(ItemIDs.minecartLocoSteamVBShay.item, 1), 1);
				...
				cm.addRecipe(1, new ItemStack(plank.getItem(), 2, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), null, null, null, null, null, new ItemStack(Items.painting, 2), null, new ItemStack(ItemIDs.minecartPropagandaUs.item, 1), 1);
				cm.addRecipe(1, new ItemStack(plank.getItem(), 2, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), null, null, null, null, null, new ItemStack(Items.painting, 2), null, new ItemStack(ItemIDs.minecartPropagandaUSSR.item, 1), 1);
				cm.addRecipe(1, new ItemStack(plank.getItem(), 2, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), null, null, null, null, null, new ItemStack(Items.painting, 2), null, new ItemStack(ItemIDs.minecartPropagandaBritish.item, 1), 1);
				cm.addRecipe(1, new ItemStack(plank.getItem(), 2, plankDmg), new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), null, null, null, null, null, new ItemStack(Items.painting, 2), null, new ItemStack(ItemIDs.minecartPropagandaJapan.item, 1), 1);
			}
			...
			for (ItemStack dye : dyeYellow) {
				...
				// =================== TIER II ==================//
				for (ItemStack bucketWater : waterbucket) {
					cm.addRecipe(2, new ItemStack(itemSteel, 6, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(bucketWater.getItem(), 1, getItemDmg(bucketWater)), dye, new ItemStack(ItemIDs.minecartTankWagon.item, 1), 1);
				}
			}
			...
			for (ItemStack dye : dyeGreen) {
				cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 1, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 2), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.boiler.item, 2), new ItemStack(ItemIDs.firebox.item, 2), null, dye, new ItemStack(ItemIDs.minecartLocoHallClass.item, 1), 1);
				cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 2), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.boiler.item, 3), new ItemStack(ItemIDs.firebox.item, 2), null, dye, new ItemStack(ItemIDs.minecartLocoKingClass.item, 1), 1);
				...
				for (ItemStack bucketWater : waterbucket) {
					cm.addRecipe(2, new ItemStack(itemSteel, 4, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 4, itemDamageSteel), null, null, null, null, new ItemStack(bucketWater.getItem(), 1, getItemDmg(bucketWater)), dye, new ItemStack(ItemIDs.minecartTankWagonThreeDome.item, 1), 1);
				}
			...
			for (ItemStack dye : dyeBlue) {
				...
				cm.addRecipe(2, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 1), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.electmotor.item, 4), new ItemStack(ItemIDs.dieselengine.item, 4), new ItemStack(ItemIDs.generator.item, 2), dye, new ItemStack(ItemIDs.minecartLocoEWSClass66.item, 1), 1);
				cm.addRecipe(2, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 1), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.electmotor.item, 4), new ItemStack(ItemIDs.dieselengine.item, 4), new ItemStack(ItemIDs.generator.item, 2), dye, new ItemStack(ItemIDs.minecartClass44.item, 1), 1);
				...
				cm.addRecipe(2, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 1), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.electmotor.item, 4), new ItemStack(ItemIDs.dieselengine.item, 4), new ItemStack(ItemIDs.generator.item, 3), dye, new ItemStack(ItemIDs.minecartLocoDeltic.item, 1), 1);
			...
			for (ItemStack dye : dyeRed) {
				...
				for (ItemStack coal : allCoal) {
					int coalDmg = getItemDmg(coal);
					cm.addRecipe(2, new ItemStack(itemSteel, 4, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), dye, new ItemStack(ItemIDs.minecartTenderBR01_DB.item, 1), 1);
				}
				cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 2), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.boiler.item, 3), new ItemStack(ItemIDs.firebox.item, 2), null, dye, new ItemStack(ItemIDs.minecartLocoCoranationClass.item, 1), 1);
			}
			for (ItemStack dye : dyeOrange) {
			...
			for (ItemStack dye : dyeBlack) {
				...
				cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 4), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 2), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.boiler.item, 3), new ItemStack(ItemIDs.firebox.item, 3), null, dye, new ItemStack(ItemIDs.minecartLocoBerk1225.item, 1), 1);
				cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 4), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 2), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.boiler.item, 3), new ItemStack(ItemIDs.firebox.item, 3), null, dye, new ItemStack(ItemIDs.minecartLocoBerk765.item, 1), 1);
				cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 4), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 2), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.boiler.item, 3), new ItemStack(ItemIDs.firebox.item, 3), null, dye, new ItemStack(ItemIDs.minecartLocoFowler.item, 1), 1);
				...
				cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 1), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.boiler.item, 1), new ItemStack(ItemIDs.firebox.item, 2), null, dye, new ItemStack(ItemIDs.minecartOnion.item, 1), 1);
				...
				cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 4), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.steelchimney.item, 2), new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.boiler.item, 3), new ItemStack(ItemIDs.firebox.item, 3), null, dye, new ItemStack(ItemIDs.minecartPELocomotive.item, 1), 1);
				for (ItemStack coal : allCoal) {
					int coalDmg = getItemDmg(coal);
					cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 4), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 2, coalDmg), dye, new ItemStack(ItemIDs.minecarttenderBerk1225.item, 1), 1);
					cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 2, coalDmg), dye, new ItemStack(ItemIDs.minecartFowler4FTender.item, 1), 1);
					cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), dye, new ItemStack(ItemIDs.minecartOnionTender.item, 1), 1);
					cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 4), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 2, coalDmg), dye, new ItemStack(ItemIDs.minecartPETender.item, 1), 1);
				}
			...
			for (ItemStack coal : allCoal) {
				int coalDmg = getItemDmg(coal);
				cm.addRecipe(2, new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 1), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartTenderD51.item, 1), 1);
			}
			// cm.addRecipe(2, null, new ItemStack(ItemIDs.bogie.item, 3), new
			// ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2), new
			// ItemStack(ItemIDs.steelchimney.item, 1), new ItemStack(ItemIDs.steelcab.item,
			// 1), new ItemStack(ItemIDs.boiler.item, 4), new
			// ItemStack(ItemIDs.firebox.item, 2), null, null, new
			// ItemStack(ItemIDs.minecartLoco4.item, 1), 1);
			...
			for (ItemStack dye : dyeGray) {
				...
				for (ItemStack bucketWater : waterbucket) {
					cm.addRecipe(2, new ItemStack(itemSteel, 6, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(bucketWater.getItem(), 1, getItemDmg(bucketWater)), dye, new ItemStack(ItemIDs.minecartTankWagon2.item, 1), 1);
				}
			}
			for (ItemStack dye : dyeOrange) {
			...
			for (ItemStack bucketWater : waterbucket) {
				cm.addRecipe(2, new ItemStack(itemSteel, 6, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(bucketWater.getItem(), 1, getItemDmg(bucketWater)), null, new ItemStack(ItemIDs.minecartTankWagonUS.item, 1), 1);
				for (ItemStack dye : dyeBlack) {
			...
			for (ItemStack coal : allCoal) {
				int coalDmg = getItemDmg(coal);
				cm.addRecipe(2, new ItemStack(itemSteel, 6, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 2, coalDmg), null, new ItemStack(ItemIDs.minecartTenderC62Class.item, 1), 1);
			}
			for (ItemStack dye : dyeBrown) {
			...
			for (ItemStack coal : allCoal) {
				int coalDmg = getItemDmg(coal);
				cm.addRecipe(2, new ItemStack(itemSteel, 6, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartTenderEr.item, 1), 1);
			}
			for (ItemStack coal : allCoal) {
				int coalDmg = getItemDmg(coal);
				cm.addRecipe(2, new ItemStack(itemSteel, 6, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoCoranationClassTender.item, 1), 1);
			}
			for (ItemStack coal : allCoal) {
				int coalDmg = getItemDmg(coal);
				cm.addRecipe(2, new ItemStack(itemSteel, 6, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 3), new ItemStack(ItemIDs.steelframe.item, 3), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecart4000GallonTender.item, 1), 1);
			}
			for (ItemStack coal : allCoal) {
				int coalDmg = getItemDmg(coal);
				cm.addRecipe(2, new ItemStack(itemSteel, 4, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartTenderHeavy.item, 1), 1);
				cm.addRecipe(2, new ItemStack(itemSteel, 4, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 4), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartSkookTender.item, 1), 1);
			...
			for (ItemStack coal : allCoal) {
				int coalDmg = getItemDmg(coal);
				cm.addRecipe(2, null, new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(Items.iron_ingot, 1), null, null, null, null, new ItemStack(coal.getItem(), 1, coalDmg), null, new ItemStack(ItemIDs.minecartLocoA4MallardTender.item, 1), 1);
			}
			...
			for (ItemStack plank : planks) {
				...
				for (ItemStack log : logs) {
					int logDmg = getItemDmg(log);
					for (ItemStack iron : ingotIron) {
						cm.addRecipe(2, new ItemStack(plank.getItem(), 3, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.ironFrame.item, 1), new ItemStack(iron.getItem(), 2, iron.getItemDamage()), null, null, null, null, new ItemStack(log.getItem(), 1, logDmg), null, new ItemStack(ItemIDs.minecartFreightWood2.item, 1), 1);
					}
				}
				cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(plank.getItem(), 1, plankDmg), null, new ItemStack(ItemIDs.minecartFreightCenterBeam_Wood_1.item, 1), 1);
				cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, null, null, new ItemStack(ItemIDs.minecartFlatCartWoodUS.item, 1), 1);
				cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(plank.getItem(), 1, plankDmg), null, new ItemStack(ItemIDs.minecartFreightCenterBeam_Wood_2.item, 1), 1);
				cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(plank.getItem(), 1, plankDmg), null, new ItemStack(ItemIDs.minecartFreightCenterBeam_Empty.item, 1), 1);

				for (ItemStack dye : dyeRed) {
					cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(Blocks.crafting_table, 1), dye, new ItemStack(ItemIDs.minecartCabooseWork.item, 1), 1);
					...
					cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 6), new ItemStack(ItemIDs.steelframe.item, 6), new ItemStack(itemSteel, 8, itemDamageSteel), null, new ItemStack(ItemIDs.steelcab.item, 4), null, null, new ItemStack(Blocks.crafting_table, 1), dye, new ItemStack(ItemIDs.minecartLightCrane.item, 1), 1);
				}
				cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.woodenFrame.item, 2), new ItemStack(Items.stick, 2), null, new ItemStack(ItemIDs.woodenCab.item, 1), null, null, new ItemStack(ItemIDs.seats.item, 1), null, new ItemStack(ItemIDs.minecartPassengerDBOriental.item, 1), 1);

				cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(Items.leather, 1), null, new ItemStack(ItemIDs.minecartStockCar.item, 1), 1);
				cm.addRecipe(2, new ItemStack(plank.getItem(), 6, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(Items.leather, 1), null, new ItemStack(ItemIDs.minecartDRWGStockCar.item, 1), 1);
				cm.addRecipe(2, new ItemStack(plank.getItem(), 3, plankDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, null, null, new ItemStack(ItemIDs.minecartFlatCartUS.item, 1), 1);
			...
			for (ItemStack dye : dyeRed) {
				...
				cm.addRecipe(3, new ItemStack(itemSteel, 2, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, new ItemStack(ItemIDs.steelcab.item, 1), null, new ItemStack(ItemIDs.seats.item, 4), null, dye, new ItemStack(ItemIDs.minecartSNCB_M6_TAIL.item, 1), 1);
				...
				for (ItemStack rs : redstone) {
					cm.addRecipe(3, new ItemStack(ItemIDs.controls.item, 2), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), null, null, new ItemStack(ItemIDs.steelcab.item, 1), new ItemStack(ItemIDs.transformer.item, 2), new ItemStack(ItemIDs.electmotor.item, 2), new ItemStack(rs.getItem(), 4), dye, new ItemStack(ItemIDs.minecartLocoBR185.item, 1), 1);
				...
				cm.addRecipe(3, new ItemStack(itemSteel, 5, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(Blocks.crafting_table, 1), dye, new ItemStack(ItemIDs.minecartCabooseLoggingPRR.item, 1), 1);
			...
			for (ItemStack dye : dyeOrange) {
				...
				for (ItemStack coal : allCoal) {
					int coalDmg = getItemDmg(coal);
					cm.addRecipe(3, new ItemStack(coal.getItem(), 2, coalDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 1), null, null, null, null, null, null, dye, new ItemStack(ItemIDs.minecartGS4_Tender.item, 1), 1);
				}
				...
				for (ItemStack coal : allCoal) {
					int coalDmg = getItemDmg(coal);
					cm.addRecipe(3, new ItemStack(coal.getItem(), 2, coalDmg), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 1), null, null, null, null, null, null, dye, new ItemStack(ItemIDs.minecartMILWTender.item, 1), 1);
				}
			...
			// cm.addRecipe(3, new ItemStack(ItemIDs.controls.item,3), new
			// ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 1),
			// new ItemStack(itemSteel, 1), null, new ItemStack(ItemIDs.steelcab.item, 1),
			// new ItemStack(ItemIDs.transformer.item,4), new
			// ItemStack(ItemIDs.electmotor.item, 4), new ItemStack(Item.redstone, 4), new
			// ItemStack(Items.dye, 1, 8), new
			// ItemStack(ItemIDs.minecartNewHighSpeedLoco.item, 1), 1);

			/*
			 * cm.addRecipe(3, null, new ItemStack(ItemIDs.ironBogie.item, 2), new
			 * ItemStack(ItemIDs.steelframe.item, 1), new ItemStack(itemSteel, 3), null,
			 * null, null, new ItemStack(ItemIDs.seats.item, 8), null, null, new
			 * ItemStack(ItemIDs.minecartIC4_DSB_FG.item, 1), 1); cm.addRecipe(3, null, new
			 * ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.steelframe.item,
			 * 1), new ItemStack(itemSteel, 3), null, null, null, new
			 * ItemStack(ItemIDs.seats.item, 8), null, null, new
			 * ItemStack(ItemIDs.minecartIC4_DSB_FH.item, 1), 1); cm.addRecipe(3, new
			 * ItemStack(ItemIDs.controls.item, 1), new ItemStack(ItemIDs.ironBogie.item,
			 * 2), new ItemStack(ItemIDs.steelframe.item, 1), new ItemStack(itemSteel, 3),
			 * null, new ItemStack(ItemIDs.steelcab.item, 1), new
			 * ItemStack(ItemIDs.electmotor.item, 6), new
			 * ItemStack(ItemIDs.dieselengine.item, 6), new
			 * ItemStack(ItemIDs.generator.item, 4), null, new
			 * ItemStack(ItemIDs.minecartIC4_DSB_MG.item, 1), 1);
			 */
			cm.addRecipe(3, null, new ItemStack(ItemIDs.ironBogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 1), new ItemStack(itemSteel, 3), null, null, null, new ItemStack(ItemIDs.seats.item, 8), null, null, new ItemStack(ItemIDs.minecartClass158car.item, 1), 1);
			...
			for (ItemStack dye : dyeBlue) {
				...
				for (ItemStack bucketWater : waterbucket) {
					cm.addRecipe(3, new ItemStack(itemSteel, 5, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(bucketWater.getItem(), 1, getItemDmg(bucketWater)), dye, new ItemStack(ItemIDs.minecartTankWagon_DB.item, 1), 1);
				}
				for (ItemStack rs : redstone) {
			...
			for (ItemStack log : logs) {
				int logDmg = getItemDmg(log);
				cm.addRecipe(3, new ItemStack(itemSteel, 5, itemDamageSteel), new ItemStack(ItemIDs.bogie.item, 2), new ItemStack(ItemIDs.steelframe.item, 2), new ItemStack(itemSteel, 2, itemDamageSteel), null, null, null, null, new ItemStack(log.getItem(), 1, logDmg), null, new ItemStack(ItemIDs.minecartFlatCartLogs_DB.item, 1), 1);
			}
			for (ItemStack dye : dyeGray) {
	...
	private static int getItemDmg(ItemStack pItem) {
