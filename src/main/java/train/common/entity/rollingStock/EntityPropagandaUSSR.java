...
public class EntityPropagandaUSSR extends GenericRailTransport {
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/propaganda_USSR_Blue.png","Blue", description));
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/propaganda_USSR_White.png","White", description));
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/propaganda_USSR_Red.png","Red", description));
    }
    @Override
