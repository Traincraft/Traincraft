...
public class EntityFreightASTFAutorack extends GenericRailTransport {
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/astf_autorack.png","astf_autorack", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{2.174999952316284f,2.1f,1.1f};}
    @Override
