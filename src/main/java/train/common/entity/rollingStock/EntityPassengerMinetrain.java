...
public class EntityPassengerMinetrain extends EntityRollingStock implements IPassenger {

	public EntityPassengerMinetrain(World world) {
		super(world);
	}

	public EntityPassengerMinetrain(World world, double d, double d1, double d2) {
		this(world);
