...
public class EntityCaboose3 extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelCaboose3()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/caboose3.png","caboose3", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{0.6499999761581421f,2.1f,1.1f};}
    @Override
