...
public class EntityTenderEr_Ussr extends GenericRailTransport {
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/tenderEr_Ussr.png","tenderEr_Ussr", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{0.8349999785423279f,2.1f,1.1f};}
    @Override
