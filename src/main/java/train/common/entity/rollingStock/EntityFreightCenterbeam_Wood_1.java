...
public class EntityFreightCenterbeam_Wood_1 extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelFreightCenterBeam_Wood_1()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/freight_centerbeam_wood_1.png","freight_centerbeam_wood_1", description));
    }
    @Override
