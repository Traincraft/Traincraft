...
public class EntityFreightKClassRailBox extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelKClassRailBox()};}
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{0.862500011920929f,2.1f,1.1f};}
    @Override
