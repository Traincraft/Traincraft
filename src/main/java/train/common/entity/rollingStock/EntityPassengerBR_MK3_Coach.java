...
public class EntityPassengerBR_MK3_Coach extends EntityRollingStock implements IPassenger {
    ...
    public EntityPassengerBR_MK3_Coach(World world, double d, double d1, double d2){
        this(world);
