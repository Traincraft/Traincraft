...
public class EntityFlatCarLogs_DB extends GenericRailTransport {
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/flatCarLogs_DB_Red.png","Red", description));
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/flatCarLogs_DB_Green.png","Green", description));
    }
    @Override
