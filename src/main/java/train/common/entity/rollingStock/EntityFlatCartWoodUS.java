...
public class EntityFlatCartWoodUS extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelFlatCarWoodUS()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/flatCartWoodUS.png","flatCartWoodUS", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{0.8700000047683716f,2.1f,1.1f};}
    @Override
