...
public class EntityPassenger81717_Passenger extends EntityRollingStock implements IPassenger {

	public EntityPassenger81717_Passenger(World world) {
		super(world);
	}

	public EntityPassenger81717_Passenger(World world, double d, double d1, double d2) {
		this(world);
