...
public class EntityElectricBR_MK3_DVT extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricBR_MK3_DVT(World world) {
        super(world);

    }

    public EntityElectricBR_MK3_DVT(World world, double d, double d1, double d2) {
        this(world);
