...
public class EntityPassengerHighSpeedCarZeroED extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelPassengerHighSpeedCarZeroED()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/passengerHighSpeedCarZeroED.png","passengerHighSpeedCarZeroED", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{1.0850000381469727f,2.1f,1.1f};}
    @Override
