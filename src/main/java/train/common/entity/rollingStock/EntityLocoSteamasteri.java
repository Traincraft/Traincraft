...
public class EntityLocoSteamasteri extends SteamTrain {
	public EntityLocoSteamasteri(World world) {
	...
	public EntityLocoSteamasteri(World world, double d, double d1, double d2) {
		this(world);
