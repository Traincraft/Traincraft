...
public class EntityGWRBrakeVan extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelGWRBrakeVan()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/GWRBrakeVan.png","GWRBrakeVan", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{1.7000000476837158f,2.1f,1.1f};}
    @Override
