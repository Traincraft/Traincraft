...
public class EntityFreightBaggageMILW extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelMILWBaggage()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/milw_baggage.png","milw_baggage", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{1.337499976158142f,2.1f,1.1f};}
    @Override
