...
public class EntityTenderCoranationClass extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelCoranationClassTender()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/CoranationClassTender.png","CoranationClassTender", description));
    }
    @Override
