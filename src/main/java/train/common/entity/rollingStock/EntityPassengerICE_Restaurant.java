...
public class EntityPassengerICE_Restaurant extends GenericRailTransport {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelICE1Restaurant()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/ICE1_Restaurant.png","ICE1_Restaurant", description));
    }
    @Override
