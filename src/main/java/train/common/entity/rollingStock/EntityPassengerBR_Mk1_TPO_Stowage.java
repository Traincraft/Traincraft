...
public class EntityPassengerBR_Mk1_TPO_Stowage extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerBR_Mk1_TPO_Stowage(World world) {
        super(world);
    }

    public EntityPassengerBR_Mk1_TPO_Stowage(World world, double d, double d1, double d2){
        this(world);
