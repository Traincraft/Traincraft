...
public class EntityLocoSteamFowler extends EntityTrainCore {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelFowler()};}
    @Override
    public float[][] modelOffsets(){return new float[][]{{-3.0f, -0.51585f, 0.0f}};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/loco_Fowler.png","loco_Fowler", description));
    }
    @Override
    ...
    @Override
    public float[] bogieLengthFromCenter() {return new float[]{-1.625f, 1.625f};}
