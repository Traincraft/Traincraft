...
public class EntityLocoSteamGLYN042T extends EntityTrainCore {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.Model042TGLYN()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/0-4-2-loco-glyn.png","0-4-2-loco-glyn", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-2.050000011920929f,2.1f,1.1f};}
    @Override
