...
public class EntityLocoSteamUSATCUS extends EntityTrainCore {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelUSATCUS()};}
    @Override
    public float[][] modelOffsets(){return new float[][]{{-2.0f, -0.25f, 0.8375f}};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/USATCUS.png","USATCUS", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-2.175000011920929f,2.1f,1.1f};}
    @Override
