...
public class EntityLocoSteamVBShay extends EntityTrainCore {
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/vbshay.png","vbshay", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{0.6375000476837158f,2.1f,1.1f};}
    @Override
    public float[] bogieLengthFromCenter() {return new float[]{-0.25f, 0.25f};}
