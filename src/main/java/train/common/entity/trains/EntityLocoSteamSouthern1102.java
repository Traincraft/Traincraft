...
public class EntityLocoSteamSouthern1102 extends EntityTrainCore {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelSouthern1102()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/Southern1102.png","Southern1102", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-3.075000011920929f,2.1f,1.1f};}
    @Override
