...
public class EntityLocoElectricE103 extends EntityTrainCore {
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{-2.0f, 0.05f, 0.0f}};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/E103_Red.png","Red", description));
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/E103_Blue.png","Blue", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-3.1024999976158143f,2.1f,1.1f};}
    @Override
