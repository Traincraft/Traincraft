...
public class EntityLocoSteamMILWClassA extends EntityTrainCore {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelMILWClassA()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/locoMILW_ClassA.png","locoMILW_ClassA", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-4.0999999940395355f,2.1f,1.1f};}
    @Override
