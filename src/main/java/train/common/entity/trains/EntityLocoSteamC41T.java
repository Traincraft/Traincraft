...
public class EntityLocoSteamC41T extends EntityTrainCore {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelLocoC41T()};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/locoC41t.png","locoC41t", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-3.0500000059604644f,2.1f,1.1f};}
    @Override
