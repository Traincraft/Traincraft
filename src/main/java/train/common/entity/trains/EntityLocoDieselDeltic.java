...
public class EntityLocoDieselDeltic extends EntityTrainCore {
    ...
    //Model stuff
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new train.client.render.models.ModelDeltic()};}
    @Override
    public float[][] modelOffsets(){return new float[][]{{-2.25f, 0.8f, 0.0f}};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/Deltic.png","Deltic", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-3.95f,2.1f,1.1f};}
    @Override
