...
public class EntityRotativeWheel extends Entity {
    ...
    public EntityRotativeWheel(World world) {
        ...
        this.dataWatcher.addObject(21, startWheel);
    }

    /**
     * @param world world
     * @param entity entity
     * @param numSeat seat id
     * @param x seat x
     * @param y seat y
     * @param z seat z
     * @param riderOffset rider offset
     */
    ...
    public void onUpdate() {
        ...
        if (worldObj.isRemote) {
            if (field_9394_d > 0) {
                ...
                rotationYaw += (float) (d12 / (double) field_9394_d);
                rotationPitch += (float) ((field_9389_i - (double) rotationPitch) / (double) field_9394_d);
                field_9394_d--;
