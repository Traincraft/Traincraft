...
public class TileTCRail extends TileEntity {
	...
	public void updateEntity() {
		...
		if (!getSwitchState() && updateTicks2 % 10 ==0) {
			...
			if (isLeftFlag == -5) {
				if (ItemTCRail.TrackTypes.MEDIUM_RIGHT_SWITCH.getLabel().equals(type) || ItemTCRail.TrackTypes.LARGE_RIGHT_SWITCH.getLabel().equals(type) || ItemTCRail.TrackTypes.MEDIUM_RIGHT_PARALLEL_SWITCH.getLabel().equals(type) || ItemTCRail.TrackTypes.VERY_LARGE_SWITCH.getLabel().equals(type) ){
					isLeftFlag =1;
				} else if (ItemTCRail.TrackTypes.MEDIUM_LEFT_SWITCH.getLabel().equals(type) || ItemTCRail.TrackTypes.LARGE_LEFT_SWITCH.getLabel().equals(type) || ItemTCRail.TrackTypes.MEDIUM_LEFT_PARALLEL_SWITCH.getLabel().equals(type) || ItemTCRail.TrackTypes.VERY_LARGE_SWITCH.getLabel().equals(type) ){
					isLeftFlag = -1;
				} else {
					isLeftFlag=0;
				}
				...
				if (tileEntity.getBlockMetadata() == 2) {
					...
					if (te1 != null) {
						if (tileEntity.getType().equals(ItemTCRail.TrackTypes.MEDIUM_LEFT_SWITCH.getLabel())) {
							...
							((TileTCRail) te1).setType(ItemTCRail.TrackTypes.VERY_LARGE_LEFT_SWITCH.getLabel());
							TileEntity te2 = world.getTileEntity(i, j, k - 2);
							...
							((TileTCRail) te1).setType(ItemTCRail.TrackTypes.VERY_LARGE_RIGHT_SWITCH.getLabel());
							TileEntity te2 = world.getTileEntity(i, j, k - 2);
