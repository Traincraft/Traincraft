...
public enum EnumTrains {
	...
	passengerGS4("Passenger GS4",EntityPassengerGS4.class,ItemIDs.minecartGS4_Passenger.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White"},10,0),
	passengerGS4Observatory("Passenger GS4 Observatory",EntityPassengerGS4_Observatory.class,ItemIDs.minecartGS4_Observatory.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White"},10,0),
	passengerGS4_Tail("Passenger GS4 Tail",EntityPassengerGS4_Tail.class,ItemIDs.minecartGS4_Tail.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White"},10,0),
	...
	freightCartGS4("Freight Cart GS4 Baggage",EntityFreightGS4_Baggage.class,ItemIDs.minecartGS4_Baggage.item,"freight",1,new String[]{"Orange", "White"},18,45,new String[] {"Cargo: any"}),
	...
	locoDieselGP7Red("Loco Diesel GP7",EntityLocoDieselGP7Red.class, ItemIDs.minecartGP7Red.item,"diesel",1520,112,0,50,0,200,0.74,0.96,20000,new String[] {"Red","Blue","Black","Yellow", "Grey", "Cyan", "Pink", "LightGrey", "Green", "White"},15,-1.4),
	...
	locoDieselE10DB("Loco Diesel E10 DB",EntityLocoDieselE10_DB.class, ItemIDs.minecartE10_DB.item,"diesel",648,60,0,60,0,170,0.66,0.96,8000,new String[] {"Blue","Red", "Grey"},15,-3.6),
	...
	locoElectricBR185("Loco Electric BR 185", EntityLocoElectricBR185.class, ItemIDs.minecartLocoBR185.item,
			"electric", 7604, 140, 0, 10, 0, 170, 0.7, 0.965, 0, new String[]{"Red", "Blue", "Magenta"}, 18, -5),
	...
	locoSteamCoranationClass("Loco Steam Coranation Class", EntityLocoSteamCoranationClass.class,
			...
			-6),
	locoSteamGS4("Loco Steam GS4", EntityLocoSteamGS4.class,  ItemIDs.minecartGS4_Loco.item, "steam", 800, 170, 0, 60, 350, 450, 0.6, 0.95, 88000, new String[]{"Orange", "White"}, 10, -6 ),
