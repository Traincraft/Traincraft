...
public enum EnumTrains {
	...
	Class345("Class 345 Engine", EntityElectricClass345.class, ItemIDs.minecartClass345engine.item, "electric", 600, 145, 0,10, 0, 100, 0.9, 0.9, 1000,TraincraftUtil.getBytesFromColors(new String[]{"White", "Red", "Orange", "Pink"}), 18, -3, "Pack: B.I.P."),
	...
	BR_MK2F_BSO("BR_MK2F_BSO", EntityPassengerBR_MK2F_BSO.class, ItemIDs.minecartBR_Mk2f_BSO.item, "passenger",0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Brown", "Cyan", "Grey", "Magenta", "Red", "Lime", "Purple"}),0, 0, "Pack: B.I.P."),
	BR_MK2F_Coach("BR_MK2F_Coach", EntityPassengerBR_MK2F_Coach.class, ItemIDs.minecartBR_MK2F_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Brown", "Cyan", "Grey", "Magenta", "Red","Orange", "LightBlue", "Green",  "White", "Black", "LightGrey", "Yellow", "Lime", "Pink", "Purple"}),0, 0, "Pack: B.I.P."),
	BR_MK2F_DBSO("BR_MK2F_DBSO", EntityElectricBR_MK2F_DBSO.class, ItemIDs.minecartBR_Mk2f_DBSO.item, "electric", 1400, 161, 3.3, 60,0,0, 0.8, 0.8, 0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Grey", "LightBlue", "Purple", "Yellow"}), 18, -4.03, "Pack: B.I.P."),
