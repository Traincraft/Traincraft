...
public enum EnumTrains {
	...
	BUnitEMDF7("EMD F7 B Unit", EntityBUnitEMDF7.class, ItemIDs.minecartLocoEMDF7B.item, "b-unit", 0, 0, 15, 0,
			0,
			0, 0, 0, 12000, new String[] { "Grey", "Black" }, 18, 0,
			new String[] { "Reduces weight carried by 80 tons when fueled" }),
	BUnitEMDF3("EMD F3 B Unit", EntityBUnitEMDF3.class, ItemIDs.minecartLocoEMDF3B.item, "b-unit", 0, 0, 15, 0,
			0,
			0, 0, 0, 12000, new String[]{"Yellow", "Black"}, 18, 0,
			new String[] { "Reduces weight carried by 80 tons when fueled" }),
	BUnitDD35("DD35 B Unit", EntityBUnitDD35.class, ItemIDs.minecartLocoDD35B.item, "b-unit", 0, 0, 20, 0, 0, 0, 0, 0,
	...
	locoDieselEMDF7("Loco Diesel EMD F-7", EntityLocoDieselEMDF7.class, ItemIDs.minecartLocoEMDF7.item, "diesel",
			1520, 169, 0, 50, 0, 200, 0.8, 0.97, 12000, new String[] { "Grey", "Black" }, 10, -2.4),
