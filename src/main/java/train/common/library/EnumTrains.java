...
public enum EnumTrains {
	...
	Class158("Class 158 Engine", EntityLocoDieselClass158.class, ItemIDs.minecartClass158engine.item, "diesel", 350, 145, 3,10, 0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Green", "Cyan", "Blue", "Purple", "Grey", "LightBlue","Lime"}), 18, -4.95, "Pack: B.I.P."),
	Class158Coach("Class 158 Passenger Car", EntityClass158Coach.class, ItemIDs.minecartClass158car.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"White", "Green", "Cyan", "Blue", "Purple", "Grey","LightBlue","Lime"}),0,0, "Pack: B.I.P."),
	...
	Class47("Class 47", EntityLocoDieselClass47.class, ItemIDs.minecartClass47.item, "diesel", 2580, 154, 1.4, 10, 0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Blue", "Green", "Grey", "LightBlue", "LightGrey", "Magenta", "Orange", "Purple", "Red", "White", "Yellow"}), 18, -4.25, "Pack: B.I.P."),
	...
	BR_MK2F_BSO("BR_MK2F_BSO", EntityPassengerBR_MK2F_BSO.class, ItemIDs.minecartBR_Mk2f_BSO.item, "passenger",0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Brown", "Cyan", "Grey", "Magenta", "Red",}),0, 0, "Pack: B.I.P."),
	BR_MK2F_Coach("BR_MK2F_Coach", EntityPassengerBR_MK2F_Coach.class, ItemIDs.minecartBR_MK2F_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Brown", "Cyan", "Grey", "Magenta", "Red","Orange", "LightBlue", "Green",  "White", "Black", "LightGrey", "Yellow"}),0, 0, "Pack: B.I.P."),
	BR_MK3_DVT("BR_MK3_DVT", EntityElectricBR_MK3_DVT.class, ItemIDs.minecartBR_MK3_DVT.item, "electric", 1500, 201, 3, 60,0,0, 0.8, 0.8, 0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Grey", "LightGrey", "Red", "White", "Yellow"}), 18, -4, "Pack: B.I.P."),
	BR_MK3_Buffet("BR_MK3_Buffet", EntityPassengerBR_MK3_Buffet.class, ItemIDs.minecartBR_MK3_Buffet.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green",  "Magenta", "Yellow","LightBlue"}),0,0, "Pack: B.I.P."),
	BR_MK3_Coach("BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green",  "Magenta", "Yellow", "Grey", "Lime", "LightBlue","Skin16", "Skin17", "Skin18"}),0,0, "Pack: B.I.P."),
	BR_MK3a_Coach("BR_MK3a_Coach", EntityPassengerBR_MK3a_Coach.class, ItemIDs.minecartBR_MK3a_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Pink", "Orange", "Magenta", "LightBlue", "Cyan", "Blue", "Yellow"}),0,0, "Pack: B.I.P."),
	...
	BR_MK4_Coach("BR_MK4_Coach", EntityPassengerBR_MK4_Coach.class, ItemIDs.minecartBR_MK4_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red","White", "Black", "Green", "Magenta", "Yellow", "Grey"}),0,0, "Pack: B.I.P."),
	...
	BR_Mk1_TSO("BR_Mk1_TSO", EntityPassengerBR_Mk1_TSO.class, ItemIDs.minecartBR_Mk1_TSO.item, "passenger", 0, 0, 3.5, 0,0,0,0,0,0,TraincraftUtil.getBytesFromColors(new String[]{"Magenta", "Pink", "Blue", "Grey", "Brown", "Black", "Cyan", "Lime", "Green", "Yellow", "LightBlue", "Purple", "Red",  "Orange",  "LightGrey",  "White"}), 0, 0,"Pack: B.I.P."),
	...
	BR_Mk1_TPO_Stowage("BR_Mk1_TPO_Stowage", EntityPassengerBR_Mk1_TPO_Stowage.class, ItemIDs.minecartBR_Mk1_TPO_Stowage.item, "passenger", 0, 0, 3.5, 0,0,0,0,0,0,TraincraftUtil.getBytesFromColors(new String[]{"Red","Blue"}), 0, 0,"Pack: B.I.P."),
	...
	Class162Engine("Class162Engine", EntityElectricClass162.class, ItemIDs.minecartClass162Engine.item, "electric", 800, 160, 0,50, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Grey", "LightBlue", "Yellow", "Green"}), 18, -4,"Pack: B.I.P."),
	Class162CoachB("Class162CoachB", EntityPassengerClass162CoachB.class, ItemIDs.minecartClass162CoachB.item, "passenger", 0, 0, 0,0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Grey", "LightBlue", "Yellow", "Green"}), 18, 0,"Pack: B.I.P."),
	...
	Class34("Class34", EntityLocoDieselClass34.class, ItemIDs.minecartClass34.item, "diesel", 2000, 146, 0, 10, 0, 100, 0.7, 0.98, 6000, TraincraftUtil.getBytesFromColors(new String[]{"Blue","Green","Grey","Orange","Red","White","LightGrey"}), 18, -3, "Pack: B.I.P." ),
	...
	Class390Front("Class390Front", EntityElectricClass390.class, ItemIDs.minecartClass390Front.item, "electric", 6840, 260, 0,60, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Blue", "Brown", "Cyan", "Grey", "LightGrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Black", "White"}), 18, -5.1,"Pack: B.I.P."),
	...
	Class390Panto("Class390Panto", EntityPassengerClass390Panto.class, ItemIDs.minecartClass390Panto.item, "passenger", 0, 0, 4, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Red", "Blue", "Cyan", "LightGrey", "Lime", "Magenta", "Pink", "Black", "White"}), 0, 0, "Pack: B.I.P." ),
