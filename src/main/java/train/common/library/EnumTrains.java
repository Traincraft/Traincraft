...
public enum EnumTrains {
	...
	locoDieselE10DB("Loco Electric E10 DB",EntityLocoElectricE10_DB.class, ItemIDs.minecartE10_DB.item,"electric",5069,150,0,60,0,170,0.66,0.96,8000,new String[] {"Blue","Red", "Grey"},15,-3.8),
