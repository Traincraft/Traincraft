...
public enum EnumTrains {
	...
	passengerGS4("Passenger GS4", EntityPassengerGS4.class, ItemIDs.minecartGS4_Passenger.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "White", "Yellow", "Brown"}, 10, 0),
	passengerGS4Observatory("Passenger GS4 Observatory", EntityPassengerGS4_Observatory.class, ItemIDs.minecartGS4_Observatory.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "White", "Yellow", "Brown"}, 10, 0),
	passengerGS4_Tail("Passenger GS4 Tail", EntityPassengerGS4_Tail.class, ItemIDs.minecartGS4_Tail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "White", "Yellow", "Brown"}, 10, 0),
	...
	freightCart_L("Freight Car L", EntityFreightCartL.class, ItemIDs.minecartFreightL.item, "freight", 3.5, null, 18, 45, new String[]{"Cargo: any"}),
	...
	freightTrailer("Freight Trailer", EntityFreightTrailer.class, ItemIDs.minecartFreightTrailer.item, "freight", 3, new String[]{"Blue", "Yellow", "LightBlue", "Red", "Grey", "Green"}, 18, 54, new String[]{"Cargo: any"}),
	...
	locoDieselEMDF7("Loco Diesel EMD F-7", EntityLocoDieselEMDF7.class, ItemIDs.minecartLocoEMDF7.item, "diesel",
			1600, 150, 0, 50, 0, 200, 0.8, 0.97, 12000,null, 10, -2.4),
