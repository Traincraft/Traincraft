...
public enum EnumTrains {
	...
	BR_MK3_Coach("BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green",  "Magenta", "Yellow", "Purple", "Grey", "Lime", "LightBlue", "Orange","Skin16", "Skin17"}),0,0, "Pack: B.I.P."),
	BR_MK4_DVT("BR_MK4_DVT", EntityElectricBR_MK4_DVT.class, ItemIDs.minecartBR_MK4_DVT.item, "electric", 500, 260, 0,25, 0, 100, 0.8, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red","White", "Black"}), 18, -4.65, "Pack: B.I.P."),
	...
	asteri("asteri", EntityLocoSteamasteri.class, ItemIDs.minecartasteri.item, "steam",100,69420,0,1,1,1,1,1,69420,null,15,-1.5, "Pack: Your Mum"),
