...
public enum EnumTrains {
	...
	Class345("Class 345 Engine", EntityElectricClass345.class, ItemIDs.minecartClass345engine.item, "electric", 1500, 145, 0,600, 0, 100, 0.7, 0.8, 1000, null, 18, -3, "Pack: B.I.P."),
