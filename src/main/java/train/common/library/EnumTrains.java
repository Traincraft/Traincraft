	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("NMBS_HLE_18", "NMBS_HLE_18", EntityLocoElectricNMBS_HLE_18.class, ItemIDs.minecartNMBS_HLE_18.item, "electric", 6705, 501, 0, 10, 0, 0, 5, 0.79, 0, new String[]{"White", "Grey"}, 10, -3.7, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class401Engine", "Class401Engine", EntityLocoElectricClass401.class, ItemIDs.minecartClass401Loco.item, "electric", 428, 121, 0, 7, 0, 0, 0.5, 0.9, 0, new String[]{"Blue", "Lime", "Green", "Grey"}, 18, -3.4, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class401Tail", "Class401Tail", EntityPassengerClass401Tail.class, ItemIDs.minecartClass401Tail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Lime", "Green", "Grey"}, 18, 0, "Pack: B.I.P."),
