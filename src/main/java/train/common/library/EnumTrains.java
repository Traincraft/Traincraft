...
public enum EnumTrains {
	...
	BR_MK2F_Coach("BR_MK2F_Coach", EntityPassengerBR_MK2F_Coach.class, ItemIDs.minecartBR_MK2F_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Brown", "Cyan", "Grey", "Magenta", "Red","Orange", "LightBlue", "Green",  "White", "Black",}),0, 0, "Pack: B.I.P."),
	...
	BR_MK3a_Coach("BR_MK3a_Coach", EntityPassengerBR_MK3a_Coach.class, ItemIDs.minecartBR_MK3a_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Pink", "Orange", "Magenta", "LightBlue", "Cyan"}),0,0, "Pack: B.I.P."),
