...
public enum EnumTrains {
	...
	Class153("Class 153 Engine", EntityLocoDieselClass153.class, ItemIDs.minecartClass153engine.item, "diesel", 350, 120, 1.4, 10,0,100,0.7,0.8,8000,TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Green", "Grey", "Orange", "Yellow"}), 18, -4.25,"Pack: B.I.P."),
	...
	Class156("Class 156 Engine", EntityLocoDieselClass156.class, ItemIDs.minecartClass156engine.item, "diesel", 285, 121, 1.4, 10,  0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] { "Black",  "Blue", "Cyan", "Green", "Grey","LightBlue", "LightGrey", "Magenta", "Pink", "Red", "White"}), 18, -5, "Pack:  B.I.P."),
	...
	SNCB_M6("SNCB_M6", EntityPassengerSNCB_M6.class, ItemIDs.minecartSNCB_M6.item, "passenger", 0, 0, 3.0,0 , 0, 0, 0,0,0,null,0,0, "Made By TheDoctor1138"),
	SNCB_M6_TAIL("SNCB_M6_TAIL", EntityPassengerSNCB_M6_TAIL.class, ItemIDs.minecartSNCB_M6_TAIL.item, "passenger", 0, 0, 3.0,0 , 0, 0, 0,0,0,null,0,0, "Made By TheDoctor1138"),
