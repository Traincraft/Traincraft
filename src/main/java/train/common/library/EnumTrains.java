...
public enum EnumTrains {
	...
	MRcompound("MRCompound", EntitylocoSteamMRCompound.class, ItemIDs.minecartMRcompound.item, "steam", 2265, 137, 0, 10, 10, 120, 0.75, 0.7, 7500, TraincraftUtil.getBytesFromColors(new String[]{"Black", "Grey", "Magenta", "Pink", "Red", "Yellow"}), 0, -4.25, "Pack: B.I.P." ),
	...
	Class142Front("Class142Front", EntityLocoDieselClass142.class, ItemIDs.minecartClass142Front.item, "diesel", 225, 121, 0, 5, 0, 100, 0.9, 0.9, 7500,TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Cyan", "Blue", "LightBlue", "LightGrey", "Red", "Yellow", "Orange"}), 18, -2.2,"Pack: B.I.P."),
