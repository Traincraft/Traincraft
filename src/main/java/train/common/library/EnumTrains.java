...
public enum EnumTrains {
	...
	/** Passengers */
	passengerCartBlue("Passenger Blue",EntityPassengerBlue.class, ItemIDs.minecartPassengerBlue.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[] {"Blue","Red","Green", "White", "Black", "Cyan"},18, 0),
	...
	passengerLongGreen("Passenger Green Long",EntityPassenger5.class, ItemIDs.minecartPassenger5.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Green", "Yellow"},18,0),
	...
	passenger_1class_DB("Passenger 1Class DB",EntityPassenger_1class_DB.class,ItemIDs.minecartPassenger8_1class_DB.item,"passenger",0,0,0.5,0,0,0,0,0,0,null,18,0),
	passenger_2class_DB("Passenger 2Class DB",EntityPassenger_2class_DB.class,ItemIDs.minecartPassenger9_2class_DB.item,"passenger",0,0,0.5,0,0,0,0,0,0,null,18,0),
	...
	passengerDBOriental("Passenger DB oriental",EntityPassengerDBOriental.class, ItemIDs.minecartPassengerDBOriental.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Yellow", "Blue", "White"},18,0),
	...
	passengerGS4("Passenger GS4",EntityPassengerGS4.class,ItemIDs.minecartGS4_Passenger.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White", "Yellow", "Brown"},10,0),
	passengerGS4Observatory("Passenger GS4 Observatory",EntityPassengerGS4_Observatory.class,ItemIDs.minecartGS4_Observatory.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White", "Yellow", "Brown"},10,0),
	passengerGS4_Tail("Passenger GS4 Tail",EntityPassengerGS4_Tail.class,ItemIDs.minecartGS4_Tail.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White", "Yellow", "Brown"},10,0),
	...
	passengerRheingold("Passenger Rheingold",EntityPassengerRheingold.class, ItemIDs.minecartPassengerRheingold.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Blue", "Red"},18,0),
	...
	passengerRheingoldPanorama("Rheingold Panorama",EntityPassengerRheingoldPanorama.class, ItemIDs.minecartPassengerRheingoldPanorama.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Blue", "Red"},18,0),

	passengerMILW("Passenger MILW",EntityPassengerMILW.class, ItemIDs.minecartPassengerMILW.item,"passenger",0,0,0.5,0,0,0,0,0,0,null,18,0),
	passengerMILWTail("Passenger MILW Tail",EntityPassengerMILWTail.class, ItemIDs.minecartPassengerMILWTail.item,"passenger",0,0,0.5,0,0,0,0,0,0,null,18,0),
	...
	locoDieselGP7Red("Loco Diesel GP7",EntityLocoDieselGP7Red.class, ItemIDs.minecartGP7Red.item,"diesel",1520,112,0,50,0,200,0.74,0.96,20000,new String[] {"Red","Blue","Black","Yellow", "Magenta", "Cyan", "Pink", "LightGrey", "Green", "White", "LightBlue", "Lime", "Brown", "Purple", "Orange", "Grey"},15,-1.4),
	...
	locoDieselEMDF7("Loco Diesel EMD F-7", EntityLocoDieselEMDF7.class, ItemIDs.minecartLocoEMDF7.item, "diesel",
			1520, 169, 0, 50, 0, 200, 0.8, 0.97, 12000,null, 10, -2.4),
	...
	/** Steam */
	locoSteamA4("Loco Steam A4 Mallard", EntityLocoSteamMallardA4.class,  ItemIDs.minecartLocoA4Mallard.item, "steam", 639, 203, 0, 60, 200, 160, 0.65, 0.97, 10000, new String[] { "Blue", "Lime", "Black", "Green", "White" }, 7, -5 ),
	locoSteamMILW("Loco Steam MILW Class A", EntityLocoSteamMILWClassA.class,  ItemIDs.minecartLocoMILWClassA.item, "steam", 639, 140, 0, 60, 150, 160, 0.65, 0.97, 10000, null, 7, -4.5 ),
	...
	locoSteamCoranationClass("Loco Steam Coranation Class", EntityLocoSteamCoranationClass.class,
			...
			-6),
	locoSteamGS4("Loco Steam GS4", EntityLocoSteamGS4.class,  ItemIDs.minecartGS4_Loco.item, "steam", 600, 177, 0, 60, 350, 450, 0.6, 0.95, 8800, new String[]{"Orange", "White"}, 10, -6 ),
