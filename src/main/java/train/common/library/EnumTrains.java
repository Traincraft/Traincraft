...
public enum EnumTrains {
	...
	BR_MK3_Buffet("BR_MK3_Buffet", EntityPassengerBR_MK3_Buffet.class, ItemIDs.minecartBR_MK3_Buffet.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Magenta", "Blue", "Cyan", "Brown", "Red", "White", "Green"}),0,0),
	BR_MK3_Coach("BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Magenta", "Blue", "Orange", "Brown", "Red", "White", "Green", "Grey", "Lime", "Black", "Pink", "Yellow"}),0,0),
