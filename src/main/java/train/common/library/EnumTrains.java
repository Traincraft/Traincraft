...
public enum EnumTrains {
	...
	RW_Type_3("RW_Type_3", EntityLocoSteamRW_Type_3.class, ItemIDs.minecartRW_Type_3.item, "steam", 900, 101, 0, 10, 10 , 100, 0.7, 0.7, 4000, TraincraftUtil.getBytesFromColors(new String[]   {"Black", "Blue", "Green", "Lime", "Pink", "Red"}), 18, -2.6f, "Pack: B.I.P."),
