...
public enum EnumTrains {
	...
	GP7u("GP7u",EntityLocoDieselBapGP7u.class, ItemIDs.minecartGP7u.item, "diesel", 1500, 100, 0, 15, 0, 170, 0.81, 0.93, 4000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Blue", "LightGrey", "Grey", "White", "Yellow"}), 10, -3, "Pack: Bap"),
	GP7("GP7", EntityLocoDieselBapGP7.class, ItemIDs.minecartGP7.item, "diesel", 1500, 105, 0, 15, 0, 170, 0.81, 0.93, 4000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Blue", "White", "Brown", "Black", "Red", "Green", "Purple", "LightGrey"}), 10, -3, "Pack: Bap"),
	GP7b("GP7b", EntityLocoDieselBapGP7b.class, ItemIDs.minecartGP7b.item, "diesel", 1500, 105, 0, 15, 0, 170, 0.81, 0.93, 4000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "White"}), 10, -3, "Pack: Bap"),
	GP9("GP9", EntityLocoDieselBapGP9.class, ItemIDs.minecartGP9.item, "diesel", 1750, 100, 0, 15, 0, 170, 0.81, 0.93, 4000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Red", "Orange", "Magenta", "Yellow","Black","Brown","Blue","Green"}), 10, -3, "Pack: Bap"),
	;
