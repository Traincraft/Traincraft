...
public enum EnumTrains {
	...
	locoSteamPannier("Loco Steam Climax",EntityLocoSteamPannier.class, ItemIDs.minecartLocoSteamPannier.item,"steam",229,45,0,50,160,130,0.5,0.968,1200,null,15,-3.5),
