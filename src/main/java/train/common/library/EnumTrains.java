...
public enum EnumTrains {
	...
	tender_BR_Black_5("Tender_BR_Black_5", EntityTenderBR_Black_5.class, ItemIDs.minecartBR_Black_5_Tender.item, "tender", 0, 0, 0.5, 0, 0, 0, 0, 0, 16000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Green", "Grey", "LightGrey", "Red", "White"}), 18, 0, "Water capacity: 16000mb"),
	/** Diesel */
	...
	Class158("Class 158 Engine", EntityLocoDieselClass158.class, ItemIDs.minecartClass158engine.item, "diesel", 350, 145, 3,10, 0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Green", "Cyan", "Blue", "White", "Grey", "LightBlue"}), 18, -4, "Pack: B.I.P."),
	...
	Class153("Class 153 Engine", EntityLocoDieselClass153.class, ItemIDs.minecartClass153engine.item, "diesel", 350, 120, 1.4, 10,0,100,0.7,0.9,8000,TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Green", "Grey", "Orange", "Yellow"}), 18, -4.25,"Pack: B.I.P."),
	Class153Coach("Class 153 Coach", EntityPassengerClass153.class, ItemIDs.minecartClass153Coach.item, "passenger", 0, 0, 1.4, 0,0,0,0,0,0,TraincraftUtil.getBytesFromColors(new String[] { "LightBlue", "Green", "Grey", "Orange", "Yellow"}), 0, 0,"Pack: B.I.P."),
	...
	BR_MK3_Buffet("BR_MK3_Buffet", EntityPassengerBR_MK3_Buffet.class, ItemIDs.minecartBR_MK3_Buffet.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green",  "Magenta", "Yellow"}),0,0, "Pack: B.I.P."),
	...
	BR_Black_5("BR_Black_5", EntityLocoSteamBR_Black_5.class, ItemIDs.minecartBR_Black_5.item, "steam", 1550, 149, 3, 10, 10 , 100, 0.7, 0.7, 1000, TraincraftUtil.getBytesFromColors(new String[]   {"Black", "Grey", "LightGrey", "Red", "White"}), 18, -3.5f, "Pack: B.I.P."),
	...
	passengerPS54SeatCoach_Lounge("PS 54 Seat Coach-Lounge", EntityPassengerPS54SeatCoach_Lounge.class, ItemIDs.minecartPS54SeatCoach_Lounge.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Cyan", "LightBlue", "LightGrey"}), 10, 0, "Pack: BAP"),
	passengerPS58SeatCoach_Observation("PS 58 Seat Coach-Observation", EntityPassengerPS58SeatCoach_Observation.class, ItemIDs.minecartPS58SeatCoach_Observation.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Cyan", "LightBlue", "Purple", "LightGrey", "Grey"}), 10, 0, "Pack: BAP"),
	...
	BR_Mk1_Baggage("BR_Mk1_Baggage", EntityPassengerBR_Mk1_BG.class, ItemIDs.minecartBR_Mk1_BG.item, "passenger", 0, 0, 3.5, 0,0,0,0,0,0,TraincraftUtil.getBytesFromColors(new String[]{"Magenta", "Blue", "Brown", "Cyan", "Green", "Grey", "LightBlue", "Red", "Orange"}), 0, 0,"Pack: B.I.P."),
	BR_Mk1_TPO_Stowage("BR_Mk1_TPO_Stowage", EntityPassengerBR_Mk1_TPO_Stowage.class, ItemIDs.minecartBR_Mk1_TPO_Stowage.item, "passenger", 0, 0, 3.5, 0,0,0,0,0,0,TraincraftUtil.getBytesFromColors(new String[]{"Red"}), 0, 0,"Pack: B.I.P."),
