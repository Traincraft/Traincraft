...
public enum EnumTrains {
	...
	locoSteamCoranationClass("Loco Steam Coranation Class", EntityLocoSteamCoranationClass.class, 135, ItemIDs.minecartLocoCoranationClass.item,"steam", 800, 183, 0, 60, 200, 300, 0.6, 0.97, 10000, null, 10,  -5 ,0.98, 1.98),
