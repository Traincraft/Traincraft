...
public enum EnumTrains {
	...
	Class156("Class 156 Engine", EntityLocoDieselClass156.class, ItemIDs.minecartClass156engine.item, "diesel", 285, 121, 1.4, 10,  0, 100, 0.8, 0.9, 8000, TraincraftUtil.getBytesFromColors(new String[] { "Black",  "Blue", "Cyan", "Green", "Grey","LightBlue", "LightGrey", "Magenta", "Pink", "Red", "White"}), 18, -5, "Pack:  B.I.P."),
