...
public enum EnumTrains {
	...
	BUnitEMDF7("EMD F7 B Unit", EntityBUnitEMDF7.class, ItemIDs.minecartLocoEMDF7B.item, "b-unit", 0, 0, 5, 0,
			0,
			0, 0, 0, 12000, new String[]{"Black", "Lime"}, 18, 0,
	...
	locoDieselBP4("Loco Diesel BP4",EntityLocoDieselBP4.class, ItemIDs.minecartLocoBP4.item,"diesel",3041,166,0,60,0,200,0.8,0.97,20000,null,10,-3.1),
