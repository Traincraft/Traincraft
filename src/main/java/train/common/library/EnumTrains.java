...
public enum EnumTrains {
	...
	passengerDBOriental("Passenger DB oriental",EntityPassengerDBOriental.class, ItemIDs.minecartPassengerDBOriental.item,"passenger",0,0,2,0,0,0,0,0,0,new String[]{"Yellow", "Blue", "White"},18,0),
