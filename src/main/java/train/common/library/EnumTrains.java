...
public enum EnumTrains {
	...
	locoDieselGP40("Loco Diesel CD742", EntityLocoDieselCD742.class, 62, ItemIDs.minecartCD742.item, "diesel", 1200, 90,
			0, 50, 0, 250, 0.8, 0.966, 10000, new String[] { "Yellow", "White" }, 15, -2.5, 0.98, 1.98),
