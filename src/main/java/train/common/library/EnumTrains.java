...
public enum EnumTrains {
	...
	BR_MK3_Coach("BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Black","Blue","Brown","Green","Grey","Lime","Magenta","Orange","Pink","Red","White","Yellow"}),0,0),
	BR_MK4_DVT("BR_MK4_DVT", EntityLocoDieselBR_MK4_DVT.class, ItemIDs.minecartBR_MK4_DVT.item, "diesel", 1, 260, 0, 25, 0, 180, 0.89, 0.8, 13000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red","White"}), 0, -3),
