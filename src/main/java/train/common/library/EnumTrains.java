...
public enum EnumTrains {
	...
	/** Passengers */
	passengerCartBlue("Passenger Blue",EntityPassengerBlue.class, 48,ItemIDs.minecartPassengerBlue.item,"passenger",0,0,0.9,0,0,0,0,0,0,new String[] {"Blue","Red","Green", "White", "Black"},18, 0,0.98,1.98),
	...
	passengerIC4_DSB_FG("Passenger IC4 DSB FG",PassengerIC4_DSB_FG.class, 61,ItemIDs.minecartIC4_DSB_FG.item,"passenger, Unfinished, Creative Only",0,0,0.5,0,0,0,0,0,0,null,10,0,0.98,1.98),
	passengerIC4_DSB_FH("Passenger IC4 DSB FH",PassengerIC4_DSB_FH.class, 56,ItemIDs.minecartIC4_DSB_FH.item,"passenger, Unfinished, Creative Only",0,0,0.5,0,0,0,0,0,0,null,10,0,0.98,1.98),
	...
	passengerGS4("Passenger GS4",EntityPassengerGS4.class, 120,ItemIDs.minecartGS4_Passenger.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White", "Yellow"},10,0,0.98,1.98),
	passengerGS4Observatory("Passenger GS4 Observatory",EntityPassengerGS4_Observatory.class, 121,ItemIDs.minecartGS4_Observatory.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White", "Yellow"},10,0,0.98,1.98),
	passengerGS4_Tail("Passenger GS4 Tail",EntityPassengerGS4_Tail.class, 122,ItemIDs.minecartGS4_Tail.item,"passenger",0,0,0.5,0,0,0,0,0,0,new String[]{"Orange", "White", "Yellow"},10,0,0.98,1.98),
	...
	/** Specials **/
	stockCar("Stock Cart",EntityStockCar.class, 44,ItemIDs.minecartStockCar.item,"special",0,0,2,0,0,0,0,0,0,new String [] {"Blue", "Red", "Yellow", "White"},18,0,0.98,1.98),
	drwgStockCar("DRWG Stock Cart",EntityStockCarDRWG.class, 58,ItemIDs.minecartDRWGStockCar.item,"special",0,0,2,0,0,0,0,0,0,null,18,0,0.98,1.98),
	...
	cabooseLoggingPRR("PRR Caboose Logging",EntityCabooseLoggingPRR.class, 79,ItemIDs.minecartCabooseLoggingPRR.item,"work",0,0,0.2,0,0,0,0,0,0,new String [] {"Red", "Blue", "Green"},18,0,0.98,1.98),
	...
	BUnitEMDF7("EMD F7 B Unit", EntityBUnitEMDF7.class, 129, ItemIDs.minecartLocoEMDF7B.item, "b-unit", 0, 0, -8, 0,
			0,
			0, 0, 0, 12000, new String[] { "Grey", "Black" }, 18, 0, 0.98, 1.98),
	...
	freightHopperUS("Freight Hopper US",EntityFreightHopperUS.class, 71,ItemIDs.minecartFreightHopperUS.item,"freight",4,new String [] {"Brown","Grey"},18,0.98,1.98, 27, new String[] {"Cargo: blocks"}),
	...
	freightBoxCartUS("Freight Box Cart US",EntityBoxCartUS.class, 67,ItemIDs.minecartBoxCartUS.item,"freight",2,new String[]{"Brown", "Yellow", "Blue"},18,0.98,1.98,45,new String[] {"Cargo: any"}),
	freightBoxCartPRR("Freight Box Cart PRR",EntityBoxCartPRR.class, 78,ItemIDs.minecartBoxCartPRR.item,"freight",2,null,18,0.98,1.98,45,new String[] {"Cargo: any"}),
	...
	freightGTNG("Freight GTNG Ore Wagon",EntityFreightGTNG.class, 90,ItemIDs.minecartFreightGTNG.item,"freight",0.5,null,18,0.98,0.98, 18,new String[] {"Cargo: opaque blocks"}),
	...
	slateWagon("Freight Slate Wagon", EntityFreightSlateWagon.class, 126, ItemIDs.minecartSlateWagon.item, "freight",
			0.5, null, 18, 0.98, 0.98, 38, new String[] { "Cargo: only stone and ores" }),
	freightCartGS4("Freight Cart GS4 Baggage",EntityFreightGS4_Baggage.class, 124,ItemIDs.minecartGS4_Baggage.item,"freight",1,new String[]{"Orange", "White", "Yellow"},18,0.98,0.98,45,new String[] {"Cargo: any"}),
	...
	freightCenterBeam_Wood2("Freight Center Beam Wood2", EntityFreightCenterbeam_Wood_2.class, 17,ItemIDs.minecartFreightCenterBeam_Wood_2.item, "freight", 3, null, 18, 0.98, 1.98,54, new String[] { "Cargo: wood stuff" }),
	freightWellcar("Freight Well Car",EntityFreightWellcar.class, 20,ItemIDs.minecartFreightWellcar.item,"freight",3,new String[] {"Blue","Red","Green","LightGrey","Grey", "Yellow"},18,0.98,1.98,54,new String[] {"Cargo: any"}),
	...
	tankWagonUS("Tank Wagon US",EntityTankWagonUS.class, 70,ItemIDs.minecartTankWagonUS.item,"tank",0,0,6,0,0,0,0,0,70000,new String[]{"Black", "Grey"},18,0,0.98,1.98,new String[] {"Capacity: 70000mb"}),
	...
	/** Diesel */
	locoDieselKOF("Loco Diesel KOF DB",EntityLocoDieselKof_DB.class,25,ItemIDs.minecartKof_DB.item, "diesel",243,45,0,60,0,170,0.66,0.96,5000,new String[] {"Red","Green","Yellow","Black","Blue"},17,-1.6,0.98,0.98),
	locoDieselGP40("Loco Diesel CD742",EntityLocoDieselCD742.class, 62,ItemIDs.minecartCD742.item,"diesel",1200,90,0,50,0,250,0.8,0.966,10000,new String[] {"Yellow","White"},15,-1.4,0.98,1.98),
	locoDieselChME3("Loco Diesel ChME3", EntityLocoDieselChME3.class, 32, ItemIDs.minecartChmE3.item,"diesel", 1318, 95, 0, 60, 0, 170, 0.66, 0.96, 5000, null, 15,  -1.2 ,  0.98, 1.98),
	locoDieselGP7Red("Loco Diesel GP7",EntityLocoDieselGP7Red.class, 59,ItemIDs.minecartGP7Red.item,"diesel",1520,112,0,50,0,200,0.74,0.96,20000,new String[] {"Red","Blue","Black","Yellow"},15,-1.4,0.98,1.98),
	locoDieselSD40("Loco Diesel SD40",EntityLocoDieselSD40.class, 21,ItemIDs.minecartLocoSD40.item,"diesel",3041,134,0,60,0,200,0.8,0.97,20000,new String[] {"Red","Yellow","Black","Green","Orange","Magenta","Blue"},10,-2.3,0.98,1.98),
	locoDieselSD70("Loco Diesel SD70",EntityLocoDieselSD70.class, 113,ItemIDs.minecartLocoSD70.item,"diesel",4055,112,0,60,0,200,0.8,0.97,20000,new String[] {"Orange","Yellow","Red","Blue","Magenta","Black", "Pink"},10,-2.3,0.98,1.98),
	locoDieselShunter("Loco Diesel Shunter", EntityLocoDieselShunter.class, 11, ItemIDs.minecartShunter.item,"diesel", 354, 32, 0, 70, 0, 260, 0.6, 0.94, 8000,new String[] { "Blue", "Green", "Red", "Black" }, 14,  -2.58,  0.98, 1.98),
	locoDieselV60_DB("Loco Diesel V60 DB",EntityLocoDieselV60_DB.class, 49,ItemIDs.minecartV60_DB.item,"diesel",648,60,0,60,0,170,0.66,0.96,8000,new String[] {"Red","Green","Yellow","Cyan"},15,-1.3,0.98,1.98),
	locoDieselIC4_DSB_MG("Loco Diesel IC4 DSB MG",EntityLocoDieselIC4_DSB_MG.class, 57,ItemIDs.minecartIC4_DSB_MG.item,"diesel, Unfinished, Creative Only",760,200,0,60,0,200,0.8,0.97,20000,new String[] {"White","Red"},10,-6,0.98,1.98),
	locoDieselMILW_H1044("Loco Diesel MILW H10-44",EntityLocoDieselMILW_H1044.class, 123,ItemIDs.minecartMILW_H1044.item,"diesel",1013,97,0,60,0,170,0.66,0.96,8000,null,15,-4.4,0.98,1.98),
	...
	locoElectricBR185("Loco Electric BR 185", EntityLocoElectricBR185.class, 131, ItemIDs.minecartLocoBR185.item,
			"electric", 7604, 140, 0, 10, 0, 170, 0.7, 0.965, 0, null, 18, -5, 0.98, 1.98),
	locoElectricClass85("Loco Electric Class 85", EntityLocoElectricClass85.class, 132,
			ItemIDs.minecartLocoClass85.item, "electric", 3244, 160, 0, 10, 0, 170, 0.7, 0.965, 0, null, 18, -5, 0.98,
			1.98),
	...
	locoSteam4_4_0("Loco Steam 4-4-0",EntityLocoSteam4_4_0.class, 13,ItemIDs.minecartPower.item,"steam",400,50,0,40,160,190,0.65,0.95,5000,new String[] {"Red","White","Blue","Brown","Green","Black", "Purple"},16,-2,0.98,1.98),
	...
	locoSteamCoranationClass("Loco Steam Coranation Class", EntityLocoSteamCoranationClass.class, 135,
			ItemIDs.minecartLocoCoranationClass.item, "steam", 1545, 183, 0, 60, 200, 300, 0.6, 0.97, 10000, null, 10,
			-6, 0.98, 1.98),
	locoSteamGS4("Loco Steam GS4", EntityLocoSteamGS4.class, 94, ItemIDs.minecartGS4_Loco.item, "steam", 800, 170, 0, 60, 350, 450, 0.6, 0.95, 88000, new String[]{"Orange", "Blue"}, 10, -5.5 , 0.98, 1.98),
