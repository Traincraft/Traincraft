...
public enum EnumTrains {
	...
	BapF7A("F7A", EntityLocoDieselBapF7A.class, ItemIDs.minecartF7A.item, "diesel", 1500, 133, 0, 15, 0, 180, 0.7, 0.79, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "LightGrey", "White", "Orange", "Black", "Yellow", "Grey", "Magenta", "LightBlue"}), 10, -2.5, "Pack: Bap"),
	BapF7B("F7B", EntityLocoDieselBapF7B.class, ItemIDs.minecartF7B.item, "diesel", 1500, 133, 0, 15, 0, 180, 0.7, 0.79, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "LightGrey", "White", "Orange", "Black", "Yellow", "Grey", "Magenta", "LightBlue"}), 10, -2.4, "Pack: Bap"),
	...
	BapGP15("GP15", EntityLocoDieselBapGP15.class, ItemIDs.minecartGP15.item, "diesel", 1800, 105, 0, 15, 0, 160, 0.79, 0.93, 15000, TraincraftUtil.getBytesFromColors(new  String[] {"Yellow", "LightGrey"}), 10, -2.6, "Pack: Bap"),
	spookyGarrattFront("Garratt Front", EntityLocoSteamGarrattFront.class,  ItemIDs.minecartGarrattFront.item, "steam", 2838, 112, 0, 1, 1, 10, 0.65, 0.97, 10000, null, 7, -2.25, "Multi-Segment Locomotive. Creative Only."),//front
	spookyGarrattRear("Garratt Rear", EntityLocoSteamGarrattRear.class,  ItemIDs.minecartGarrattBack.item, "steam", 2838, 112, 0, 1, 1, 10, 0.65, 0.97, 10000, null, 7, -2.25, "Multi-Segment Locomotive. Creative Only."),//rear
	spookyGarrattMid("Garratt Mid", EntityLocoSteamGarrattMid.class,  ItemIDs.minecartGarrattMid.item, "steam", 1, 112, 0, 60, 200, 160, 0.65, 0.97, 10000, null, 7, -4.25, "Multi-Segment Locomotive. Creative Only."),//mid
	...
	SD9("SD9", EntityLocoDieselBapSD9.class, ItemIDs.minecartSD9.item, "diesel", 1750, 104, 0, 5, 0, 190, 0.75, 0.89, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "Lime", "Orange", "White", "Cyan", "Grey"}), 10, -3.1, "Pack: Bap"),
	SD40dash2("SD40-2", EntityLocoDieselBapSD40dash2.class, ItemIDs.minecartSD40dash2.item, "diesel", 3000, 105, 0, 5, 0, 190, 0.75, 0.89, 20000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Orange", "Cyan", "Grey"}), 10, -3.8, "Pack: Bap"),
