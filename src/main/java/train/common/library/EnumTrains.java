...
public enum EnumTrains {
	...
	Class158("Class 158 Engine", EntityLocoDieselClass158.class, ItemIDs.minecartClass158engine.item, "diesel", 350, 145, 3,10, 0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Green", "Cyan", "Blue", "Purple", "Grey", "LightBlue","Lime", "LightGrey", "Yellow", "Magenta"}), 18, -4.95, "Pack: B.I.P."),
	Class158Coach("Class 158 Passenger Car", EntityClass158Coach.class, ItemIDs.minecartClass158car.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"White", "Green", "Cyan", "Blue", "Purple", "Grey","LightBlue","Lime", "LightGrey", "Yellow", "Magenta"}),0,0, "Pack: B.I.P."),
	...
	BR_MK2F_DBSO("BR_MK2F_DBSO", EntityElectricBR_MK2F_DBSO.class, ItemIDs.minecartBR_Mk2f_DBSO.item, "electric", 1000, 161, 3.3, 60,0,0, 0.8, 0.8, 0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Grey", "LightBlue", "Purple", "Yellow", "Black", "Red"}), 18, -4.03, "Pack: B.I.P."),
	BR_MK3_DVT("BR_MK3_DVT", EntityElectricBR_MK3_DVT.class, ItemIDs.minecartBR_MK3_DVT.item, "electric", 1100, 201, 3, 60,0,0, 0.8, 0.8, 0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Grey", "LightGrey", "Red", "White", "Yellow", "LightBlue"}), 18, -4, "Pack: B.I.P."),
	...
	BR_MK4_DVT("BR_MK4_DVT", EntityElectricBR_MK4_DVT.class, ItemIDs.minecartBR_MK4_DVT.item, "electric", 1100, 260, 0,25, 0, 100, 0.8, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red","White", "Black", "Pink"}), 18, -4.65, "Pack: B.I.P."),
	...
	Class43("Class43", EntityLocoDieselClass43.class, ItemIDs.minecartClass43.item, "diesel", 2250, 238, 0, 25, 0, 180, 0.85, 0.8, 13000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Blue", "Brown", "Green", "Red", "Cyan", "LightBlue", "Orange", "Yellow", "Purple", "Pink"}), 0, -3.15),
	Class90("Class90", EntityElectricClass90.class, ItemIDs.minecartClass90.item, "electric", 5000, 178, 0,60, 0, 100, 0.7, 0.82, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "LightGrey", "Grey", "Pink", "Red", "White", "Magenta", "Brown"}), 18, -2.75),
	Class91("Class91", EntityElectricClass91.class, ItemIDs.minecartClass91.item, "electric", 6300, 260, 0,60, 0, 100, 0.7, 0.82, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red", "White", "Pink"}), 18, -4.2),
	...
	DuewagGT6ERLoco("DuewagGT6ERLoco", EntityElectricDuewagGT6ERLoco.class, ItemIDs.minecartDuewagGT6ERLoco.item, "electric", 250, 70, 0,20, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Magenta","Green","Blue","White","Grey","Orange"}), 18, -1.95, "Pack: Trams In Motion"),
	DuewagGT6ERTail("DuewagGT6ERTail", EntityPassengerDuewagGT6ERTail.class, ItemIDs.minecartDuewagGT6ERTail.item, "passenger", 0, 0, 1,0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Magenta","Green","Blue","White","Grey","Orange"}), 18, -1.35, "Pack: Trams In Motion"),
	;
