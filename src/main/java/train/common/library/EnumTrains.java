...
public enum EnumTrains {
	...
	locoElectricBNLRV_A("BNLRV_A", EntityLocoElectricBNLRV_A.class, ItemIDs.minecartBNLRV_A.item, "electric", 500 , 70, 3, 10, 0,0,0.9,0, 0,  TraincraftUtil.getBytesFromColors(new String[]{"White", "Orange", "Yellow"}), 10, -4, "Pack: Trams In Motion"),
