...
public enum EnumTrains {
	...
	locoElectricRhB_De("Loco Electric RhB De",EntityLocoElectricRhB_De.class, ItemIDs.minecartRhB_De.item,"electric",211,45,0,10,0,140,0.5,0.965,0,null,14,-2),
	locoElectricRhB_Te("Loco Electric RhB Te",EntityLocoElectricRhB_Te.class, ItemIDs.minecartRhB_Te.item,"electric",227,55,0,10,0,140,0.5,0.965,0,null,14,-2),
