...
public enum EnumTrains {
	...
	propagandaBritain("Propaganda Britain",EntityPropagandaBritain.class, ItemIDs.minecartPropagandaBritish.item,"decorative",0,0,0,0,0,0,0,0,0,new String[]{"Blue", "White", "Yellow"},14,0),
	...
	locoDieselEMDF3("Loco Diesel EMD F-3", EntityLocoDieselEMDF3.class, ItemIDs.minecartLocoEMDF3.item, "diesel",
			1520, 166, 0, 55, 0, 200, 0.8, 0.97, 12000, null, 10, -2.25),
