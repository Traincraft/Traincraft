...
public enum EnumTrains {
	...
	locoDieselChME3("Loco Diesel ChME3", EntityLocoDieselChME3.class, 32, ItemIDs.minecartChmE3.item,"diesel", 500, 95, 0, 60, 0, 170, 0.66, 0.96, 5000, null, 15,  -1.2 ,  0.98, 1.98),
	...
	locoDieselSD70("Loco Diesel SD70",EntityLocoDieselSD70.class, 113,ItemIDs.minecartLocoSD70.item,"diesel",900,90,0,60,0,200,0.8,0.97,20000,new String[] {"Orange","Yellow","Red","Blue","Magenta","Black", "Pink"},10,-2.3,0.98,1.98),
	...
	locoDieselIC4_DSB_MG("Loco Diesel IC4 DSB MG",EntityLocoDieselIC4_DSB_MG.class, 57,ItemIDs.minecartIC4_DSB_MG.item,"diesel, Unfinished, Creative Only",900,200,0,60,0,200,0.8,0.97,20000,new String[] {"White","Red"},10,-6,0.98,1.98),
