...
public enum EnumTrains {
	...
	CF7("CF7angle", EntityLocoDieselBapCF7.class, ItemIDs.minecartCF7.item, "diesel", 1500, 116, 0, 25, 0, 185, 0.8, 0.8, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Red", "LightGrey", "White", "Green", "Brown", "Skin16", "Skin17", "Orange", "Skin18", "Skin19", "Skin20", "Skin21", "Black", "Grey", "Cyan"}), 10, -2.5, "Pack: Bap"),
	...
	Class156("Class 156 Engine", EntityLocoDieselClass156.class, ItemIDs.minecartClass156engine.item, "diesel", 285, 121, 1.4, 10,  0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] { "Black",  "Blue", "Cyan", "Green", "Grey,","LightBlue", "LightGrey", "Magenta", "Pink", "Red", "White"}), 18, -5.25, "Pack:  B.I.P."),
	Class47("Class 47", EntityLocoDieselClass47.class, ItemIDs.minecartClass47.item, "diesel", 2580, 154, 1.4, 10, 0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Blue", "Green", "Grey", "LightBlue", "LightGrey", "Magenta", "Orange", "Purple", "Red", "White", "Yellow"}), 18, -5.25, "Pack: B.I.P."),
	...
	BR_MK3_DVT("BR_MK3_DVT", EntityElectricBR_MK3_DVT.class, ItemIDs.minecartBR_MK3_DVT.item, "electric", 500, 201, 3, 60,0,0, 0.8, 0.8, 0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Grey", "LightGrey", "Red", "White", "Yellow"}), 18, -4, "Pack: B.I.P."),
	BR_MK3_Buffet("BR_MK3_Buffet", EntityPassengerBR_MK3_Buffet.class, ItemIDs.minecartBR_MK3_Buffet.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Magenta", "Blue", "Cyan", "Brown", "Red", "White", "Pink", "LightGrey", "Green", "Black"}),0,0, "Pack: B.I.P."),
	BR_MK3_Coach("BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey", "Grey", "Pink", "Lime", "Yellow", "LightBlue", "Magenta", "White", "Virgin", "Virgin_First", "Red_First"}),0,0, "Pack: B.I.P."),
	BR_MK4_DVT("BR_MK4_DVT", EntityElectricBR_MK4_DVT.class, ItemIDs.minecartBR_MK4_DVT.item, "electric", 500, 260, 0,25, 0, 100, 0.8, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red","White", "Black"}), 18, -3.15, "Pack: B.I.P."),
	...
	Class43("Class43", EntityLocoDieselClass43.class, ItemIDs.minecartClass43.item, "diesel", 2250, 238, 0, 25, 0, 180, 0.89, 0.8, 13000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Blue", "Brown", "Green", "Red", "Cyan", "LightBlue"}), 0, -3.15),
