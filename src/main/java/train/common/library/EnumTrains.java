...
public enum EnumTrains {
	...
	Class390Front("Class390Front", EntityElectricClass390.class, ItemIDs.minecartClass390Front.item, "electric", 6840, 260, 0,60, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Blue", "Cyan", "Grey", "LightGrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Black", "White"}), 18, -5.1,"Pack: B.I.P."),
