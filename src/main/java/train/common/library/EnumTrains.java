...
public enum EnumTrains {
	...
	passenger81717("Passenger 81-717", EntityPassenger81717_Passenger.class, ItemIDs.minecart81717_passenger.item, "passenger", 0, 0, 2.5, 0, 0, 0, 0, 0, 0, null, 25, 0),
	...
	locoElectric81717_Motor("Loco Electric 81-717", EntityLocoElectric81717_Motor.class, ItemIDs.minecart81717_motor.item, "electric", 8000, 110, 0, 40, 0, 250, 1.5, 0.98, 0, null, 13, -5),
	...
	Class345("Class 345 Engine", EntityElectricClass345.class, ItemIDs.minecartClass345engine.item, "electric", 1500, 300, 0,10, 0, 100, 0.9, 0.9, 1000, null, 18, -3, "Pack: B.I.P."),
	...
	Class158("Class 158 Engine", EntityLocoDieselClass158.class, ItemIDs.minecartClass158engine.item, "diesel", 350, 145, 3,10, 0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Green", "Cyan", "Blue", "White", "Grey"}), 18, -4, "Pack: B.I.P."),
	...
	BR_MK3_Coach("BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Magenta", "Blue", "Cyan", "Brown", "Red", "White", "Pink", "Grey", "Green", "Lime", "Yellow", "Black"}),0,0, "Pack: B.I.P."),
	BR_MK4_DVT("BR_MK4_DVT", EntityElectricBR_MK4_DVT.class, ItemIDs.minecartBR_MK4_DVT.item, "electric", 1, 260, 0,25, 0, 100, 0.8, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red","White", "Black"}), 18, -3.15, "Pack: B.I.P."),
