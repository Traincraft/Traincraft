...
public enum EnumTrains {
	...
	tender_BR_Black_5("Tender_BR_Black_5", EntityTenderBR_Black_5.class, ItemIDs.minecartBR_Black_5_Tender.item, "tender", 0, 0, 0.6, 0, 0, 0, 0, 0, 16000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Green", "Grey", "LightGrey", "Red", "White", "Magenta", "Yellow"}), 18, 0, "Water capacity: 16000mb"),
    ...
    passengerBW305("BW305",EntityPassengerBW305.class, ItemIDs.minecartPassengerBW305.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0,TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Green", "Yellow", "Blue", "Magenta", "Cyan"}), 0, 0, "Pack: Trams in Motion" ),
	locoElectricTW305("TW305",EntityLocoElectricTW305.class, ItemIDs.minecartLocoElectricTW305.item,"electric",350,55,0,10,0,140,0.75,0.7,0,TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Green", "Yellow", "Blue", "Magenta", "Cyan"}),14,-2,"Pack: Trams in Motion"  ),
	...
	Class158("Class 158 Engine", EntityLocoDieselClass158.class, ItemIDs.minecartClass158engine.item, "diesel", 350, 145, 3,10, 0, 100, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Green", "Cyan", "Blue", "Purple", "Grey", "LightBlue","Lime", "LightGrey", "Yellow"}), 18, -4.95, "Pack: B.I.P."),
	Class158Coach("Class 158 Passenger Car", EntityClass158Coach.class, ItemIDs.minecartClass158car.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"White", "Green", "Cyan", "Blue", "Purple", "Grey","LightBlue","Lime", "LightGrey", "Yellow"}),0,0, "Pack: B.I.P."),
	Class153("Class 153 Engine", EntityLocoDieselClass153.class, ItemIDs.minecartClass153engine.item, "diesel", 350, 120, 1.4, 10,0,100,0.7,0.9,8000,TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Green", "Grey", "Orange", "Yellow","Blue","Lime", "Purple"}), 18, -4.25,"Pack: B.I.P."),
	Class153Coach("Class 153 Coach", EntityPassengerClass153.class, ItemIDs.minecartClass153Coach.item, "passenger", 0, 0, 1.4, 0,0,0,0,0,0,TraincraftUtil.getBytesFromColors(new String[] { "LightBlue", "Green", "Grey", "Orange", "Yellow","Blue","Lime", "Purple"}), 0, 0,"Pack: B.I.P."),
	...
	SNCB_M6_TAIL("SNCB_M6_TAIL", EntityPassengerSNCB_M6_TAIL.class, ItemIDs.minecartSNCB_M6_TAIL.item, "passenger", 0, 0, 3.0,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"White"}),0,-4.15, "Pack: B.I.P."),
	...
	BR_MK2F_BSO("BR_MK2F_BSO", EntityPassengerBR_MK2F_BSO.class, ItemIDs.minecartBR_Mk2f_BSO.item, "passenger",0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Brown", "Cyan", "Grey", "Magenta", "Red", "Lime", "Purple", "Black", "Orange", "LightGrey"}),0, 0, "Pack: B.I.P."),
	...
	BR_MK2F_DBSO("BR_MK2F_DBSO", EntityElectricBR_MK2F_DBSO.class, ItemIDs.minecartBR_Mk2f_DBSO.item, "electric", 1400, 161, 3.3, 60,0,0, 0.8, 0.8, 0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Grey", "LightBlue", "Purple", "Yellow", "Black", "Red"}), 18, -4.03, "Pack: B.I.P."),
	BR_MK3_DVT("BR_MK3_DVT", EntityElectricBR_MK3_DVT.class, ItemIDs.minecartBR_MK3_DVT.item, "electric", 1500, 201, 3, 60,0,0, 0.8, 0.8, 0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Grey", "LightGrey", "Red", "White", "Yellow", "LightBlue"}), 18, -4, "Pack: B.I.P."),
	BR_MK3_Buffet("BR_MK3_Buffet", EntityPassengerBR_MK3_Buffet.class, ItemIDs.minecartBR_MK3_Buffet.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green",  "Magenta", "Yellow", "LightBlue", "Grey", "Purple", "Orange"}),0,0, "Pack: B.I.P."),
	BR_MK3_Coach("BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green",  "Magenta", "Yellow", "Grey", "Lime", "LightBlue", "Purple", "Skin16", "Skin17", "Skin18"}),0,0, "Pack: B.I.P."),
	...
	BR_MK4_DVT("BR_MK4_DVT", EntityElectricBR_MK4_DVT.class, ItemIDs.minecartBR_MK4_DVT.item, "electric", 1500, 260, 0,25, 0, 100, 0.8, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red","White", "Black", "Pink"}), 18, -4.65, "Pack: B.I.P."),
	...
	BR_Black_5("BR_Black_5", EntityLocoSteamBR_Black_5.class, ItemIDs.minecartBR_Black_5.item, "steam", 1450, 149, 3, 10, 10 , 100, 0.7, 0.7, 6000, TraincraftUtil.getBytesFromColors(new String[]   {"Black", "Grey", "LightGrey", "Red", "White", "Magenta", "Yellow"}), 18, -3.5f, "Pack: B.I.P."),
	Class43("Class43", EntityLocoDieselClass43.class, ItemIDs.minecartClass43.item, "diesel", 2250, 238, 0, 25, 0, 180, 0.89, 0.8, 13000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Blue", "Brown", "Green", "Red", "Cyan", "LightBlue", "Orange", "Yellow", "Purple", "Pink"}), 0, -3.15),
	Class90("Class90", EntityElectricClass90.class, ItemIDs.minecartClass90.item, "electric", 5000, 178, 0,60, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "LightGrey", "Grey", "Pink", "Red", "White", "Magenta", "Brown"}), 18, -2.75),
	Class91("Class91", EntityElectricClass91.class, ItemIDs.minecartClass91.item, "electric", 6300, 260, 0,60, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Red", "White", "Pink"}), 18, -4.2),
	Class321("Class321", EntityElectricClass321.class, ItemIDs.minecartClass321.item, "electric", 1438, 178, 0,60, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Grey", "White", "Red", "Green"}), 18, -4,"Pack: B.I.P."),
	...
	GWR_101_Class("GWR101Class", EntityLocoSteamGWR101Class.class, ItemIDs.minecartGWR101Class.item, "steam", 550, 51, 0, 10, 10 , 100, 0.7, 0.7, 9500, TraincraftUtil.getBytesFromColors(new String[]   {"Blue", "Brown", "Green", "Grey", "Lime", "Purple", "Red"}), 18, -2.4f, "Pack: B.I.P."),
	B80C_A("B80C_A", EntityElectricB80C_A.class, ItemIDs.minecartB80C_A.item, "electric", 300, 80, 0,60, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Grey", "White","Pink","Yellow","Green", "Orange"}), 18, -2.4, "Pack: Metro In Motion"),
	B80C_B("B80C_B", EntityPassengerB80C_B.class, ItemIDs.minecartB80C_B.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Red", "Grey", "White","Pink","Yellow","Green", "Orange"}),0,0, "Pack: Metro In Motion"),
	...
	DuewagGT6ZRLoco("DuewagGT6ZRLoco", EntityElectricDuewagGT6ZRLoco.class, ItemIDs.minecartDuewagGT6ZRLoco.item, "electric", 250, 70, 0,20, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Green","Blue","Grey","Cyan","Lime"}), 18, -1.9, "Pack: Trams In Motion"),
	DuewagGT6ZRTail("DuewagGT6ZRTail", EntityPassengerDuewagGT6ZRTail.class, ItemIDs.minecartDuewagGT6ZRTail.item, "passenger", 0, 0, 1,0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Green","Blue","Grey","Cyan","Lime"}), 18, -1.9, "Pack: Trams In Motion"),
	...
	Class416Tail("Class416Tail", EntityPassengerClass416Tail.class, ItemIDs.minecartClass416Tail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Cyan", "Green", "Grey", "LightBlue"}), 18, 0, "Pack: B.I.P." ),
	...
	Class401Engine("Class401Engine",EntityLocoElectricClass401.class, ItemIDs.minecartClass401Loco.item, "electric", 428, 121, 0, 7, 0, 0, 0.5, 0.9, 0, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Lime", "Green", "Grey", "LightBlue"}), 18, -3.75, "Pack: B.I.P." ),
	...
	DuewagGT6ERLoco("DuewagGT6ERLoco", EntityElectricDuewagGT6ERLoco.class, ItemIDs.minecartDuewagGT6ERLoco.item, "electric", 250, 70, 0,20, 0, 100, 0.7, 0.8, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Magenta","Green","Blue","White","Grey"}), 18, -1.9, "Pack: Trams In Motion"),
	DuewagGT6ERTail("DuewagGT6ERTail", EntityPassengerDuewagGT6ERTail.class, ItemIDs.minecartDuewagGT6ERTail.item, "passenger", 0, 0, 1,0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Magenta","Green","Blue","White","Grey"}), 18, -1.9, "Pack: Trams In Motion"),
	;
