...
public class EntityHandler {
	public static void init() {	
		...
		EntityRegistry.registerModEntity(EntityBogie.class, "Entity Front Bogie", EntityIds.LOCOMOTIVE_BOGIE, Traincraft.instance, 800, 3, true);//front bogie
		...
		for(EnumTrains trains : EnumTrains.values()){
			EntityRegistry.registerModEntity(trains.getEntityClass(), trains.getInternalName(), trainID, Traincraft.instance, 800, 3, true);
			trainID++;
