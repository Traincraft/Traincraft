...
public enum Tracks{
	...
	DETECTOR_STEAM_LOCOMOTIVES(2, "detector.steam", 8, BlockDetectorSteamLocomotiveTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft steam locomotives"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.fireboxSteel, 'C', TiMItems.steelPinCircuit),
	DETECTOR_DIESEL_LOCOMOTIVES(2, "detector.diesel", 8, BlockDetectorDieselLocomotiveTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft diesel locomotives"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMFluids.bucketDiesel, 'C', TiMItems.steelPinCircuit),
	...
	ENERGY_TRACK(4, "energy", 16, BlockEnergyTrack.class,Arrays.asList("A track that can transfer power to", "Traincraft electric locomotives","Power it with a redstone power source","See the Traincraft guide for more info"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_STONE.stack, 'B', TiMItems.copperWire, 'C', Items.ender_pearl),
