...
public enum Tracks{
	...
	DETECTOR_FREIGHT(2, "detector.freight", 8, BlockDetectorFreightTrack.class, Arrays.asList("Emits a redstone signal on all","passing Traincraft freight carts"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', Blocks.chest, 'C', TiMItems.steelPinCircuit),
	DETECTOR_PASSENGER(2, "detector.passenger", 8, BlockDetectorPassengerTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft passengers carts"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.seatsWooden, 'C', TiMItems.steelPinCircuit),
	DETECTOR_ALL_LOCOMOTIVES(2, "detector.loco", 8, BlockDetectorAllLocomotiveTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft locomotives"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.controlPanel, 'C', TiMItems.steelPinCircuit),
	DETECTOR_STEAM_LOCOMOTIVES(2, "detector.steam", 8, BlockDetectorSteamLocomotiveTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft steam locomotives"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.fireboxIron, 'C', TiMItems.steelPinCircuit),
	DETECTOR_DIESEL_LOCOMOTIVES(2, "detector.diesel", 8, BlockDetectorDieselLocomotiveTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft diesel locomotives"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.mediumDieselEngine, 'C', TiMItems.steelPinCircuit),
	DETECTOR_TANK_CARTS(2, "detector.tank", 8, BlockDetectorTankCartsTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft tank carts"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', Items.water_bucket, 'C', TiMItems.steelPinCircuit),
	COUPLER_TRACK(2, "coupler", 8, BlockCouplerTrack.class,Arrays.asList("Will attach any passing rolling stock","(Railcraft carts included) when powered","An unpowered track will detach carts"), "#A#", "#B#", "# #", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.itemStake),
	...
	ANIMAL_BOARDING_TRACK(2, "boarding.animal", 8, BlockAnimalBoardingTrack.class,Arrays.asList("Will put any close animal inside the Stock car"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', Items.golden_carrot, 'C', TiMItems.seatsWooden),
	MOB_BOARDING_TRACK(2, "boarding.mob", 8, BlockMobBoardingTrack.class,Arrays.asList("Will put any close mob inside the Stock car"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', Items.bone, 'C', TiMItems.seatsWooden),
	...
	ENERGY_TRACK(4, "energy", 16, BlockEnergyTrack.class,Arrays.asList("A track that can transfer power to", "Traincraft electric locomotives","Power it with a redstone power source","See the Traincraft guide for more info"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_STONE.stack, 'B', TiMItems.copperWire, 'C', TiMItems.seatsWooden),
	LOCO_SPEED_CONTROLLER(5, "speed.loco", 8, BlockLocomotiveSpeedControllerTrack.class,Arrays.asList("Controls Traincraft locomotive's max speed","Use a crowbar to change the mode"), "#A#", "#B#", "#B#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.controlPanel),
	...
	HORN_ALL_LOCOMOTIVES(2, "horn.loco", 8, BlockDetectorHornAllLocomotiveTrack.class,Arrays.asList("Sounds the horn on all","passing Traincraft locomotives"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', Items.sign, 'C', TiMItems.steelPinCircuit),
