...
public enum Tracks{
	...
	DETECTOR_PASSENGER(2, "detector.passenger", 8, BlockDetectorPassengerTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft passengers carts"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.seatsWooden, 'C', ItemIDs.electronicCircuit.item),
	DETECTOR_ALL_LOCOMOTIVES(2, "detector.loco", 8, BlockDetectorAllLocomotiveTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft locomotives"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.controlPanel, 'C', ItemIDs.electronicCircuit.item),
	DETECTOR_STEAM_LOCOMOTIVES(2, "detector.steam", 8, BlockDetectorSteamLocomotiveTrack.class,Arrays.asList("Emits a redstone signal on all","passing Traincraft steam locomotives"), "#A#", "#B#", "#C#", '#', RAIL_ADVANCED.stack, 'A', RAILBED_WOOD.stack, 'B', TiMItems.fireboxSteel, 'C', ItemIDs.electronicCircuit.item),
