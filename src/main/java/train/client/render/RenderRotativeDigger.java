...
public class RenderRotativeDigger extends Render {
    ...
    private void render(EntityRotativeDigger digger, double x, double y, double z, float yaw, float f1) {
        GL11.glPushMatrix();
        GL11.glTranslatef((float) x, (float) y, (float) z);
        GL11.glRotatef(90F - yaw, 0.0F, 1.0F, 0.0F);
    ...
    public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
        render((EntityRotativeDigger) entity, d, d1, d2, f, f1);
    }
