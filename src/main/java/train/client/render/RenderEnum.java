...
public enum RenderEnum {
	...
	/** Tenders */
	tenderSmall(EntityTenderSmall.class, new ModelTender(), "tender2", true, new float[] { 0.0F, -0.5F, 0.0F }, new float[] { 0F, 90F, 0F }, new float[] { 0.75F, 0.75F, 0.75F }, "", 0, null, "", null, 0, false),
