...
public enum RenderEnum {
	...
	locoBR101(EntityLocoElectricBR101.class, new BR101_EngineModel(), "BR101_Engine", false, new float[] { -2.0F, 0.1F, 0.0F },  new float[] { 0F, 180F, 180F }, null, "", 0, null, "", null, 0, false),
	/** Steam */
