...
public class ModelGP9 extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 256;

	public ModelGP9() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[193] = new ModelRendererTurbo(this, 385, 97, textureX, textureY); // Box 211 erie large headlight
		bodyModel[194] = new ModelRendererTurbo(this, 505, 33, textureX, textureY, "lamp"); // Box 212 lamp
		bodyModel[195] = new ModelRendererTurbo(this, 401, 97, textureX, textureY); // Box 213 erie large headlight
		...
		bodyModel[250] = new ModelRendererTurbo(this, 289, 9, textureX, textureY); // Box 259
		bodyModel[251] = new ModelRendererTurbo(this, 329, 113, textureX, textureY); // Box 86
		bodyModel[252] = new ModelRendererTurbo(this, 225, 113, textureX, textureY); // Box 87
		bodyModel[253] = new ModelRendererTurbo(this, 49, 113, textureX, textureY); // Box 86
		bodyModel[254] = new ModelRendererTurbo(this, 241, 113, textureX, textureY); // Box 87
		bodyModel[255] = new ModelRendererTurbo(this, 281, 113, textureX, textureY); // Box 74
		bodyModel[256] = new ModelRendererTurbo(this, 257, 113, textureX, textureY, "lamp"); // Box 186 lamp
		bodyModel[257] = new ModelRendererTurbo(this, 297, 113, textureX, textureY, "lamp"); // Box 187 lamp
		bodyModel[258] = new ModelRendererTurbo(this, 353, 113, textureX, textureY); // Box 644
		bodyModel[259] = new ModelRendererTurbo(this, 377, 113, textureX, textureY); // Box 645
		bodyModel[260] = new ModelRendererTurbo(this, 121, 97, textureX, textureY); // Box 646
		bodyModel[261] = new ModelRendererTurbo(this, 401, 113, textureX, textureY); // Box 647
		bodyModel[262] = new ModelRendererTurbo(this, 425, 113, textureX, textureY); // Box 648
		bodyModel[263] = new ModelRendererTurbo(this, 305, 97, textureX, textureY); // Box 649
		bodyModel[264] = new ModelRendererTurbo(this, 177, 25, textureX, textureY, "lamp"); // Box 363 liveryimg 3 glow
		bodyModel[265] = new ModelRendererTurbo(this, 225, 25, textureX, textureY, "lamp"); // Box 364 liveryimg 3 glow
		bodyModel[266] = new ModelRendererTurbo(this, 433, 113, textureX, textureY); // Box 627
		bodyModel[267] = new ModelRendererTurbo(this, 369, 113, textureX, textureY); // Box 287
		bodyModel[268] = new ModelRendererTurbo(this, 329, 97, textureX, textureY, "lamp"); // Box 288 glow
		bodyModel[269] = new ModelRendererTurbo(this, 65, 105, textureX, textureY, "lamp"); // Box 162 rotating lamp?
		bodyModel[270] = new ModelRendererTurbo(this, 393, 113, textureX, textureY); // Box 165
		bodyModel[271] = new ModelRendererTurbo(this, 305, 105, textureX, textureY, "lamp"); // Box 162 rotating lamp?
		bodyModel[272] = new ModelRendererTurbo(this, 417, 113, textureX, textureY); // Box 165
		bodyModel[273] = new ModelRendererTurbo(this, 348, 125, textureX, textureY); // Box 3 cull
		bodyModel[274] = new ModelRendererTurbo(this, 372, 125, textureX, textureY); // Box 306
		bodyModel[275] = new ModelRendererTurbo(this, 44, 23, textureX, textureY, "lamp"); // Box 117 liveryimg 2
		bodyModel[276] = new ModelRendererTurbo(this, 55, 23, textureX, textureY, "lamp"); // Box 118 liveryimg 2
		bodyModel[277] = new ModelRendererTurbo(this, 22, 23, textureX, textureY, "lamp"); // Box 115 liveryimg 2
		bodyModel[278] = new ModelRendererTurbo(this, 33, 23, textureX, textureY, "lamp"); // Box 116 liveryimg 2
		bodyModel[279] = new ModelRendererTurbo(this, 67, 51, textureX, textureY); // Box 311
		bodyModel[280] = new ModelRendererTurbo(this, 467, 112, textureX, textureY); // Box 312
		bodyModel[281] = new ModelRendererTurbo(this, 457, 25, textureX, textureY); // Box 313
		bodyModel[282] = new ModelRendererTurbo(this, 225, 113, textureX, textureY); // Box 314
		bodyModel[283] = new ModelRendererTurbo(this, 86, 131, textureX, textureY); // Box 196 winterization hatch
		bodyModel[284] = new ModelRendererTurbo(this, 413, 65, textureX, textureY); // Box 254
		bodyModel[285] = new ModelRendererTurbo(this, 399, 65, textureX, textureY); // Box 255
		bodyModel[286] = new ModelRendererTurbo(this, 407, 73, textureX, textureY); // Box 256
		bodyModel[287] = new ModelRendererTurbo(this, 134, 116, textureX, textureY); // Box 89
		bodyModel[288] = new ModelRendererTurbo(this, 104, 116, textureX, textureY); // Box 89
		bodyModel[289] = new ModelRendererTurbo(this, 112, 127, textureX, textureY); // Box 196 winterization hatch
		bodyModel[290] = new ModelRendererTurbo(this, 399, 68, textureX, textureY); // Box 255
		bodyModel[291] = new ModelRendererTurbo(this, 411, 68, textureX, textureY); // Box 255
		bodyModel[292] = new ModelRendererTurbo(this, 406, 69, textureX, textureY); // Box 256
		bodyModel[293] = new ModelRendererTurbo(this, 406, 65, textureX, textureY); // Box 254
		bodyModel[294] = new ModelRendererTurbo(this, 32, 62, textureX, textureY); // Box 203
		bodyModel[295] = new ModelRendererTurbo(this, 36, 65, textureX, textureY); // Box 204
		bodyModel[296] = new ModelRendererTurbo(this, 14, 82, textureX, textureY); // Box 190
		bodyModel[297] = new ModelRendererTurbo(this, 18, 87, textureX, textureY); // Box 188
		bodyModel[298] = new ModelRendererTurbo(this, 25, 86, textureX, textureY); // Box 190
		bodyModel[299] = new ModelRendererTurbo(this, 25, 91, textureX, textureY); // Box 190
		bodyModel[300] = new ModelRendererTurbo(this, 10, 87, textureX, textureY); // Box 188
		bodyModel[301] = new ModelRendererTurbo(this, 3, 86, textureX, textureY); // Box 190
		bodyModel[302] = new ModelRendererTurbo(this, 3, 91, textureX, textureY); // Box 190
		bodyModel[303] = new ModelRendererTurbo(this, 18, 73, textureX, textureY); // Box 188
		bodyModel[304] = new ModelRendererTurbo(this, 25, 72, textureX, textureY); // Box 190
		bodyModel[305] = new ModelRendererTurbo(this, 25, 77, textureX, textureY); // Box 190
		bodyModel[306] = new ModelRendererTurbo(this, 10, 73, textureX, textureY); // Box 188
		bodyModel[307] = new ModelRendererTurbo(this, 3, 68, textureX, textureY); // Box 190
		bodyModel[308] = new ModelRendererTurbo(this, 3, 77, textureX, textureY); // Box 190
		bodyModel[309] = new ModelRendererTurbo(this, 14, 68, textureX, textureY); // Box 241
		...
		bodyModel[168].setRotationPoint(-4.5F, -24F, -2.5F);

		bodyModel[169].addBox(0F, 0F, 0F, 5, 1, 5, 0F); // Box 187
		bodyModel[169].setRotationPoint(-10F, -24F, -2.5F);
		...
		bodyModel[178].addBox(0F, 0F, 0F, 7, 2, 6, 0F); // Box 196 winterization hatch
		bodyModel[178].setRotationPoint(18F, -25F, -3F);
		...
		bodyModel[235].setRotationPoint(19.5F, -27F, -1F);

		bodyModel[236].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 240
		bodyModel[236].setRotationPoint(18F, -27F, 0F);

		bodyModel[237].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 241
		bodyModel[237].setRotationPoint(19.5F, -26F, -0.5F);
		...
		bodyModel[250].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 259
		bodyModel[250].setRotationPoint(-30F, -25F, -2F);

		bodyModel[251].addBox(0F, 0F, 0F, 7, 7, 3, 0F); // Box 86
		bodyModel[251].setRotationPoint(-21.5F, -15F, -5F);
		bodyModel[251].rotateAngleY = -0.38397244F;

		bodyModel[252].addBox(0F, 0F, 0F, 1, 7, 10, 0F); // Box 87
		bodyModel[252].setRotationPoint(-21.4F, -15F, -4F);

		bodyModel[253].addBox(0F, 0F, 0F, 2, 2, 2, 0F); // Box 86
		bodyModel[253].setRotationPoint(-18.4F, -17F, -5.5F);
		bodyModel[253].rotateAngleY = -0.38397244F;

		bodyModel[254].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 87
		bodyModel[254].setRotationPoint(-20.4F, -16.75F, -4F);
		bodyModel[254].rotateAngleY = -0.38397244F;

		bodyModel[255].addBox(0F, 0F, 0F, 2, 4, 2, 0F); // Box 74
		bodyModel[255].setRotationPoint(-24F, -24.5F, -1F);

		bodyModel[256].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 186 lamp
		bodyModel[256].setRotationPoint(-24.25F, -24.5F, -1F);

		bodyModel[257].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 187 lamp
		bodyModel[257].setRotationPoint(-24.25F, -22.5F, -1F);

		bodyModel[258].addShapeBox(0F, 0F, 0F, 2, 2, 6, 0F,-2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 644
		bodyModel[258].setRotationPoint(-24F, -22.5F, -7F);

		bodyModel[259].addShapeBox(0F, 0F, 0F, 2, 2, 6, 0F,-2F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 645
		bodyModel[259].setRotationPoint(-24F, -24.5F, -7F);

		bodyModel[260].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,-1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F); // Box 646
		bodyModel[260].setRotationPoint(-23F, -24.5F, -2F);

		bodyModel[261].addShapeBox(0F, 0F, 0F, 2, 2, 6, 0F,0F, 0F, 0F, 0F, 0F, -1F, 0F, -1.5F, 0F, -2F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F); // Box 647
		bodyModel[261].setRotationPoint(-24F, -24.5F, 1F);

		bodyModel[262].addShapeBox(0F, 0F, 0F, 2, 2, 6, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F); // Box 648
		bodyModel[262].setRotationPoint(-24F, -22.5F, 1F);

		bodyModel[263].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F); // Box 649
		bodyModel[263].setRotationPoint(-23F, -24.5F, 1F);

		bodyModel[264].addBox(0F, 0F, 0F, 0, 2, 5, 0F); // Box 363 liveryimg 3 glow
		bodyModel[264].setRotationPoint(-22.35F, -22.5F, -6F);
		bodyModel[264].rotateAngleY = 0.32288591F;

		bodyModel[265].addBox(0F, 0F, -5F, 0, 2, 5, 0F); // Box 364 liveryimg 3 glow
		bodyModel[265].setRotationPoint(-22.4F, -22.5F, 6F);
		bodyModel[265].rotateAngleY = -0.31415927F;

		bodyModel[266].addBox(0F, 0F, 0F, 1, 3, 14, 0F); // Box 627
		bodyModel[266].setRotationPoint(-11F, -23F, -7F);

		bodyModel[267].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0.3F, -0.5F, 0.1F, -1F, -0.5F, 0.1F, -1F, -0.5F, 0.1F, 0.3F, -0.5F, 0.1F, 0.3F, 0F, 0.1F, -1F, 0F, 0.1F, -1F, 0F, 0.1F, 0.3F, 0F, 0.1F); // Box 287
		bodyModel[267].setRotationPoint(-29.32F, -24F, -0.5F);

		bodyModel[268].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F); // Box 288 glow
		bodyModel[268].setRotationPoint(-29.47F, -24F, -0.5F);

		bodyModel[269].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F); // Box 162 rotating lamp?
		bodyModel[269].setRotationPoint(-21.53F, -25.5F, -0.5F);

		bodyModel[270].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0.3F, -0.5F, 0.1F, -1F, -0.5F, 0.1F, -1F, -0.5F, 0.1F, 0.3F, -0.5F, 0.1F, 0.3F, 0F, 0.1F, -1F, 0F, 0.1F, -1F, 0F, 0.1F, 0.3F, 0F, 0.1F); // Box 165
		bodyModel[270].setRotationPoint(-21.37F, -25.5F, -0.5F);

		bodyModel[271].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F); // Box 162 rotating lamp?
		bodyModel[271].setRotationPoint(-11.53F, -25.5F, -0.5F);

		bodyModel[272].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0.3F, -0.5F, 0.1F, -1F, -0.5F, 0.1F, -1F, -0.5F, 0.1F, 0.3F, -0.5F, 0.1F, 0.3F, 0F, 0.1F, -1F, 0F, 0.1F, -1F, 0F, 0.1F, 0.3F, 0F, 0.1F); // Box 165
		bodyModel[272].setRotationPoint(-11.37F, -25.5F, -0.5F);

		bodyModel[273].addShapeBox(0F, 0F, 0F, 6, 5, 5, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2.5F, 0F, 0F, -2.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2.5F, 0F, 0F, -2.5F); // Box 3 cull
		bodyModel[273].setRotationPoint(-19F, -20F, 10F);

		bodyModel[274].addShapeBox(0F, 0F, 0F, 6, 5, 5, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2.5F, 0F, 0F, -2.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2.5F, 0F, 0F, -2.5F); // Box 306
		bodyModel[274].setRotationPoint(-19F, -20F, -12.5F);

		bodyModel[275].addBox(0F, 0F, 0F, 0, 2, 5, 0F); // Box 117 liveryimg 2
		bodyModel[275].setRotationPoint(-31.51F, -20.5F, -6F);
		bodyModel[275].rotateAngleY = 0.4712389F;

		bodyModel[276].addBox(0F, 0F, -5F, 0, 2, 5, 0F); // Box 118 liveryimg 2
		bodyModel[276].setRotationPoint(-31.51F, -20.5F, 6F);
		bodyModel[276].rotateAngleY = -0.4712389F;

		bodyModel[277].addBox(0F, 0F, 0F, 0, 2, 5, 0F); // Box 115 liveryimg 2
		bodyModel[277].setRotationPoint(32.51F, -20.5F, -6F);
		bodyModel[277].rotateAngleY = -0.4712389F;

		bodyModel[278].addBox(0F, 0F, -5F, 0, 2, 5, 0F); // Box 116 liveryimg 2
		bodyModel[278].setRotationPoint(32.51F, -20.5F, 6F);
		bodyModel[278].rotateAngleY = 0.4712389F;

		bodyModel[279].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 311
		bodyModel[279].setRotationPoint(-34.5F, -19F, -1F);

		bodyModel[280].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 312
		bodyModel[280].setRotationPoint(34.5F, -17F, -1F);

		bodyModel[281].addShapeBox(0F, 0F, 0F, 4, 1, 0, 0F,0F, 0F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 5F, 0F, 0F, 5F, 0F, 0F, 0F, 0F); // Box 313
		bodyModel[281].setRotationPoint(-5F, -16F, -11.01F);

		bodyModel[282].addShapeBox(0F, 0F, 0F, 4, 1, 0, 0F,0F, 0F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 5F, 0F, 0F, 5F, 0F, 0F, 0F, 0F); // Box 314
		bodyModel[282].setRotationPoint(-5F, -16F, 11.01F);

		bodyModel[283].addBox(0F, 0F, 0F, 3, 4, 15, 0F); // Box 196 winterization hatch
		bodyModel[283].setRotationPoint(0F, -25F, -7.5F);

		bodyModel[284].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 254
		bodyModel[284].setRotationPoint(1F, -26.5F, -1F);

		bodyModel[285].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 255
		bodyModel[285].setRotationPoint(1F, -26.5F, 0F);

		bodyModel[286].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 256
		bodyModel[286].setRotationPoint(1F, -24.5F, -0.5F);

		bodyModel[287].addBox(0F, 0F, 0F, 7, 1, 7, 0F); // Box 89
		bodyModel[287].setRotationPoint(23F, -24F, -3.5F);

		bodyModel[288].addBox(0F, 0F, 0F, 7, 1, 7, 0F); // Box 89
		bodyModel[288].setRotationPoint(-8F, -24F, -3.5F);

		bodyModel[289].addBox(0F, 0F, 0F, 13, 2, 8, 0F); // Box 196 winterization hatch
		bodyModel[289].setRotationPoint(18F, -25F, -4F);

		bodyModel[290].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 255
		bodyModel[290].setRotationPoint(-1F, -25.75F, 1F);

		bodyModel[291].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 255
		bodyModel[291].setRotationPoint(1F, -25.75F, -2F);

		bodyModel[292].addBox(0F, 0F, 0F, 1, 1, 2, 0F); // Box 256
		bodyModel[292].setRotationPoint(1F, -25.5F, -1F);

		bodyModel[293].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 254
		bodyModel[293].setRotationPoint(-0.5F, -25.5F, -0.5F);

		bodyModel[294].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 203
		bodyModel[294].setRotationPoint(0F, -25F, 3F);

		bodyModel[295].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 204
		bodyModel[295].setRotationPoint(0.5F, -24F, 3F);

		bodyModel[296].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 190
		bodyModel[296].setRotationPoint(-37.25F, -5F, -6.75F);

		bodyModel[297].addShapeBox(0F, 0F, 0F, 1, 6, 2, 0F,0F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, 0F, 0F, 0F); // Box 188
		bodyModel[297].setRotationPoint(-37F, -9F, -4.75F);

		bodyModel[298].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 190
		bodyModel[298].setRotationPoint(-37.25F, -9F, -4.75F);

		bodyModel[299].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 190
		bodyModel[299].setRotationPoint(-37.25F, -7F, -4.75F);

		bodyModel[300].addShapeBox(0F, 0F, 0F, 1, 6, 2, 0F,0F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, 0F, 0F, 0F); // Box 188
		bodyModel[300].setRotationPoint(-37F, -9F, 2.75F);

		bodyModel[301].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 190
		bodyModel[301].setRotationPoint(-37.25F, -9F, 2.75F);

		bodyModel[302].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 190
		bodyModel[302].setRotationPoint(-37.25F, -7F, 2.75F);

		bodyModel[303].addShapeBox(0F, 0F, 0F, 1, 6, 2, 0F,-0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.25F, 0F, 0F); // Box 188
		bodyModel[303].setRotationPoint(37F, -9F, -4.75F);

		bodyModel[304].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 190
		bodyModel[304].setRotationPoint(37.25F, -9F, -4.75F);

		bodyModel[305].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 190
		bodyModel[305].setRotationPoint(37.25F, -7F, -4.75F);

		bodyModel[306].addShapeBox(0F, 0F, 0F, 1, 6, 2, 0F,-0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.25F, 0F, 0F); // Box 188
		bodyModel[306].setRotationPoint(37F, -9F, 2.75F);

		bodyModel[307].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 190
		bodyModel[307].setRotationPoint(37.25F, -9F, 2.75F);

		bodyModel[308].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 190
		bodyModel[308].setRotationPoint(37.25F, -7F, 2.75F);

		bodyModel[309].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 241
		bodyModel[309].setRotationPoint(37.25F, -5F, 4.75F);
	}
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		} */else if (entity instanceof AbstractTrains && DepreciatedUtil.getColorFromString(((AbstractTrains) entity).getColor()) == 89) {
			Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, "textures/trains/blombergB_Grey.png"));
			GL11.glPushMatrix();
	...
	public ModelRendererTurbo ModelGP9[];
}