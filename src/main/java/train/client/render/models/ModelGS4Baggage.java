...
public class ModelGS4Baggage extends ModelBase
{
    ...
    {
        gs4baggageModel = new ModelRendererTurbo[1];
        gs4baggageModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 88

        gs4baggageModel[0].addBox(0F, 0F, 0F, 110, 36, 22, 0F); // Box 88
        gs4baggageModel[0].setRotationPoint(-56F, -33F, -11F);
