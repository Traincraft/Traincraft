...
public class ModelPassengerHighSpeedCarZeroED extends ModelBase {
	...
	public ModelPassengerHighSpeedCarZeroED() {
		...
		box19 = new CustomModelRenderer(this, 195, 4, 256, 128);
		box19.addBox(0F, 0F, 0F, 8, 7, 0);
		box19.setPosition(22F, 0F, -5F);

		box2 = new CustomModelRenderer(this, 199, 14, 256, 128);
		box2.addBox(0F, 0F, 0F, 2, 2, 14);
		box2.setPosition(13F, 2F, -7F);

		box20 = new CustomModelRenderer(this, 199, 14, 256, 128);
		box20.addBox(0F, 0F, 0F, 2, 2, 14);
		box20.setPosition(25F, 2F, -7F);

		box21 = new CustomModelRenderer(this, 195, 4, 256, 128);
		box21.addBox(0F, 0F, 0F, 8, 7, 0);
		box21.setPosition(22F, 0F, 5F);

		box22 = new CustomModelRenderer(this, 145, 5, 256, 128);
		box22.addBox(0F, 0F, 0F, 8, 4, 16);
		box22.setPosition(16F, 1F, -8F);

		box23 = new CustomModelRenderer(this, 145, 5, 256, 128);
		box23.addBox(0F, 0F, 0F, 8, 4, 16);
		box23.setPosition(-24F, 1F, -8F);

		box24 = new CustomModelRenderer(this, 121, 1, 256, 128);
		box24.addBox(0F, 0F, 0F, 16, 3, 1);
		box24.setPosition(-28F, 3F, -6F);

		box25 = new CustomModelRenderer(this, 132, 96, 256, 128);
		...
		box26 = new CustomModelRenderer(this, 0, 39, 256, 128);
		box26.addBox(0F, 0F, 0F, 17, 5, 14);
		box26.setPosition(-9F, 1F, -6F);

		box27 = new CustomModelRenderer(this, 201, 64, 256, 128);
		...
		box28 = new CustomModelRenderer(this, 201, 64, 256, 128);
		...
		box29 = new CustomModelRenderer(this, 132, 96, 256, 128);
		...
		box38 = new CustomModelRenderer(this, 201, 64, 256, 128);
		...
		box39 = new CustomModelRenderer(this, 132, 96, 256, 128);
		...
		box4 = new CustomModelRenderer(this, 195, 4, 256, 128);
		box4.addBox(0F, 0F, 0F, 8, 7, 0);
		box4.setPosition(-30F, 0F, 5F);

		box40 = new CustomModelRenderer(this, 132, 96, 256, 128);
		...
		box84 = new CustomModelRenderer(this, 121, 1, 256, 128);
		box84.addBox(0F, 0F, 0F, 16, 3, 1);
		box84.setPosition(12F, 3F, 5F);

		box85 = new CustomModelRenderer(this, 121, 1, 256, 128);
		box85.addBox(0F, 0F, 0F, 16, 3, 1);
		box85.setPosition(12F, 3F, -6F);

		box86 = new CustomModelRenderer(this, 224, 5, 256, 128);
		box86.addBox(0F, 0F, 0F, 6, 4, 6);
		box86.setPosition(17F, 2F, -3F);

		box87 = new CustomModelRenderer(this, 224, 5, 256, 128);
		box87.addBox(0F, 0F, 0F, 6, 4, 6);
		box87.setPosition(-23F, 2F, -3F);

		box88 = new CustomModelRenderer(this, 53, 38, 256, 128);
		...
		box91 = new CustomModelRenderer(this, 53, 38, 256, 128);
		box91.addBox(0F, 0F, -2F, 1, 8, 1);
		box91.setPosition(-33F, 24F, 11F);
		box91.rotateAngleX = -0.22689280275926285F;

		box92 = new CustomModelRenderer(this, 58, 38, 256, 128);
