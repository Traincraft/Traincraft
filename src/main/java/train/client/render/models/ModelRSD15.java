...
public class ModelRSD15 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[120] = new ModelRendererTurbo(this, 60, 179, textureX, textureY); // SP cab headlight
		bodyModel[121] = new ModelRendererTurbo(this, 146, 107, textureX, textureY); // SP cab headligh
		bodyModel[122] = new ModelRendererTurbo(this, 387, 221, textureX, textureY); // cab headlight botm
		bodyModel[123] = new ModelRendererTurbo(this, 145, 116, textureX, textureY); // cab headlight top
		bodyModel[124] = new ModelRendererTurbo(this, 154, 200, textureX, textureY); // long hood headlight botm 
		bodyModel[125] = new ModelRendererTurbo(this, 178, 85, textureX, textureY); // long hood headlight top
		...
		bodyModel[144] = new ModelRendererTurbo(this, 399, 336, textureX, textureY); // rsd15 high hood low headlight (top rsd17)
		bodyModel[145] = new ModelRendererTurbo(this, 399, 342, textureX, textureY); // rsd15 high hood top headlight
		bodyModel[146] = new ModelRendererTurbo(this, 409, 232, textureX, textureY); // nose headlight l
		bodyModel[147] = new ModelRendererTurbo(this, 311, 337, textureX, textureY); // nose headlight r
		...
		bodyModel[310] = new ModelRendererTurbo(this, 43, 143, textureX, textureY); // cab numberboard l
		bodyModel[311] = new ModelRendererTurbo(this, 457, 194, textureX, textureY); // cab numberboard r
		bodyModel[312] = new ModelRendererTurbo(this, 68, 162, textureX, textureY); // long hood numberboard l
		bodyModel[313] = new ModelRendererTurbo(this, 95, 113, textureX, textureY); // long hood numberboard r
		...
		bodyModel[320] = new ModelRendererTurbo(this, 125, 89, textureX, textureY); // commander beacon
		bodyModel[321] = new ModelRendererTurbo(this, 159, 218, textureX, textureY); // Box 613
		bodyModel[322] = new ModelRendererTurbo(this, 502, 181, textureX, textureY); // sp emergency
		...
		bodyModel[327] = new ModelRendererTurbo(this, 371, 221, textureX, textureY); // SP cab mount numberboard
		...
		bodyModel[334] = new ModelRendererTurbo(this, 85, 140, textureX, textureY); // A&MT ditchlight l
		bodyModel[335] = new ModelRendererTurbo(this, 85, 146, textureX, textureY); // Box 361
		bodyModel[336] = new ModelRendererTurbo(this, 399, 216, textureX, textureY); // A&MT ditchlight r
		bodyModel[337] = new ModelRendererTurbo(this, 115, 110, textureX, textureY); // Box 238
		bodyModel[338] = new ModelRendererTurbo(this, 412, 211, textureX, textureY); // high hood numberboard r
		bodyModel[339] = new ModelRendererTurbo(this, 450, 202, textureX, textureY); // high hood numberboard l
		...
		bodyModel[374] = new ModelRendererTurbo(this, 85, 152, textureX, textureY); // rsd17 headlight low top
		bodyModel[375] = new ModelRendererTurbo(this, 46, 170, textureX, textureY); // rsd17 headlight low bottom
		...
		bodyModel[397] = new ModelRendererTurbo(this, 64, 171, textureX, textureY); // PRR cab siignalling
		bodyModel[398] = new ModelRendererTurbo(this, 123, 126, textureX, textureY); // commander beacon
		...
		bodyModel[419] = new ModelRendererTurbo(this, 429, 216, textureX, textureY); // rsd17 headlight low high
		bodyModel[420] = new ModelRendererTurbo(this, 429, 222, textureX, textureY); // rsd17 headlight low high long hood
		...
		bodyModel[428] = new ModelRendererTurbo(this, 311, 337, textureX, textureY); // SP headlight rear low r
		bodyModel[429] = new ModelRendererTurbo(this, 187, 86, textureX, textureY); // SP headlight rear low l
		...
		bodyModel[440] = new ModelRendererTurbo(this, 371, 221, textureX, textureY); // SP cab mount numberboard
		...
		bodyModel[454] = new ModelRendererTurbo(this, 147, 11, textureX, textureY); // RSD17 high hood numberboard l
		...
		bodyModel[457] = new ModelRendererTurbo(this, 135, 4, textureX, textureY); // RSD17longhoodnumberboardl
