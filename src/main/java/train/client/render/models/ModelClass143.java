...
public class ModelClass143 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[74] = new ModelRendererTurbo(this, 9, 17, textureX, textureY, "lamp"); // Lamp
		...
		bodyModel[1].setRotationPoint(-24F, 0.5F, 8.5F);
		...
		bodyModel[2].setRotationPoint(-24F, 0.5F, 8.5F);
		...
		bodyModel[3].setRotationPoint(-24F, 2.25F, 8.5F);
		...
		bodyModel[4].setRotationPoint(12F, 5F, 8.5F);

		bodyModel[5].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 67
		bodyModel[5].setRotationPoint(12F, 1.75F, 9F);
		...
		bodyModel[6].setRotationPoint(-16F, 5F, 8.5F);

		bodyModel[7].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 67
		bodyModel[7].setRotationPoint(-16F, 1.75F, 9F);

		bodyModel[8].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 70
		bodyModel[8].setRotationPoint(20F, 1.75F, 9F);
		...
		bodyModel[9].setRotationPoint(20F, 5F, 8.5F);

		bodyModel[10].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 70
		bodyModel[10].setRotationPoint(-8F, 1.75F, 9F);
		...
		bodyModel[11].setRotationPoint(-8F, 5F, 8.5F);
		...
		bodyModel[12].setRotationPoint(-24F, 2.25F, -7.5F);
		...
		bodyModel[13].setRotationPoint(-24F, 0.5F, -7.5F);
		...
		bodyModel[14].setRotationPoint(-24F, 0.5F, -7.5F);

		bodyModel[15].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 64
		bodyModel[15].setRotationPoint(12F, 1.75F, -8F);
		...
		bodyModel[16].setRotationPoint(15F, 5F, -7.5F);

		bodyModel[17].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 70
		bodyModel[17].setRotationPoint(-8F, 1.75F, -8F);
		...
		bodyModel[18].setRotationPoint(-8F, 5F, -7.5F);

		bodyModel[19].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 64
		bodyModel[19].setRotationPoint(-16F, 1.75F, -8F);
		...
		bodyModel[20].setRotationPoint(-16F, 5F, -7.5F);

		bodyModel[21].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 70
		bodyModel[21].setRotationPoint(20F, 1.75F, -8F);
		...
		bodyModel[22].setRotationPoint(23F, 5F, -7.5F);
		...
		bodyModel[23].setRotationPoint(-16F, 6.5F, -8.5F);
		...
		bodyModel[24].setRotationPoint(-16F, 6.5F, 8.5F);

		bodyModel[25].addBox(0F, 0F, 0F, 1, 5, 20, 0F); // Box 1
		bodyModel[25].setRotationPoint(-29F, -0.5F, -9F);
		...
		bodyModel[26].setRotationPoint(28F, 0.5F, -9.5F);

		bodyModel[27].addBox(0F, 0F, 0F, 1, 1, 16, 0F); // Box 0
		bodyModel[27].setRotationPoint(-12F, 4.5F, -7F);

		bodyModel[28].addBox(0F, 0F, 0F, 57, 1, 20, 0F); // Box 1
		bodyModel[28].setRotationPoint(-28F, -0.5F, -9F);

		bodyModel[29].addBox(0F, 0F, 0F, 2, 2, 2, 0F); // Box 0
		bodyModel[29].setRotationPoint(-12.5F, 4F, 0F);

		bodyModel[30].addBox(0F, 0F, 0F, 2, 2, 2, 0F); // Box 0
		bodyModel[30].setRotationPoint(15.5F, 4F, 0F);
		...
		bodyModel[31].setRotationPoint(18.5F, 5F, -7.5F);
		...
		bodyModel[32].setRotationPoint(17.5F, 4F, -7.5F);

		bodyModel[33].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 57
		bodyModel[33].setRotationPoint(16.5F, 5F, -7.5F);
		...
		bodyModel[34].setRotationPoint(13.5F, 5F, -7.5F);
		...
		bodyModel[35].setRotationPoint(14.5F, 4F, -7.5F);

		bodyModel[36].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 57
		bodyModel[36].setRotationPoint(14.5F, 5F, -7.5F);
		...
		bodyModel[37].setRotationPoint(-9.5F, 5F, -7.5F);
		...
		bodyModel[38].setRotationPoint(-10.5F, 4F, -7.5F);

		bodyModel[39].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 57
		bodyModel[39].setRotationPoint(-11.5F, 5F, -7.5F);
		...
		bodyModel[40].setRotationPoint(-14.5F, 5F, -7.5F);
		...
		bodyModel[42].setRotationPoint(-13.5F, 5F, -7.5F);
		...
		bodyModel[43].setRotationPoint(18.5F, 5F, 8.5F);
		...
		bodyModel[44].setRotationPoint(17.5F, 4F, 8.5F);

		bodyModel[45].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 57
		bodyModel[45].setRotationPoint(16.5F, 5F, 8.5F);
		...
		bodyModel[46].setRotationPoint(13.5F, 5F, 8.5F);
		...
		bodyModel[47].setRotationPoint(14.5F, 4F, 8.5F);
		...
		bodyModel[49].setRotationPoint(-9.5F, 5F, 8.5F);
		...
		bodyModel[50].setRotationPoint(-10.5F, 4F, 8.5F);

		bodyModel[51].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 57
		bodyModel[51].setRotationPoint(-11.5F, 5F, 8.5F);
		...
		bodyModel[53].setRotationPoint(-13.5F, 4F, 8.5F);

		bodyModel[54].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 57
		bodyModel[54].setRotationPoint(-13.5F, 5F, 8.5F);
		...
		bodyModel[55].setRotationPoint(28F, 0.5F, 7.5F);
		...
		bodyModel[63].setRotationPoint(-30F, 2.5F, 4F);
		...
		bodyModel[64].setRotationPoint(-30F, 3.5F, 4F);

		bodyModel[65].addBox(0F, 0F, 0F, 3, 2, 18, 0F); // Box 64
		bodyModel[65].setRotationPoint(-27F, 0.5F, -8F);

		bodyModel[66].addBox(0F, 0F, 0F, 5, 8, 10, 0F); // Box 64
		bodyModel[66].setRotationPoint(23F, 0F, -4F);
		...
		bodyModel[73].setRotationPoint(-30F, -8.5F, -9F);

		bodyModel[74].addShapeBox(0F, 0F, 0F, 1, 30, 61, 0F,-0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -55F, -0.5F, 0F, -55F, -0.425F, -27F, 0F, 0F, -27F, 0F, 0F, -27F, -55F, -0.425F, -27F, -55F); // Lamp
		bodyModel[74].setRotationPoint(-30F, -17.5F, -2F);
		...
		bodyModel[75].setRotationPoint(-30F, -17.5F, -9F);
		...
		bodyModel[76].setRotationPoint(-30F, -17.5F, -3F);
		...
		bodyModel[77].setRotationPoint(-30F, -17.5F, 4F);
		...
		bodyModel[78].setRotationPoint(-30F, -17.5F, 10F);
		...
		bodyModel[79].setRotationPoint(-30F, -18.5F, -9F);

		bodyModel[80].addBox(0F, 0F, 0F, 58, 1, 20, 0F); // Box 1
		bodyModel[80].setRotationPoint(-29F, -18.5F, -9F);
		...
		bodyModel[81].setRotationPoint(-29F, -18.5F, -10F);
		...
		bodyModel[82].setRotationPoint(-29F, -18.5F, 11F);

		bodyModel[83].addBox(0F, 0F, 0F, 53, 2, 5, 0F); // Box 1
		bodyModel[83].setRotationPoint(-24F, -20.5F, -1.5F);
		...
		bodyModel[84].setRotationPoint(-24F, -20.5F, -9F);
		...
		bodyModel[85].setRotationPoint(-24F, -20.5F, 4F);
		...
		bodyModel[86].setRotationPoint(-29F, -20.5F, -9F);
		...
		bodyModel[90].setRotationPoint(29F, -21F, 7.5F);
		...
		bodyModel[91].setRotationPoint(-30F, -18.5F, -10F);
		...
		bodyModel[92].setRotationPoint(-30F, -18.5F, 11F);
		...
		bodyModel[93].setRotationPoint(-30F, -17.5F, -10F);
		...
		bodyModel[94].setRotationPoint(-30F, -8.5F, -10F);
		...
		bodyModel[95].setRotationPoint(-30F, -0.5F, 11F);
		...
		bodyModel[96].setRotationPoint(-30F, -1.5F, -10F);
		...
		bodyModel[97].setRotationPoint(-30F, -0.5F, -10F);
		...
		bodyModel[98].setRotationPoint(-29F, -0.5F, -10F);
		...
		bodyModel[99].setRotationPoint(-29F, -0.5F, 11F);

		bodyModel[100].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 85
		bodyModel[100].setRotationPoint(27F, 3F, 7.5F);

		bodyModel[101].addBox(0F, 0F, 0F, 1, 1, 3, 0F); // Box 85
		bodyModel[101].setRotationPoint(26F, 3F, 5.5F);
		...
		bodyModel[102].setRotationPoint(-12F, 4.5F, 9.5F);
		...
		bodyModel[103].setRotationPoint(-12.25F, 2.5F, 10F);
		...
		bodyModel[104].setRotationPoint(-12F, 1.75F, 9.5F);
		...
		bodyModel[105].setRotationPoint(16F, 4.5F, 9.5F);
		...
		bodyModel[106].setRotationPoint(15.75F, 2.5F, 10F);
		...
		bodyModel[107].setRotationPoint(16F, 1.75F, 9.5F);
		...
		bodyModel[108].setRotationPoint(-12F, 4.5F, -8.5F);
		...
		bodyModel[109].setRotationPoint(-12.25F, 2.5F, -9F);
		...
		bodyModel[110].setRotationPoint(-12F, 1.75F, -8.5F);
		...
		bodyModel[111].setRotationPoint(16F, 4.5F, -8.5F);
		...
		bodyModel[112].setRotationPoint(15.75F, 2.5F, -9F);
		...
		bodyModel[113].setRotationPoint(16F, 1.75F, -8.5F);
		...
		bodyModel[114].setRotationPoint(-11.5F, 5F, 8.25F);
		...
		bodyModel[115].setRotationPoint(-11.5F, 4F, 8.25F);
		...
		bodyModel[116].setRotationPoint(-12.5F, 4F, 8.25F);
		...
		bodyModel[117].setRotationPoint(-12.5F, 5F, 8.25F);
		...
		bodyModel[118].setRotationPoint(-11.5F, 4F, -7.75F);
		...
		bodyModel[119].setRotationPoint(-12.5F, 4F, -7.75F);
		...
		bodyModel[120].setRotationPoint(-12.5F, 5F, -7.75F);
		...
		bodyModel[121].setRotationPoint(-11.5F, 5F, -7.75F);
		...
		bodyModel[122].setRotationPoint(16.5F, 5F, 8.25F);
		...
		bodyModel[123].setRotationPoint(16.5F, 4F, 8.25F);
		...
		bodyModel[124].setRotationPoint(15.5F, 4F, 8.25F);
		...
		bodyModel[125].setRotationPoint(15.5F, 5F, 8.25F);
		...
		bodyModel[126].setRotationPoint(16.5F, 4F, -7.75F);
		...
		bodyModel[127].setRotationPoint(15.5F, 4F, -7.75F);
		...
		bodyModel[128].setRotationPoint(15.5F, 5F, -7.75F);
		...
		bodyModel[129].setRotationPoint(16.5F, 5F, -7.75F);

		bodyModel[130].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 1
		bodyModel[130].setRotationPoint(-16.5F, 0F, -5F);

		bodyModel[131].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 1
		bodyModel[131].setRotationPoint(-16.5F, 0F, 7F);

		bodyModel[132].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 1
		bodyModel[132].setRotationPoint(11.5F, 0F, -5F);
		...
		bodyModel[135].setRotationPoint(-30F, -17.5F, 11F);
		...
		bodyModel[136].setRotationPoint(-30F, -1.5F, 11F);
		...
		bodyModel[137].setRotationPoint(-29F, -1.5F, -10F);
		...
		bodyModel[138].setRotationPoint(-29F, -4.5F, -10.05F);
		...
		bodyModel[139].setRotationPoint(-29F, -8.5F, -10.1F);
		...
		bodyModel[140].setRotationPoint(-29F, -17.5F, -9.75F);
		...
		bodyModel[141].setRotationPoint(-10F, -1.5F, -10F);
		...
		bodyModel[142].setRotationPoint(-10F, -4.5F, -10.05F);
		...
		bodyModel[143].setRotationPoint(-10F, -8.5F, -10.1F);
		...
		bodyModel[144].setRotationPoint(-10F, -17.5F, -9.75F);
		...
		bodyModel[145].setRotationPoint(-29F, 6.5F, -9F);
		...
		bodyModel[146].setRotationPoint(-29F, 6.5F, 4F);
		...
		bodyModel[147].setRotationPoint(-29F, 6.5F, -2F);
		...
		bodyModel[148].setRotationPoint(-18F, -17.5F, -9.5F);
		...
		bodyModel[149].setRotationPoint(-29F, -1.5F, 11F);
		...
		bodyModel[150].setRotationPoint(-29F, -4.5F, 11.05F);
		...
		bodyModel[151].setRotationPoint(-29F, -8.5F, 11.1F);
		...
		bodyModel[152].setRotationPoint(-29F, -17.5F, 10.75F);
		...
		bodyModel[153].setRotationPoint(-10F, -1.5F, 11F);
		...
		bodyModel[154].setRotationPoint(-10F, -4.5F, 11.05F);
		...
		bodyModel[155].setRotationPoint(-10F, -8.5F, 11.1F);
		...
		bodyModel[156].setRotationPoint(-10F, -17.5F, 10.75F);
		...
		bodyModel[157].setRotationPoint(-18F, -17.5F, 10.5F);
		...
		bodyModel[158].setRotationPoint(20F, -1.5F, 10F);
		...
		bodyModel[159].setRotationPoint(20F, -4.5F, 10.05F);
		...
		bodyModel[160].setRotationPoint(20F, -8.5F, 10.1F);
		...
		bodyModel[161].setRotationPoint(20F, -17.5F, 9.75F);
		...
		bodyModel[162].setRotationPoint(21F, -17.5F, 10.5F);

		bodyModel[163].addBox(0F, 0F, 0F, 6, 3, 18, 0F); // Box 64
		bodyModel[163].setRotationPoint(5F, 0.5F, -8F);
		...
		bodyModel[164].setRotationPoint(28F, -1.5F, -10F);
		...
		bodyModel[165].setRotationPoint(28F, -4.5F, -10.05F);
		...
		bodyModel[166].setRotationPoint(28F, -8.5F, -10.1F);
		...
		bodyModel[167].setRotationPoint(28F, -17.5F, -9.75F);
		...
		bodyModel[168].setRotationPoint(28F, -1.5F, 10F);
		...
		bodyModel[169].setRotationPoint(28F, -4.5F, 10.05F);
		...
		bodyModel[170].setRotationPoint(28F, -8.5F, 10.1F);
		...
		bodyModel[171].setRotationPoint(28F, -17.5F, 9.75F);

		bodyModel[172].addBox(0F, 0F, 0F, 1, 17, 7, 0F); // Box 150
		bodyModel[172].setRotationPoint(28F, -17.5F, -9F);

		bodyModel[173].addBox(0F, 0F, 0F, 1, 17, 7, 0F); // Box 150
		bodyModel[173].setRotationPoint(28F, -17.5F, 4F);

		bodyModel[174].addBox(0F, 0F, 0F, 1, 1, 6, 0F); // Box 150
		bodyModel[174].setRotationPoint(28F, -17.5F, -2F);

		bodyModel[175].addBox(0F, 0F, 0F, 3, 1, 8, 0F); // Box 0
		bodyModel[175].setRotationPoint(29.25F, -0.5F, -3F);

		bodyModel[176].addBox(0F, 0F, 0F, 3, 1, 8, 0F); // Box 0
		bodyModel[176].setRotationPoint(29.25F, -17.5F, -3F);

		bodyModel[177].addBox(0F, 0F, 0F, 3, 16, 1, 0F); // Box 0
		bodyModel[177].setRotationPoint(29.25F, -16.5F, -3F);

		bodyModel[178].addBox(0F, 0F, 0F, 3, 16, 1, 0F); // Box 0
		bodyModel[178].setRotationPoint(29.25F, -16.5F, 4F);
		...
		bodyModel[179].setRotationPoint(30F, -16.5F, -2F);
		...
		bodyModel[180].setRotationPoint(12F, 6.5F, -8.5F);
		...
		bodyModel[181].setRotationPoint(12F, 6.5F, 8.5F);

		bodyModel[182].addBox(0F, 0F, 0F, 10, 4, 20, 0F); // Box 64
		bodyModel[182].setRotationPoint(-5F, 0.5F, -9F);

		bodyModel[183].addBox(0F, 0F, 0F, 8, 4, 16, 0F); // Box 64
		bodyModel[183].setRotationPoint(-27F, 2.5F, -7F);
		...
		bodyModel[184].setRotationPoint(-19F, -1.5F, -10F);
		...
		bodyModel[185].setRotationPoint(-19F, -4.5F, -10.05F);
		...
		bodyModel[186].setRotationPoint(-19F, -8.5F, -10.1F);
		...
		bodyModel[187].setRotationPoint(-19F, -17.5F, -9.75F);
		...
		bodyModel[188].setRotationPoint(-19F, -1.5F, 10F);
		...
		bodyModel[189].setRotationPoint(-19F, -4.5F, 10.05F);
		...
		bodyModel[190].setRotationPoint(-19F, -8.5F, 10.1F);
		...
		bodyModel[191].setRotationPoint(-19F, -17.5F, 9.75F);

		bodyModel[192].addBox(0F, 0F, 0F, 1, 17, 20, 0F); // Box 150
		bodyModel[192].setRotationPoint(-19F, -17.5F, -9F);

		bodyModel[193].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[193].setRotationPoint(-10F, -5F, 8.75F);

		bodyModel[194].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[194].setRotationPoint(-10F, -5F, 5.75F);
		...
		bodyModel[195].setRotationPoint(-7F, -11F, 8.75F);
		...
		bodyModel[196].setRotationPoint(-7F, -11F, 5.75F);

		bodyModel[197].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[197].setRotationPoint(-9F, -4F, 7.75F);

		bodyModel[198].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[198].setRotationPoint(-10F, -5F, -6.75F);

		bodyModel[199].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[199].setRotationPoint(-10F, -5F, -9.75F);
		...
		bodyModel[200].setRotationPoint(-10F, -11F, -6.75F);
		...
		bodyModel[201].setRotationPoint(-10F, -11F, -9.75F);

		bodyModel[202].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[202].setRotationPoint(-8F, -4F, -7.75F);

		bodyModel[203].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[203].setRotationPoint(-4F, -5F, 8.75F);

		bodyModel[204].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[204].setRotationPoint(-4F, -5F, 5.75F);
		...
		bodyModel[205].setRotationPoint(-1F, -11F, 8.75F);
		...
		bodyModel[206].setRotationPoint(-1F, -11F, 5.75F);

		bodyModel[207].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[207].setRotationPoint(-3F, -4F, 7.75F);

		bodyModel[208].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[208].setRotationPoint(-4F, -5F, -6.75F);

		bodyModel[209].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[209].setRotationPoint(-4F, -5F, -9.75F);
		...
		bodyModel[210].setRotationPoint(-4F, -11F, -6.75F);
		...
		bodyModel[211].setRotationPoint(-4F, -11F, -9.75F);

		bodyModel[212].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[212].setRotationPoint(-2F, -4F, -7.75F);

		bodyModel[213].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[213].setRotationPoint(2F, -5F, 8.75F);

		bodyModel[214].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[214].setRotationPoint(2F, -5F, 5.75F);
		...
		bodyModel[215].setRotationPoint(5F, -11F, 8.75F);
		...
		bodyModel[216].setRotationPoint(5F, -11F, 5.75F);

		bodyModel[217].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[217].setRotationPoint(3F, -4F, 7.75F);

		bodyModel[218].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[218].setRotationPoint(2F, -5F, -6.75F);

		bodyModel[219].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[219].setRotationPoint(2F, -5F, -9.75F);
		...
		bodyModel[220].setRotationPoint(2F, -11F, -6.75F);
		...
		bodyModel[221].setRotationPoint(2F, -11F, -9.75F);

		bodyModel[222].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[222].setRotationPoint(4F, -4F, -7.75F);

		bodyModel[223].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[223].setRotationPoint(8F, -5F, 8.75F);

		bodyModel[224].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[224].setRotationPoint(8F, -5F, 5.75F);
		...
		bodyModel[225].setRotationPoint(11F, -11F, 8.75F);
		...
		bodyModel[226].setRotationPoint(11F, -11F, 5.75F);

		bodyModel[227].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[227].setRotationPoint(9F, -4F, 7.75F);

		bodyModel[228].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[228].setRotationPoint(8F, -5F, -6.75F);

		bodyModel[229].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[229].setRotationPoint(8F, -5F, -9.75F);
		...
		bodyModel[230].setRotationPoint(8F, -11F, -6.75F);
		...
		bodyModel[231].setRotationPoint(8F, -11F, -9.75F);

		bodyModel[232].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[232].setRotationPoint(10F, -4F, -7.75F);

		bodyModel[233].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[233].setRotationPoint(14F, -5F, 8.75F);

		bodyModel[234].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[234].setRotationPoint(14F, -5F, 5.75F);
		...
		bodyModel[235].setRotationPoint(17F, -11F, 8.75F);
		...
		bodyModel[236].setRotationPoint(17F, -11F, 5.75F);

		bodyModel[237].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[237].setRotationPoint(15F, -4F, 7.75F);

		bodyModel[238].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[238].setRotationPoint(14F, -5F, -6.75F);

		bodyModel[239].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 104
		bodyModel[239].setRotationPoint(14F, -5F, -9.75F);
		...
		bodyModel[240].setRotationPoint(14F, -11F, -6.75F);
		...
		bodyModel[241].setRotationPoint(14F, -11F, -9.75F);

		bodyModel[242].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 104
		bodyModel[242].setRotationPoint(16F, -4F, -7.75F);

		bodyModel[243].addBox(0F, 0F, 0F, 0, 17, 20, 0F); // Box 102
		bodyModel[243].setRotationPoint(-10.5F, -17.5F, -9F);
		...
		bodyModel[244].setRotationPoint(-11F, -1.5F, -10F);
		...
		bodyModel[245].setRotationPoint(-11F, -4.5F, -10.05F);
		...
		bodyModel[246].setRotationPoint(-11F, -8.5F, -10.1F);
		...
		bodyModel[247].setRotationPoint(-11F, -17.5F, -9.75F);
		...
		bodyModel[248].setRotationPoint(-11F, -1.5F, 10F);
		...
		bodyModel[249].setRotationPoint(-11F, -4.5F, 10.05F);
		...
		bodyModel[250].setRotationPoint(-11F, -8.5F, 10.1F);
		...
		bodyModel[251].setRotationPoint(-11F, -17.5F, 9.75F);

		bodyModel[252].addBox(0F, 0F, 0F, 0, 17, 7, 0F); // Box 102
		bodyModel[252].setRotationPoint(20.5F, -17.5F, 5F);

		bodyModel[253].addShapeBox(0F, 0F, 0F, 1, 3, 1, 0F,-0.25F, 0F, 0.1F, 0F, 0F, 0.1F, 0F, 0F, -0.45F, -0.1F, 0F, -0.45F, 0F, 0F, 0.05F, 0F, 0F, 0.05F, 0F, 0F, -0.5F, 0F, 0F, -0.5F); // Box 1
		bodyModel[253].setRotationPoint(-30F, -4.5F, -10F);

		bodyModel[254].addShapeBox(0F, 0F, 0F, 1, 3, 1, 0F,-0.1F, 0F, -0.45F, 0F, 0F, -0.45F, 0F, 0F, 0.1F, -0.25F, 0F, 0.1F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0.05F, 0F, 0F, 0.05F); // Box 1
		bodyModel[254].setRotationPoint(-30F, -4.5F, 11F);
		...
		bodyModel[255].setRotationPoint(-30F, -8.5F, 11F);

		bodyModel[256].addBox(0F, 0F, 0F, 10, 7, 1, 0F); // Box 75
		bodyModel[256].setRotationPoint(-29F, -7.5F, -10F);

		bodyModel[257].addBox(0F, 0F, 0F, 3, 7, 3, 0F); // Box 75
		bodyModel[257].setRotationPoint(-29F, -7.5F, -3F);

		bodyModel[258].addBox(0F, 0F, 0F, 3, 2, 6, 0F); // Box 75
		bodyModel[258].setRotationPoint(-29F, -7.5F, -9F);
		...
		bodyModel[259].setRotationPoint(-29F, -8F, -8F);

		bodyModel[260].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 64
		bodyModel[260].setRotationPoint(-29F, -14.5F, -9.75F);

		bodyModel[261].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 64
		bodyModel[261].setRotationPoint(-29F, -9.5F, -2.75F);
		...
		bodyModel[262].setRotationPoint(-28F, -5.5F, 0F);

		bodyModel[263].addBox(0F, 0F, 0F, 1, 7, 12, 0F); // Box 75
		bodyModel[263].setRotationPoint(-29F, -7.5F, 0F);

		bodyModel[264].addBox(0F, 0F, 0F, 2, 7, 6, 0F); // Box 75
		bodyModel[264].setRotationPoint(-28F, -7.5F, 6F);
		...
		bodyModel[265].setRotationPoint(-28F, -8.5F, -2.75F);
		...
		bodyModel[266].setRotationPoint(-27F, -8.5F, -6.5F);
		...
		bodyModel[267].setRotationPoint(-27F, -8.5F, -6.5F);
		...
		bodyModel[268].setRotationPoint(-27.5F, -8.25F, -4.5F);
		...
		bodyModel[269].setRotationPoint(-27.5F, -8.5F, -8.75F);
		...
		bodyModel[270].setRotationPoint(-27.5F, -8.5F, -9.75F);

		bodyModel[271].addBox(0F, 0F, 0F, 3, 3, 2, 0F); // Box 1
		bodyModel[271].setRotationPoint(28F, 1F, 0F);

		bodyModel[272].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 5
		bodyModel[272].setRotationPoint(31F, 1F, 0F);

		bodyModel[273].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 6
		bodyModel[273].setRotationPoint(31F, 3F, 1F);

		bodyModel[274].addBox(0F, 0F, 0F, 5, 19, 1, 0F); // Box 102
		bodyModel[274].setRotationPoint(23F, -18F, -5F);
		...
		bodyModel[275].setRotationPoint(13F, -18F, -5F);
		...
		bodyModel[276].setRotationPoint(19F, -1.5F, -10F);
		...
		bodyModel[277].setRotationPoint(19F, -4.5F, -10.05F);
		...
		bodyModel[278].setRotationPoint(19F, -8.5F, -10.1F);
		...
		bodyModel[279].setRotationPoint(19F, -17.5F, -9.75F);
		...
		bodyModel[280].setRotationPoint(-18F, -13.5F, 10.7F);
		...
		bodyModel[281].setRotationPoint(-14F, -13.5F, 10.7F);
		...
		bodyModel[282].setRotationPoint(21F, -13.5F, 10.7F);
		...
		bodyModel[283].setRotationPoint(25F, -13.5F, 10.7F);
		...
		bodyModel[284].setRotationPoint(-18F, -13.5F, -9.7F);
		...
		bodyModel[285].setRotationPoint(-14F, -13.5F, -9.7F);

		bodyModel[286].addBox(0F, 0F, 0F, 6, 3, 18, 0F); // Box 64
		bodyModel[286].setRotationPoint(5F, 3.5F, -8F);

		bodyModel[287].addBox(0F, 0F, 0F, 10, 2, 18, 0F); // Box 64
		bodyModel[287].setRotationPoint(-5F, 4.5F, -8F);
	}
