...
public class ModelVersaLongi extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 64;

	public ModelVersaLongi() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[10] = new ModelRendererTurbo(this, 167, 61, textureX, textureY); // Box 28
		bodyModel[11] = new ModelRendererTurbo(this, 43, 37, textureX, textureY); // Box 32
		bodyModel[12] = new ModelRendererTurbo(this, 146, 42, textureX, textureY); // Box 38
		...
		bodyModel[19] = new ModelRendererTurbo(this, 167, 61, textureX, textureY); // Box 98
		bodyModel[20] = new ModelRendererTurbo(this, 196, 42, textureX, textureY); // Box 99
		bodyModel[21] = new ModelRendererTurbo(this, 151, 42, textureX, textureY); // Box 100
		bodyModel[22] = new ModelRendererTurbo(this, 161, 42, textureX, textureY); // Box 101
		bodyModel[23] = new ModelRendererTurbo(this, 156, 42, textureX, textureY); // Box 102
		bodyModel[24] = new ModelRendererTurbo(this, 191, 42, textureX, textureY); // Box 103
		bodyModel[25] = new ModelRendererTurbo(this, 186, 42, textureX, textureY); // Box 104
		bodyModel[26] = new ModelRendererTurbo(this, 181, 42, textureX, textureY); // Box 105
		bodyModel[27] = new ModelRendererTurbo(this, 176, 42, textureX, textureY); // Box 106
		bodyModel[28] = new ModelRendererTurbo(this, 166, 42, textureX, textureY); // Box 107
		...
		bodyModel[38] = new ModelRendererTurbo(this, 171, 42, textureX, textureY); // Box 117
		...
		bodyModel[43] = new ModelRendererTurbo(this, 226, 42, textureX, textureY); // Box 122
		bodyModel[44] = new ModelRendererTurbo(this, 221, 42, textureX, textureY); // Box 123
		bodyModel[45] = new ModelRendererTurbo(this, 216, 42, textureX, textureY); // Box 124
		bodyModel[46] = new ModelRendererTurbo(this, 211, 42, textureX, textureY); // Box 125
		bodyModel[47] = new ModelRendererTurbo(this, 206, 42, textureX, textureY); // Box 126
		bodyModel[48] = new ModelRendererTurbo(this, 201, 42, textureX, textureY); // Box 127
		bodyModel[49] = new ModelRendererTurbo(this, 231, 42, textureX, textureY); // Box 128
		bodyModel[50] = new ModelRendererTurbo(this, 236, 42, textureX, textureY); // Box 129
		bodyModel[51] = new ModelRendererTurbo(this, 241, 42, textureX, textureY); // Box 130
		bodyModel[52] = new ModelRendererTurbo(this, 246, 42, textureX, textureY); // Box 131
		bodyModel[53] = new ModelRendererTurbo(this, 251, 42, textureX, textureY); // Box 132
		...
		bodyModel[59] = new ModelRendererTurbo(this, 295, 34, textureX, textureY); // Box 138
		bodyModel[60] = new ModelRendererTurbo(this, 295, 47, textureX, textureY); // Box 139
		bodyModel[61] = new ModelRendererTurbo(this, 260, 47, textureX, textureY); // Box 140
		bodyModel[62] = new ModelRendererTurbo(this, 260, 34, textureX, textureY); // Box 141
		...
		bodyModel[66] = new ModelRendererTurbo(this, 400, 51, textureX, textureY); // Box 66
		...
		bodyModel[10].addBox(0F, 0F, 0F, 42, 1, 1, 0F); // Box 28
		bodyModel[10].setRotationPoint(-21F, -16F, -11F);
		...
		bodyModel[12].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 38
		bodyModel[12].setRotationPoint(-20F, -15F, -10.75F);
		...
		bodyModel[19].addBox(0F, 0F, 0F, 42, 1, 1, 0F); // Box 98
		bodyModel[19].setRotationPoint(-21F, -16F, 10F);

		bodyModel[20].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 99
		bodyModel[20].setRotationPoint(19F, -15F, -10.75F);

		bodyModel[21].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 100
		bodyModel[21].setRotationPoint(-16F, -15F, -10.75F);

		bodyModel[22].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 101
		bodyModel[22].setRotationPoint(-8F, -15F, -10.75F);

		bodyModel[23].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 102
		bodyModel[23].setRotationPoint(-12F, -15F, -10.75F);

		bodyModel[24].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 103
		bodyModel[24].setRotationPoint(15F, -15F, -10.75F);

		bodyModel[25].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 104
		bodyModel[25].setRotationPoint(11F, -15F, -10.75F);

		bodyModel[26].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 105
		bodyModel[26].setRotationPoint(7F, -15F, -10.75F);

		bodyModel[27].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 106
		bodyModel[27].setRotationPoint(3F, -15F, -10.75F);

		bodyModel[28].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 107
		bodyModel[28].setRotationPoint(-4F, -15F, -10.75F);
		...
		bodyModel[38].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 117
		bodyModel[38].setRotationPoint(-0.5F, -15F, -10.75F);
		...
		bodyModel[43].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 122
		bodyModel[43].setRotationPoint(-0.5F, -15F, 9.75F);

		bodyModel[44].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 123
		bodyModel[44].setRotationPoint(3F, -15F, 9.75F);

		bodyModel[45].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 124
		bodyModel[45].setRotationPoint(7F, -15F, 9.75F);

		bodyModel[46].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 125
		bodyModel[46].setRotationPoint(11F, -15F, 9.75F);

		bodyModel[47].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 126
		bodyModel[47].setRotationPoint(15F, -15F, 9.75F);

		bodyModel[48].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 127
		bodyModel[48].setRotationPoint(19F, -15F, 9.75F);

		bodyModel[49].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 128
		bodyModel[49].setRotationPoint(-4F, -15F, 9.75F);

		bodyModel[50].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 129
		bodyModel[50].setRotationPoint(-8F, -15F, 9.75F);

		bodyModel[51].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 130
		bodyModel[51].setRotationPoint(-12F, -15F, 9.75F);

		bodyModel[52].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 131
		bodyModel[52].setRotationPoint(-16F, -15F, 9.75F);

		bodyModel[53].addBox(0F, 0F, 0F, 1, 16, 1, 0F); // Box 132
		bodyModel[53].setRotationPoint(-20F, -15F, 9.75F);
		...
		bodyModel[58].addBox(0F, 0F, 0F, 7, 4, 4, 0F); // Box 137
		bodyModel[58].setRotationPoint(-25F, -3F, 4F);

		bodyModel[59].addShapeBox(0F, 0F, 0F, 10, 5, 7, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F); // Box 138
		bodyModel[59].setRotationPoint(-11F, 2F, -10F);

		bodyModel[60].addShapeBox(0F, 0F, 0F, 10, 5, 7, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F); // Box 139
		bodyModel[60].setRotationPoint(-11F, 2F, 3F);

		bodyModel[61].addShapeBox(0F, 0F, 0F, 10, 5, 7, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F); // Box 140
		bodyModel[61].setRotationPoint(1F, 2F, 3F);

		bodyModel[62].addShapeBox(0F, 0F, 0F, 10, 5, 7, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F); // Box 141
		bodyModel[62].setRotationPoint(1F, 2F, -10F);
		...
		bodyModel[65].addShapeBox(0F, 0F, 0F, 4, 11, 18, 0F,-2F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 65
		bodyModel[65].setRotationPoint(-2F, -10F, -9F);

		bodyModel[66].addShapeBox(0F, 0F, 0F, 30, 9, 2, 0F,0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 66
		bodyModel[66].setRotationPoint(-15F, -10F, -1F);

		bodyModel[67].addShapeBox(0F, 0F, 0F, 4, 9, 2, 0F,0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, -4F, 0F, 0F, -4F, 0F, 0F, 0F, 0F, 0F); // Box 67
		bodyModel[67].setRotationPoint(15F, -10F, -1F);

		bodyModel[68].addShapeBox(0F, 0F, 0F, 4, 9, 2, 0F,0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, -4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -4F, 0F, 0F); // Box 68
		bodyModel[68].setRotationPoint(-19F, -10F, -1F);

		bodyModel[69].addBox(0F, 0F, 0F, 30, 2, 2, 0F); // Box 69
		bodyModel[69].setRotationPoint(-15F, -1F, -1F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		bogie.render(entity, f, f1, f2, f3, f4, f5);
		GL11.glPopMatrix();*/
		if(entity instanceof AbstractTrains && DepreciatedUtil.getColorFromString(((AbstractTrains) entity).getColor())==3456){
