...
public class ModelEmbeddedLeft45DegreeTurnTCTrack {
    ...
    public ModelEmbeddedLeft45DegreeTurnTCTrack(){
        ...
        modelEmbeddedVeryLargeLeft45DegreeTurn = AdvancedModelLoader.loadModel(new ResourceLocation(Info.modelPrefix + "track_embedded_curve_45degree_very_large_l.obj"));
        modelEmbeddedSuperLargeLeft45DegreeTurn = AdvancedModelLoader.loadModel(new ResourceLocation(Info.modelPrefix + "track_embedded_curve_45degree_super_large_l.obj"));
    ...
    public void renderVeryLarge() {modelEmbeddedVeryLargeLeft45DegreeTurn.renderAll();}
    public void renderSuperLarge() {modelEmbeddedSuperLargeLeft45DegreeTurn.renderAll();}
    ...
    public void render(String type, int facing, double x, double y, double z, float r, float g, float b, float a) {
        ...
        if (facing == 0) {
            ...
            if (type.equals("large") || type.equals("verylarge") || type.equals("superlarge"))
