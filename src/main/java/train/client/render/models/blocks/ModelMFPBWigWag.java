...
public class ModelMFPBWigWag extends ModelConverter {
	...
	private final void initGroup_group0(){
		...
		{//LEGACY CONVERTER START
			TexturedPolygon[] faces = new TexturedPolygon[18]; TexturedVertex[] vertices = null;
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.5169067f, -1.1020975f, 0.7038108f, 0.14694545f);
			vertices[1] = new TexturedVertex(0.0f, 7.5845336E-10f, -5.5104876E-10f, 0.69921875f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0f, 9.375E-10f, -8.1958855E-17f, 0.69921875f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0f, 1.875f, -1.6391772E-7f, 0.69921875f, 0.1484375f);
			faces[0] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.5794071f, -1.7832309f, 0.7066489f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.0f, 2.8970354E-10f, -8.9161545E-10f, 0.69921875f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0f, 7.5845336E-10f, -5.5104876E-10f, 0.69921875f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0f, 1.5169067f, -1.1020975f, 0.7038108f, 0.14694545f);
			faces[1] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.5794071f, -1.7832309f, 0.7066489f, 0.1382108f);
			vertices[1] = new TexturedVertex(0.0f, -2.8970354E-10f, -8.916154E-10f, 0.69921875f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0f, 2.8970354E-10f, -8.9161545E-10f, 0.69921875f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0f, 0.5794071f, -1.7832309f, 0.7066489f, 0.1430392f);
			faces[2] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.5169073f, -1.1020968f, 0.7038108f, 0.13430455f);
			vertices[1] = new TexturedVertex(0.0f, -7.5845363E-10f, -5.510484E-10f, 0.69921875f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0f, -2.8970354E-10f, -8.916154E-10f, 0.69921875f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0f, -0.5794071f, -1.7832309f, 0.7066489f, 0.1382108f);
			faces[3] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0625f, 1.875f, -1.6391772E-7f, 0.71484375f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, 9.375E-10f, -8.1958855E-17f, 0.71484375f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0625f, 7.5845336E-10f, -5.5104876E-10f, 0.71484375f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0625f, 1.5169067f, -1.1020975f, 0.7194358f, 0.14694545f);
			faces[4] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0625f, 1.5169067f, -1.1020975f, 0.7194358f, 0.14694545f);
			vertices[1] = new TexturedVertex(0.0625f, 7.5845336E-10f, -5.5104876E-10f, 0.71484375f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0625f, 2.8970354E-10f, -8.9161545E-10f, 0.71484375f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0625f, 0.5794071f, -1.7832309f, 0.7222739f, 0.1430392f);
			faces[5] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0625f, 0.5794071f, -1.7832309f, 0.7222739f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.0625f, 2.8970354E-10f, -8.9161545E-10f, 0.71484375f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0625f, -2.8970354E-10f, -8.916154E-10f, 0.71484375f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0625f, -0.5794071f, -1.7832309f, 0.7222739f, 0.1382108f);
			faces[6] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0625f, -0.5794071f, -1.7832309f, 0.7222739f, 0.1382108f);
			vertices[1] = new TexturedVertex(0.0625f, -2.8970354E-10f, -8.916154E-10f, 0.71484375f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0625f, -7.5845363E-10f, -5.510484E-10f, 0.71484375f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0625f, -1.5169073f, -1.1020968f, 0.7194358f, 0.13430455f);
			faces[7] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.875f, -1.6391772E-7f, 0.69140625f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, 1.875f, -1.6391772E-7f, 0.69140625f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, 1.5169067f, -1.1020975f, 0.69453126f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 1.5169067f, -1.1020975f, 0.69453126f, 0.1484375f);
			faces[8] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 7.5845336E-10f, -5.5104876E-10f, 0.69453126f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.0625f, 7.5845336E-10f, -5.5104876E-10f, 0.69453126f, 0.15625f);
			vertices[2] = new TexturedVertex(0.0625f, 9.375E-10f, -8.1958855E-17f, 0.69140625f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, 9.375E-10f, -8.1958855E-17f, 0.69140625f, 0.15234375f);
			faces[9] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.5169067f, -1.1020975f, 0.69453126f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, 1.5169067f, -1.1020975f, 0.69453126f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, 0.5794071f, -1.7832309f, 0.6976563f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 0.5794071f, -1.7832309f, 0.6976563f, 0.1484375f);
			faces[10] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 2.8970354E-10f, -8.9161545E-10f, 0.6976563f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.0625f, 2.8970354E-10f, -8.9161545E-10f, 0.6976563f, 0.15625f);
			vertices[2] = new TexturedVertex(0.0625f, 7.5845336E-10f, -5.5104876E-10f, 0.69453126f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, 7.5845336E-10f, -5.5104876E-10f, 0.69453126f, 0.15234375f);
			faces[11] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.5794071f, -1.7832309f, 0.6976563f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, 0.5794071f, -1.7832309f, 0.6976563f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, -0.5794071f, -1.7832309f, 0.7007812f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -0.5794071f, -1.7832309f, 0.7007812f, 0.1484375f);
			faces[12] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -2.8970354E-10f, -8.916154E-10f, 0.7007812f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.0625f, -2.8970354E-10f, -8.916154E-10f, 0.7007812f, 0.15625f);
			vertices[2] = new TexturedVertex(0.0625f, 2.8970354E-10f, -8.9161545E-10f, 0.6976563f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, 2.8970354E-10f, -8.9161545E-10f, 0.6976563f, 0.15234375f);
			faces[13] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.5794071f, -1.7832309f, 0.7007812f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, -0.5794071f, -1.7832309f, 0.7007812f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, -1.5169073f, -1.1020968f, 0.70390624f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -1.5169073f, -1.1020968f, 0.70390624f, 0.1484375f);
			faces[14] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -7.5845363E-10f, -5.510484E-10f, 0.70390624f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.0625f, -7.5845363E-10f, -5.510484E-10f, 0.70390624f, 0.15625f);
			vertices[2] = new TexturedVertex(0.0625f, -2.8970354E-10f, -8.916154E-10f, 0.7007812f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, -2.8970354E-10f, -8.916154E-10f, 0.7007812f, 0.15234375f);
			faces[15] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 9.375E-10f, -8.1958855E-17f, 0.73046875f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, 9.375E-10f, -8.1958855E-17f, 0.73046875f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, 1.875f, -1.6391772E-7f, 0.72265625f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 1.875f, -1.6391772E-7f, 0.72265625f, 0.1484375f);
			faces[16] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.5169073f, -1.1020968f, 0.72265625f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.0625f, -1.5169073f, -1.1020968f, 0.72265625f, 0.15625f);
			vertices[2] = new TexturedVertex(0.0625f, -7.5845363E-10f, -5.510484E-10f, 0.73046875f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, -7.5845363E-10f, -5.510484E-10f, 0.73046875f, 0.15234375f);
			faces[17] = new TexturedPolygon(vertices);
			//
			group0[236].copyTo(new TexturedVertex[0], faces);
		...
		{//LEGACY CONVERTER START
			TexturedPolygon[] faces = new TexturedPolygon[18]; TexturedVertex[] vertices = null;
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.5169067f, -1.1020975f, 0.66084206f, 0.14694545f);
			vertices[1] = new TexturedVertex(0.0f, 7.5845336E-10f, -5.5104876E-10f, 0.65625f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0f, 9.375E-10f, -8.1958855E-17f, 0.65625f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0f, 1.875f, -1.6391772E-7f, 0.65625f, 0.1484375f);
			faces[0] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.5794071f, -1.7832309f, 0.66368014f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.0f, 2.8970354E-10f, -8.9161545E-10f, 0.65625f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0f, 7.5845336E-10f, -5.5104876E-10f, 0.65625f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0f, 1.5169067f, -1.1020975f, 0.66084206f, 0.14694545f);
			faces[1] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.5794071f, -1.7832309f, 0.66368014f, 0.1382108f);
			vertices[1] = new TexturedVertex(0.0f, -2.8970354E-10f, -8.916154E-10f, 0.65625f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0f, 2.8970354E-10f, -8.9161545E-10f, 0.65625f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0f, 0.5794071f, -1.7832309f, 0.66368014f, 0.1430392f);
			faces[2] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.5169073f, -1.1020968f, 0.66084206f, 0.13430455f);
			vertices[1] = new TexturedVertex(0.0f, -7.5845363E-10f, -5.510484E-10f, 0.65625f, 0.140625f);
			vertices[2] = new TexturedVertex(0.0f, -2.8970354E-10f, -8.916154E-10f, 0.65625f, 0.140625f);
			vertices[3] = new TexturedVertex(0.0f, -0.5794071f, -1.7832309f, 0.66368014f, 0.1382108f);
			faces[3] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.25f, 1.75f, -1.5298987E-7f, 0.671875f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, 8.7499996E-10f, -7.649493E-17f, 0.671875f, 0.140625f);
			vertices[2] = new TexturedVertex(0.25f, 7.078898E-10f, -5.1431215E-10f, 0.671875f, 0.140625f);
			vertices[3] = new TexturedVertex(0.25f, 1.4157796f, -1.0286243f, 0.67646706f, 0.14694545f);
			faces[4] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.25f, 1.4157796f, -1.0286243f, 0.67646706f, 0.14694545f);
			vertices[1] = new TexturedVertex(0.25f, 7.078898E-10f, -5.1431215E-10f, 0.671875f, 0.140625f);
			vertices[2] = new TexturedVertex(0.25f, 2.7038996E-10f, -8.321744E-10f, 0.671875f, 0.140625f);
			vertices[3] = new TexturedVertex(0.25f, 0.54077995f, -1.6643488f, 0.67930514f, 0.1430392f);
			faces[5] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.25f, 0.54077995f, -1.6643488f, 0.67930514f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.25f, 2.7038996E-10f, -8.321744E-10f, 0.671875f, 0.140625f);
			vertices[2] = new TexturedVertex(0.25f, -2.7039E-10f, -8.321744E-10f, 0.671875f, 0.140625f);
			vertices[3] = new TexturedVertex(0.25f, -0.54077995f, -1.6643488f, 0.67930514f, 0.1382108f);
			faces[6] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.25f, -0.54077995f, -1.6643488f, 0.67930514f, 0.1382108f);
			vertices[1] = new TexturedVertex(0.25f, -2.7039E-10f, -8.321744E-10f, 0.671875f, 0.140625f);
			vertices[2] = new TexturedVertex(0.25f, -7.078901E-10f, -5.143118E-10f, 0.671875f, 0.140625f);
			vertices[3] = new TexturedVertex(0.25f, -1.4157802f, -1.0286236f, 0.67646706f, 0.13430455f);
			faces[7] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.875f, -1.6391772E-7f, 0.6484375f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, 1.75f, -1.5298987E-7f, 0.6484375f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, 1.4157796f, -1.0286243f, 0.6515625f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 1.5169067f, -1.1020975f, 0.6515625f, 0.1484375f);
			faces[8] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 7.5845336E-10f, -5.5104876E-10f, 0.6515625f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.25f, 7.078898E-10f, -5.1431215E-10f, 0.6515625f, 0.15625f);
			vertices[2] = new TexturedVertex(0.25f, 8.7499996E-10f, -7.649493E-17f, 0.6484375f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, 9.375E-10f, -8.1958855E-17f, 0.6484375f, 0.15234375f);
			faces[9] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.5169067f, -1.1020975f, 0.6515625f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, 1.4157796f, -1.0286243f, 0.6515625f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, 0.54077995f, -1.6643488f, 0.6546875f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 0.5794071f, -1.7832309f, 0.6546875f, 0.1484375f);
			faces[10] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 2.8970354E-10f, -8.9161545E-10f, 0.6546875f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.25f, 2.7038996E-10f, -8.321744E-10f, 0.6546875f, 0.15625f);
			vertices[2] = new TexturedVertex(0.25f, 7.078898E-10f, -5.1431215E-10f, 0.6515625f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, 7.5845336E-10f, -5.5104876E-10f, 0.6515625f, 0.15234375f);
			faces[11] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.5794071f, -1.7832309f, 0.6546875f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, 0.54077995f, -1.6643488f, 0.6546875f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, -0.54077995f, -1.6643488f, 0.6578125f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -0.5794071f, -1.7832309f, 0.6578125f, 0.1484375f);
			faces[12] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -2.8970354E-10f, -8.916154E-10f, 0.6578125f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.25f, -2.7039E-10f, -8.321744E-10f, 0.6578125f, 0.15625f);
			vertices[2] = new TexturedVertex(0.25f, 2.7038996E-10f, -8.321744E-10f, 0.6546875f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, 2.8970354E-10f, -8.9161545E-10f, 0.6546875f, 0.15234375f);
			faces[13] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.5794071f, -1.7832309f, 0.6578125f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, -0.54077995f, -1.6643488f, 0.6578125f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, -1.4157802f, -1.0286236f, 0.6609375f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -1.5169073f, -1.1020968f, 0.6609375f, 0.1484375f);
			faces[14] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -7.5845363E-10f, -5.510484E-10f, 0.6609375f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.25f, -7.078901E-10f, -5.143118E-10f, 0.6609375f, 0.15625f);
			vertices[2] = new TexturedVertex(0.25f, -2.7039E-10f, -8.321744E-10f, 0.6578125f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, -2.8970354E-10f, -8.916154E-10f, 0.6578125f, 0.15234375f);
			faces[15] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 9.375E-10f, -8.1958855E-17f, 0.6875f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, 8.7499996E-10f, -7.649493E-17f, 0.6875f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, 1.75f, -1.5298987E-7f, 0.6796875f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 1.875f, -1.6391772E-7f, 0.6796875f, 0.1484375f);
			faces[16] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.5169073f, -1.1020968f, 0.6796875f, 0.15234375f);
			vertices[1] = new TexturedVertex(0.25f, -1.4157802f, -1.0286236f, 0.6796875f, 0.15625f);
			vertices[2] = new TexturedVertex(0.25f, -7.078901E-10f, -5.143118E-10f, 0.6875f, 0.15625f);
			vertices[3] = new TexturedVertex(0.0f, -7.5845363E-10f, -5.510484E-10f, 0.6875f, 0.15234375f);
			faces[17] = new TexturedPolygon(vertices);
			//
			group0[237].copyTo(new TexturedVertex[0], faces);
		}//LEGACY CONVERTER END
		...
		{//LEGACY CONVERTER START
			TexturedPolygon[] faces = new TexturedPolygon[18]; TexturedVertex[] vertices = null;
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.4157796f, -1.0286243f, 0.9225608f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.0f, 7.078898E-10f, -5.1431215E-10f, 0.91796875f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 8.7499996E-10f, -7.649493E-17f, 0.91796875f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 1.75f, -1.5298987E-7f, 0.91796875f, 0.14453125f);
			faces[0] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.54077995f, -1.6643488f, 0.9253989f, 0.13913295f);
			vertices[1] = new TexturedVertex(0.0f, 2.7038996E-10f, -8.321744E-10f, 0.91796875f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 7.078898E-10f, -5.1431215E-10f, 0.91796875f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 1.4157796f, -1.0286243f, 0.9225608f, 0.1430392f);
			faces[1] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.54077995f, -1.6643488f, 0.9253989f, 0.13430455f);
			vertices[1] = new TexturedVertex(0.0f, -2.7039E-10f, -8.321744E-10f, 0.91796875f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 2.7038996E-10f, -8.321744E-10f, 0.91796875f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 0.54077995f, -1.6643488f, 0.9253989f, 0.13913295f);
			faces[2] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.4157802f, -1.0286236f, 0.9225608f, 0.1303983f);
			vertices[1] = new TexturedVertex(0.0f, -7.078901E-10f, -5.143118E-10f, 0.91796875f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, -2.7039E-10f, -8.321744E-10f, 0.91796875f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, -0.54077995f, -1.6643488f, 0.9253989f, 0.13430455f);
			faces[3] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.25f, 1.375f, -1.2020632E-7f, 0.93359375f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.25f, 6.875E-10f, -6.010316E-17f, 0.93359375f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.25f, 5.5619914E-10f, -4.0410242E-10f, 0.93359375f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.25f, 1.1123983f, -0.8082048f, 0.9381858f, 0.1430392f);
			faces[4] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.25f, 1.1123983f, -0.8082048f, 0.9381858f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.25f, 5.5619914E-10f, -4.0410242E-10f, 0.93359375f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.25f, 2.1244925E-10f, -6.538513E-10f, 0.93359375f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.25f, 0.4248985f, -1.3077027f, 0.9410239f, 0.13913295f);
			faces[5] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.25f, 0.4248985f, -1.3077027f, 0.9410239f, 0.13913295f);
			vertices[1] = new TexturedVertex(0.25f, 2.1244925E-10f, -6.538513E-10f, 0.93359375f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.25f, -2.1244927E-10f, -6.538513E-10f, 0.93359375f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.25f, -0.42489856f, -1.3077027f, 0.9410239f, 0.13430455f);
			faces[6] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.25f, -0.42489856f, -1.3077027f, 0.9410239f, 0.13430455f);
			vertices[1] = new TexturedVertex(0.25f, -2.1244927E-10f, -6.538513E-10f, 0.93359375f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.25f, -5.561993E-10f, -4.0410214E-10f, 0.93359375f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.25f, -1.1123987f, -0.8082043f, 0.9381858f, 0.1303983f);
			faces[7] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.75f, -1.5298987E-7f, 0.91015625f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.25f, 1.375f, -1.2020632E-7f, 0.91015625f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.25f, 1.1123983f, -0.8082048f, 0.91328126f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 1.4157796f, -1.0286243f, 0.91328126f, 0.14453125f);
			faces[8] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 7.078898E-10f, -5.1431215E-10f, 0.91328126f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, 5.5619914E-10f, -4.0410242E-10f, 0.91328126f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, 6.875E-10f, -6.010316E-17f, 0.91015625f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 8.7499996E-10f, -7.649493E-17f, 0.91015625f, 0.1484375f);
			faces[9] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.4157796f, -1.0286243f, 0.91328126f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.25f, 1.1123983f, -0.8082048f, 0.91328126f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.25f, 0.4248985f, -1.3077027f, 0.9164063f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 0.54077995f, -1.6643488f, 0.9164063f, 0.14453125f);
			faces[10] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 2.7038996E-10f, -8.321744E-10f, 0.9164063f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, 2.1244925E-10f, -6.538513E-10f, 0.9164063f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, 5.5619914E-10f, -4.0410242E-10f, 0.91328126f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 7.078898E-10f, -5.1431215E-10f, 0.91328126f, 0.1484375f);
			faces[11] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.54077995f, -1.6643488f, 0.9164063f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.25f, 0.4248985f, -1.3077027f, 0.9164063f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.25f, -0.42489856f, -1.3077027f, 0.9195312f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, -0.54077995f, -1.6643488f, 0.9195312f, 0.14453125f);
			faces[12] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -2.7039E-10f, -8.321744E-10f, 0.9195312f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, -2.1244927E-10f, -6.538513E-10f, 0.9195312f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, 2.1244925E-10f, -6.538513E-10f, 0.9164063f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 2.7038996E-10f, -8.321744E-10f, 0.9164063f, 0.1484375f);
			faces[13] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.54077995f, -1.6643488f, 0.9195312f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.25f, -0.42489856f, -1.3077027f, 0.9195312f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.25f, -1.1123987f, -0.8082043f, 0.92265624f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, -1.4157802f, -1.0286236f, 0.92265624f, 0.14453125f);
			faces[14] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -7.078901E-10f, -5.143118E-10f, 0.92265624f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, -5.561993E-10f, -4.0410214E-10f, 0.92265624f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, -2.1244927E-10f, -6.538513E-10f, 0.9195312f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -2.7039E-10f, -8.321744E-10f, 0.9195312f, 0.1484375f);
			faces[15] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 8.7499996E-10f, -7.649493E-17f, 0.94921875f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.25f, 6.875E-10f, -6.010316E-17f, 0.94921875f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.25f, 1.375f, -1.2020632E-7f, 0.94140625f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 1.75f, -1.5298987E-7f, 0.94140625f, 0.14453125f);
			faces[16] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.4157802f, -1.0286236f, 0.94140625f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.25f, -1.1123987f, -0.8082043f, 0.94140625f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.25f, -5.561993E-10f, -4.0410214E-10f, 0.94921875f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -7.078901E-10f, -5.143118E-10f, 0.94921875f, 0.1484375f);
			faces[17] = new TexturedPolygon(vertices);
			//
			group0[238].copyTo(new TexturedVertex[0], faces);
		}//LEGACY CONVERTER END
		...
		{//LEGACY CONVERTER START
			TexturedPolygon[] faces = new TexturedPolygon[18]; TexturedVertex[] vertices = null;
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.1123983f, -0.8082048f, 0.79365456f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.0f, 5.5619914E-10f, -4.0410242E-10f, 0.7890625f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 6.875E-10f, -6.010316E-17f, 0.7890625f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 1.375f, -1.2020632E-7f, 0.7890625f, 0.14453125f);
			faces[0] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.4248985f, -1.3077027f, 0.79649264f, 0.13913295f);
			vertices[1] = new TexturedVertex(0.0f, 2.1244925E-10f, -6.538513E-10f, 0.7890625f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 5.5619914E-10f, -4.0410242E-10f, 0.7890625f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 1.1123983f, -0.8082048f, 0.79365456f, 0.1430392f);
			faces[1] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.42489856f, -1.3077027f, 0.79649264f, 0.13430455f);
			vertices[1] = new TexturedVertex(0.0f, -2.1244927E-10f, -6.538513E-10f, 0.7890625f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 2.1244925E-10f, -6.538513E-10f, 0.7890625f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 0.4248985f, -1.3077027f, 0.79649264f, 0.13913295f);
			faces[2] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.1123987f, -0.8082043f, 0.79365456f, 0.1303983f);
			vertices[1] = new TexturedVertex(0.0f, -5.561993E-10f, -4.0410214E-10f, 0.7890625f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, -2.1244927E-10f, -6.538513E-10f, 0.7890625f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, -0.42489856f, -1.3077027f, 0.79649264f, 0.13430455f);
			faces[3] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.1875f, 0.75f, -6.5567086E-8f, 0.8046875f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.1875f, 3.7499998E-10f, -3.278354E-17f, 0.8046875f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.1875f, 3.0338135E-10f, -2.204195E-10f, 0.8046875f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.1875f, 0.6067627f, -0.440839f, 0.80927956f, 0.1430392f);
			faces[4] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.1875f, 0.6067627f, -0.440839f, 0.80927956f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.1875f, 3.0338135E-10f, -2.204195E-10f, 0.8046875f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.1875f, 1.1588141E-10f, -3.5664616E-10f, 0.8046875f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.1875f, 0.23176283f, -0.71329236f, 0.81211764f, 0.13913295f);
			faces[5] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.1875f, 0.23176283f, -0.71329236f, 0.81211764f, 0.13913295f);
			vertices[1] = new TexturedVertex(0.1875f, 1.1588141E-10f, -3.5664616E-10f, 0.8046875f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.1875f, -1.1588142E-10f, -3.5664616E-10f, 0.8046875f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.1875f, -0.23176284f, -0.71329236f, 0.81211764f, 0.13430455f);
			faces[6] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.1875f, -0.23176284f, -0.71329236f, 0.81211764f, 0.13430455f);
			vertices[1] = new TexturedVertex(0.1875f, -1.1588142E-10f, -3.5664616E-10f, 0.8046875f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.1875f, -3.0338146E-10f, -2.2041935E-10f, 0.8046875f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.1875f, -0.60676295f, -0.4408387f, 0.80927956f, 0.1303983f);
			faces[7] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.375f, -1.2020632E-7f, 0.78125f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.1875f, 0.75f, -6.5567086E-8f, 0.78125f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.1875f, 0.6067627f, -0.440839f, 0.784375f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 1.1123983f, -0.8082048f, 0.784375f, 0.14453125f);
			faces[8] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 5.5619914E-10f, -4.0410242E-10f, 0.784375f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.1875f, 3.0338135E-10f, -2.204195E-10f, 0.784375f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.1875f, 3.7499998E-10f, -3.278354E-17f, 0.78125f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 6.875E-10f, -6.010316E-17f, 0.78125f, 0.1484375f);
			faces[9] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.1123983f, -0.8082048f, 0.784375f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.1875f, 0.6067627f, -0.440839f, 0.784375f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.1875f, 0.23176283f, -0.71329236f, 0.7875f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 0.4248985f, -1.3077027f, 0.7875f, 0.14453125f);
			faces[10] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 2.1244925E-10f, -6.538513E-10f, 0.7875f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.1875f, 1.1588141E-10f, -3.5664616E-10f, 0.7875f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.1875f, 3.0338135E-10f, -2.204195E-10f, 0.784375f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 5.5619914E-10f, -4.0410242E-10f, 0.784375f, 0.1484375f);
			faces[11] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.4248985f, -1.3077027f, 0.7875f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.1875f, 0.23176283f, -0.71329236f, 0.7875f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.1875f, -0.23176284f, -0.71329236f, 0.790625f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, -0.42489856f, -1.3077027f, 0.790625f, 0.14453125f);
			faces[12] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -2.1244927E-10f, -6.538513E-10f, 0.790625f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.1875f, -1.1588142E-10f, -3.5664616E-10f, 0.790625f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.1875f, 1.1588141E-10f, -3.5664616E-10f, 0.7875f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 2.1244925E-10f, -6.538513E-10f, 0.7875f, 0.1484375f);
			faces[13] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.42489856f, -1.3077027f, 0.790625f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.1875f, -0.23176284f, -0.71329236f, 0.790625f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.1875f, -0.60676295f, -0.4408387f, 0.79375f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, -1.1123987f, -0.8082043f, 0.79375f, 0.14453125f);
			faces[14] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -5.561993E-10f, -4.0410214E-10f, 0.79375f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.1875f, -3.0338146E-10f, -2.2041935E-10f, 0.79375f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.1875f, -1.1588142E-10f, -3.5664616E-10f, 0.790625f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -2.1244927E-10f, -6.538513E-10f, 0.790625f, 0.1484375f);
			faces[15] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 6.875E-10f, -6.010316E-17f, 0.8203125f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.1875f, 3.7499998E-10f, -3.278354E-17f, 0.8203125f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.1875f, 0.75f, -6.5567086E-8f, 0.8125f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 1.375f, -1.2020632E-7f, 0.8125f, 0.14453125f);
			faces[16] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.1123987f, -0.8082043f, 0.8125f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.1875f, -0.60676295f, -0.4408387f, 0.8125f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.1875f, -3.0338146E-10f, -2.2041935E-10f, 0.8203125f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -5.561993E-10f, -4.0410214E-10f, 0.8203125f, 0.1484375f);
			faces[17] = new TexturedPolygon(vertices);
			//
			group0[239].copyTo(new TexturedVertex[0], faces);
		}//LEGACY CONVERTER END
		...
		{//LEGACY CONVERTER START
			TexturedPolygon[] faces = new TexturedPolygon[18]; TexturedVertex[] vertices = null;
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.4885912f, -1.0815251f, 0.6178733f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.0f, 7.4429557E-10f, -5.407625E-10f, 0.61328125f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 9.1999997E-10f, -8.0428955E-17f, 0.61328125f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 1.84f, -1.6085792E-7f, 0.61328125f, 0.14453125f);
			faces[0] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.5685915f, -1.749944f, 0.6207114f, 0.13913295f);
			vertices[1] = new TexturedVertex(0.0f, 2.8429573E-10f, -8.7497193E-10f, 0.61328125f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 7.4429557E-10f, -5.407625E-10f, 0.61328125f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 1.4885912f, -1.0815251f, 0.6178733f, 0.1430392f);
			faces[1] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.56859154f, -1.749944f, 0.6207114f, 0.13430455f);
			vertices[1] = new TexturedVertex(0.0f, -2.8429575E-10f, -8.7497193E-10f, 0.61328125f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, 2.8429573E-10f, -8.7497193E-10f, 0.61328125f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, 0.5685915f, -1.749944f, 0.6207114f, 0.13913295f);
			faces[2] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.4885917f, -1.0815243f, 0.6178733f, 0.1303983f);
			vertices[1] = new TexturedVertex(0.0f, -7.4429585E-10f, -5.4076216E-10f, 0.61328125f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0f, -2.8429575E-10f, -8.7497193E-10f, 0.61328125f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0f, -0.56859154f, -1.749944f, 0.6207114f, 0.13430455f);
			faces[3] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0625f, 1.875f, -1.6391772E-7f, 0.62890625f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.0625f, 9.375E-10f, -8.1958855E-17f, 0.62890625f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0625f, 7.5845336E-10f, -5.5104876E-10f, 0.62890625f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0625f, 1.5169067f, -1.1020975f, 0.6334983f, 0.1430392f);
			faces[4] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0625f, 1.5169067f, -1.1020975f, 0.6334983f, 0.1430392f);
			vertices[1] = new TexturedVertex(0.0625f, 7.5845336E-10f, -5.5104876E-10f, 0.62890625f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0625f, 2.8970354E-10f, -8.9161545E-10f, 0.62890625f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0625f, 0.5794071f, -1.7832309f, 0.6363364f, 0.13913295f);
			faces[5] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0625f, 0.5794071f, -1.7832309f, 0.6363364f, 0.13913295f);
			vertices[1] = new TexturedVertex(0.0625f, 2.8970354E-10f, -8.9161545E-10f, 0.62890625f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0625f, -2.8970354E-10f, -8.916154E-10f, 0.62890625f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0625f, -0.5794071f, -1.7832309f, 0.6363364f, 0.13430455f);
			faces[6] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0625f, -0.5794071f, -1.7832309f, 0.6363364f, 0.13430455f);
			vertices[1] = new TexturedVertex(0.0625f, -2.8970354E-10f, -8.916154E-10f, 0.62890625f, 0.13671875f);
			vertices[2] = new TexturedVertex(0.0625f, -7.5845363E-10f, -5.510484E-10f, 0.62890625f, 0.13671875f);
			vertices[3] = new TexturedVertex(0.0625f, -1.5169073f, -1.1020968f, 0.6334983f, 0.1303983f);
			faces[7] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.84f, -1.6085792E-7f, 0.60546875f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.0625f, 1.875f, -1.6391772E-7f, 0.60546875f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.0625f, 1.5169067f, -1.1020975f, 0.60859376f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 1.4885912f, -1.0815251f, 0.60859376f, 0.14453125f);
			faces[8] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 7.4429557E-10f, -5.407625E-10f, 0.60859376f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, 7.5845336E-10f, -5.5104876E-10f, 0.60859376f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, 9.375E-10f, -8.1958855E-17f, 0.60546875f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 9.1999997E-10f, -8.0428955E-17f, 0.60546875f, 0.1484375f);
			faces[9] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 1.4885912f, -1.0815251f, 0.60859376f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.0625f, 1.5169067f, -1.1020975f, 0.60859376f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.0625f, 0.5794071f, -1.7832309f, 0.6117188f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 0.5685915f, -1.749944f, 0.6117188f, 0.14453125f);
			faces[10] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 2.8429573E-10f, -8.7497193E-10f, 0.6117188f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, 2.8970354E-10f, -8.9161545E-10f, 0.6117188f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, 7.5845336E-10f, -5.5104876E-10f, 0.60859376f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 7.4429557E-10f, -5.407625E-10f, 0.60859376f, 0.1484375f);
			faces[11] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 0.5685915f, -1.749944f, 0.6117188f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.0625f, 0.5794071f, -1.7832309f, 0.6117188f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.0625f, -0.5794071f, -1.7832309f, 0.6148437f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, -0.56859154f, -1.749944f, 0.6148437f, 0.14453125f);
			faces[12] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -2.8429575E-10f, -8.7497193E-10f, 0.6148437f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, -2.8970354E-10f, -8.916154E-10f, 0.6148437f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, 2.8970354E-10f, -8.9161545E-10f, 0.6117188f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, 2.8429573E-10f, -8.7497193E-10f, 0.6117188f, 0.1484375f);
			faces[13] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -0.56859154f, -1.749944f, 0.6148437f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.0625f, -0.5794071f, -1.7832309f, 0.6148437f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.0625f, -1.5169073f, -1.1020968f, 0.61796874f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, -1.4885917f, -1.0815243f, 0.61796874f, 0.14453125f);
			faces[14] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -7.4429585E-10f, -5.4076216E-10f, 0.61796874f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, -7.5845363E-10f, -5.510484E-10f, 0.61796874f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, -2.8970354E-10f, -8.916154E-10f, 0.6148437f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -2.8429575E-10f, -8.7497193E-10f, 0.6148437f, 0.1484375f);
			faces[15] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, 9.1999997E-10f, -8.0428955E-17f, 0.64453125f, 0.14453125f);
			vertices[1] = new TexturedVertex(0.0625f, 9.375E-10f, -8.1958855E-17f, 0.64453125f, 0.1484375f);
			vertices[2] = new TexturedVertex(0.0625f, 1.875f, -1.6391772E-7f, 0.63671875f, 0.1484375f);
			vertices[3] = new TexturedVertex(0.0f, 1.84f, -1.6085792E-7f, 0.63671875f, 0.14453125f);
			faces[16] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(0.0f, -1.4885917f, -1.0815243f, 0.63671875f, 0.1484375f);
			vertices[1] = new TexturedVertex(0.0625f, -1.5169073f, -1.1020968f, 0.63671875f, 0.15234375f);
			vertices[2] = new TexturedVertex(0.0625f, -7.5845363E-10f, -5.510484E-10f, 0.64453125f, 0.15234375f);
			vertices[3] = new TexturedVertex(0.0f, -7.4429585E-10f, -5.4076216E-10f, 0.64453125f, 0.1484375f);
			faces[17] = new TexturedPolygon(vertices);
			//
			group0[240].copyTo(new TexturedVertex[0], faces);
		}//LEGACY CONVERTER END
	...
	private final void initGroup_Signal(){
		...
		{//LEGACY CONVERTER START
			TexturedPolygon[] faces = new TexturedPolygon[48]; TexturedVertex[] vertices = null;
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 11.598076f, 1.5000006f, 0.7519531f, 0.096086234f);
			vertices[1] = new TexturedVertex(3.5938f, 11.327443f, 1.3437505f, 0.75097656f, 0.09439478f);
			vertices[2] = new TexturedVertex(3.5938f, 11.6875f, 2.3494871E-7f, 0.74609375f, 0.095703125f);
			vertices[3] = new TexturedVertex(3.5938f, 12.0f, 2.6226834E-7f, 0.74609375f, 0.09765625f);
			faces[0] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 10.5f, 2.5980763f, 0.7562425f, 0.091796875f);
			vertices[1] = new TexturedVertex(3.5938f, 10.34375f, 2.3274434f, 0.75455105f, 0.09082031f);
			vertices[2] = new TexturedVertex(3.5938f, 11.327443f, 1.3437505f, 0.75097656f, 0.09439478f);
			vertices[3] = new TexturedVertex(3.5938f, 11.598076f, 1.5000006f, 0.7519531f, 0.096086234f);
			faces[1] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 9.0f, 3.0f, 0.7578125f, 0.0859375f);
			vertices[1] = new TexturedVertex(3.5938f, 9.0f, 2.6875f, 0.7558594f, 0.0859375f);
			vertices[2] = new TexturedVertex(3.5938f, 10.34375f, 2.3274434f, 0.75455105f, 0.09082031f);
			vertices[3] = new TexturedVertex(3.5938f, 10.5f, 2.5980763f, 0.7562425f, 0.091796875f);
			faces[2] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 7.5f, 2.5980763f, 0.7562425f, 0.080078125f);
			vertices[1] = new TexturedVertex(3.5938f, 7.65625f, 2.3274434f, 0.75455105f, 0.08105469f);
			vertices[2] = new TexturedVertex(3.5938f, 9.0f, 2.6875f, 0.7558594f, 0.0859375f);
			vertices[3] = new TexturedVertex(3.5938f, 9.0f, 3.0f, 0.7578125f, 0.0859375f);
			faces[3] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.401924f, 1.5000005f, 0.7519531f, 0.075788766f);
			vertices[1] = new TexturedVertex(3.5938f, 6.672557f, 1.3437505f, 0.75097656f, 0.07748022f);
			vertices[2] = new TexturedVertex(3.5938f, 7.65625f, 2.3274434f, 0.75455105f, 0.08105469f);
			vertices[3] = new TexturedVertex(3.5938f, 7.5f, 2.5980763f, 0.7562425f, 0.080078125f);
			faces[4] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.0f, -5.245367E-7f, 0.74609375f, 0.07421875f);
			vertices[1] = new TexturedVertex(3.5938f, 6.3125f, -4.6989743E-7f, 0.74609375f, 0.076171875f);
			vertices[2] = new TexturedVertex(3.5938f, 6.672557f, 1.3437505f, 0.75097656f, 0.07748022f);
			vertices[3] = new TexturedVertex(3.5938f, 6.401924f, 1.5000005f, 0.7519531f, 0.075788766f);
			faces[5] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.4019246f, -1.5000014f, 0.7402344f, 0.075788766f);
			vertices[1] = new TexturedVertex(3.5938f, 6.6725574f, -1.3437513f, 0.74121094f, 0.07748022f);
			vertices[2] = new TexturedVertex(3.5938f, 6.3125f, -4.6989743E-7f, 0.74609375f, 0.076171875f);
			vertices[3] = new TexturedVertex(3.5938f, 6.0f, -5.245367E-7f, 0.74609375f, 0.07421875f);
			faces[6] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 7.500001f, -2.5980768f, 0.735945f, 0.080078125f);
			vertices[1] = new TexturedVertex(3.5938f, 7.656251f, -2.3274438f, 0.73763645f, 0.08105469f);
			vertices[2] = new TexturedVertex(3.5938f, 6.6725574f, -1.3437513f, 0.74121094f, 0.07748022f);
			vertices[3] = new TexturedVertex(3.5938f, 6.4019246f, -1.5000014f, 0.7402344f, 0.075788766f);
			faces[7] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 9.000001f, -3.0f, 0.734375f, 0.0859375f);
			vertices[1] = new TexturedVertex(3.5938f, 9.000001f, -2.6875f, 0.7363281f, 0.0859375f);
			vertices[2] = new TexturedVertex(3.5938f, 7.656251f, -2.3274438f, 0.73763645f, 0.08105469f);
			vertices[3] = new TexturedVertex(3.5938f, 7.500001f, -2.5980768f, 0.735945f, 0.080078125f);
			faces[8] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 10.500001f, -2.5980759f, 0.735945f, 0.091796875f);
			vertices[1] = new TexturedVertex(3.5938f, 10.343751f, -2.327443f, 0.73763645f, 0.09082031f);
			vertices[2] = new TexturedVertex(3.5938f, 9.000001f, -2.6875f, 0.7363281f, 0.0859375f);
			vertices[3] = new TexturedVertex(3.5938f, 9.000001f, -3.0f, 0.734375f, 0.0859375f);
			faces[9] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 11.598076f, -1.4999996f, 0.7402344f, 0.096086234f);
			vertices[1] = new TexturedVertex(3.5938f, 11.327443f, -1.3437496f, 0.74121094f, 0.09439478f);
			vertices[2] = new TexturedVertex(3.5938f, 10.343751f, -2.327443f, 0.73763645f, 0.09082031f);
			vertices[3] = new TexturedVertex(3.5938f, 10.500001f, -2.5980759f, 0.735945f, 0.091796875f);
			faces[10] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 12.0f, 2.6226834E-7f, 0.74609375f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5938f, 11.6875f, 2.3494871E-7f, 0.74609375f, 0.095703125f);
			vertices[2] = new TexturedVertex(3.5938f, 11.327443f, -1.3437496f, 0.74121094f, 0.09439478f);
			vertices[3] = new TexturedVertex(3.5938f, 11.598076f, -1.4999996f, 0.7402344f, 0.096086234f);
			faces[11] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 12.0f, 2.6226834E-7f, 0.76953125f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 11.6875f, 2.3494871E-7f, 0.76953125f, 0.095703125f);
			vertices[2] = new TexturedVertex(3.5313f, 11.327443f, 1.3437505f, 0.77441406f, 0.09439478f);
			vertices[3] = new TexturedVertex(3.5313f, 11.598076f, 1.5000006f, 0.7753906f, 0.096086234f);
			faces[12] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 11.598076f, 1.5000006f, 0.7753906f, 0.096086234f);
			vertices[1] = new TexturedVertex(3.5313f, 11.327443f, 1.3437505f, 0.77441406f, 0.09439478f);
			vertices[2] = new TexturedVertex(3.5313f, 10.34375f, 2.3274434f, 0.77798855f, 0.09082031f);
			vertices[3] = new TexturedVertex(3.5313f, 10.5f, 2.5980763f, 0.77968f, 0.091796875f);
			faces[13] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 10.5f, 2.5980763f, 0.77968f, 0.091796875f);
			vertices[1] = new TexturedVertex(3.5313f, 10.34375f, 2.3274434f, 0.77798855f, 0.09082031f);
			vertices[2] = new TexturedVertex(3.5313f, 9.0f, 2.6875f, 0.7792969f, 0.0859375f);
			vertices[3] = new TexturedVertex(3.5313f, 9.0f, 3.0f, 0.78125f, 0.0859375f);
			faces[14] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 9.0f, 3.0f, 0.78125f, 0.0859375f);
			vertices[1] = new TexturedVertex(3.5313f, 9.0f, 2.6875f, 0.7792969f, 0.0859375f);
			vertices[2] = new TexturedVertex(3.5313f, 7.65625f, 2.3274434f, 0.77798855f, 0.08105469f);
			vertices[3] = new TexturedVertex(3.5313f, 7.5f, 2.5980763f, 0.77968f, 0.080078125f);
			faces[15] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 7.5f, 2.5980763f, 0.77968f, 0.080078125f);
			vertices[1] = new TexturedVertex(3.5313f, 7.65625f, 2.3274434f, 0.77798855f, 0.08105469f);
			vertices[2] = new TexturedVertex(3.5313f, 6.672557f, 1.3437505f, 0.77441406f, 0.07748022f);
			vertices[3] = new TexturedVertex(3.5313f, 6.401924f, 1.5000005f, 0.7753906f, 0.075788766f);
			faces[16] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 6.401924f, 1.5000005f, 0.7753906f, 0.075788766f);
			vertices[1] = new TexturedVertex(3.5313f, 6.672557f, 1.3437505f, 0.77441406f, 0.07748022f);
			vertices[2] = new TexturedVertex(3.5313f, 6.3125f, -4.6989743E-7f, 0.76953125f, 0.076171875f);
			vertices[3] = new TexturedVertex(3.5313f, 6.0f, -5.245367E-7f, 0.76953125f, 0.07421875f);
			faces[17] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 6.0f, -5.245367E-7f, 0.76953125f, 0.07421875f);
			vertices[1] = new TexturedVertex(3.5313f, 6.3125f, -4.6989743E-7f, 0.76953125f, 0.076171875f);
			vertices[2] = new TexturedVertex(3.5313f, 6.6725574f, -1.3437513f, 0.76464844f, 0.07748022f);
			vertices[3] = new TexturedVertex(3.5313f, 6.4019246f, -1.5000014f, 0.7636719f, 0.075788766f);
			faces[18] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 6.4019246f, -1.5000014f, 0.7636719f, 0.075788766f);
			vertices[1] = new TexturedVertex(3.5313f, 6.6725574f, -1.3437513f, 0.76464844f, 0.07748022f);
			vertices[2] = new TexturedVertex(3.5313f, 7.656251f, -2.3274438f, 0.76107395f, 0.08105469f);
			vertices[3] = new TexturedVertex(3.5313f, 7.500001f, -2.5980768f, 0.7593825f, 0.080078125f);
			faces[19] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 7.500001f, -2.5980768f, 0.7593825f, 0.080078125f);
			vertices[1] = new TexturedVertex(3.5313f, 7.656251f, -2.3274438f, 0.76107395f, 0.08105469f);
			vertices[2] = new TexturedVertex(3.5313f, 9.000001f, -2.6875f, 0.7597656f, 0.0859375f);
			vertices[3] = new TexturedVertex(3.5313f, 9.000001f, -3.0f, 0.7578125f, 0.0859375f);
			faces[20] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 9.000001f, -3.0f, 0.7578125f, 0.0859375f);
			vertices[1] = new TexturedVertex(3.5313f, 9.000001f, -2.6875f, 0.7597656f, 0.0859375f);
			vertices[2] = new TexturedVertex(3.5313f, 10.343751f, -2.327443f, 0.76107395f, 0.09082031f);
			vertices[3] = new TexturedVertex(3.5313f, 10.500001f, -2.5980759f, 0.7593825f, 0.091796875f);
			faces[21] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 10.500001f, -2.5980759f, 0.7593825f, 0.091796875f);
			vertices[1] = new TexturedVertex(3.5313f, 10.343751f, -2.327443f, 0.76107395f, 0.09082031f);
			vertices[2] = new TexturedVertex(3.5313f, 11.327443f, -1.3437496f, 0.76464844f, 0.09439478f);
			vertices[3] = new TexturedVertex(3.5313f, 11.598076f, -1.4999996f, 0.7636719f, 0.096086234f);
			faces[22] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5313f, 11.598076f, -1.4999996f, 0.7636719f, 0.096086234f);
			vertices[1] = new TexturedVertex(3.5313f, 11.327443f, -1.3437496f, 0.76464844f, 0.09439478f);
			vertices[2] = new TexturedVertex(3.5313f, 11.6875f, 2.3494871E-7f, 0.76953125f, 0.095703125f);
			vertices[3] = new TexturedVertex(3.5313f, 12.0f, 2.6226834E-7f, 0.76953125f, 0.09765625f);
			faces[23] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 12.0f, 2.6226834E-7f, 0.734375f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 12.0f, 2.6226834E-7f, 0.734375f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 11.598076f, 1.5000006f, 0.73828125f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 11.598076f, 1.5000006f, 0.73828125f, 0.09765625f);
			faces[24] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 11.327443f, 1.3437505f, 0.73828125f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 11.327443f, 1.3437505f, 0.73828125f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 11.6875f, 2.3494871E-7f, 0.734375f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 11.6875f, 2.3494871E-7f, 0.734375f, 0.1015625f);
			faces[25] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 11.598076f, 1.5000006f, 0.73828125f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 11.598076f, 1.5000006f, 0.73828125f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 10.5f, 2.5980763f, 0.7421875f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 10.5f, 2.5980763f, 0.7421875f, 0.09765625f);
			faces[26] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 10.34375f, 2.3274434f, 0.7421875f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 10.34375f, 2.3274434f, 0.7421875f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 11.327443f, 1.3437505f, 0.73828125f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 11.327443f, 1.3437505f, 0.73828125f, 0.1015625f);
			faces[27] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 10.5f, 2.5980763f, 0.7421875f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 10.5f, 2.5980763f, 0.7421875f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 9.0f, 3.0f, 0.74609375f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 9.0f, 3.0f, 0.74609375f, 0.09765625f);
			faces[28] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 9.0f, 2.6875f, 0.74609375f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 9.0f, 2.6875f, 0.74609375f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 10.34375f, 2.3274434f, 0.7421875f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 10.34375f, 2.3274434f, 0.7421875f, 0.1015625f);
			faces[29] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 9.0f, 3.0f, 0.74609375f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 9.0f, 3.0f, 0.74609375f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 7.5f, 2.5980763f, 0.75f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 7.5f, 2.5980763f, 0.75f, 0.09765625f);
			faces[30] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 7.65625f, 2.3274434f, 0.75f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 7.65625f, 2.3274434f, 0.75f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 9.0f, 2.6875f, 0.74609375f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 9.0f, 2.6875f, 0.74609375f, 0.1015625f);
			faces[31] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 7.5f, 2.5980763f, 0.75f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 7.5f, 2.5980763f, 0.75f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 6.401924f, 1.5000005f, 0.75390625f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 6.401924f, 1.5000005f, 0.75390625f, 0.09765625f);
			faces[32] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.672557f, 1.3437505f, 0.75390625f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 6.672557f, 1.3437505f, 0.75390625f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 7.65625f, 2.3274434f, 0.75f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 7.65625f, 2.3274434f, 0.75f, 0.1015625f);
			faces[33] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.401924f, 1.5000005f, 0.75390625f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 6.401924f, 1.5000005f, 0.75390625f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 6.0f, -5.245367E-7f, 0.7578125f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 6.0f, -5.245367E-7f, 0.7578125f, 0.09765625f);
			faces[34] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.3125f, -4.6989743E-7f, 0.7578125f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 6.3125f, -4.6989743E-7f, 0.7578125f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 6.672557f, 1.3437505f, 0.75390625f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 6.672557f, 1.3437505f, 0.75390625f, 0.1015625f);
			faces[35] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.0f, -5.245367E-7f, 0.7578125f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 6.0f, -5.245367E-7f, 0.7578125f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 6.4019246f, -1.5000014f, 0.76171875f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 6.4019246f, -1.5000014f, 0.76171875f, 0.09765625f);
			faces[36] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.6725574f, -1.3437513f, 0.76171875f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 6.6725574f, -1.3437513f, 0.76171875f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 6.3125f, -4.6989743E-7f, 0.7578125f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 6.3125f, -4.6989743E-7f, 0.7578125f, 0.1015625f);
			faces[37] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 6.4019246f, -1.5000014f, 0.76171875f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 6.4019246f, -1.5000014f, 0.76171875f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 7.500001f, -2.5980768f, 0.765625f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 7.500001f, -2.5980768f, 0.765625f, 0.09765625f);
			faces[38] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 7.656251f, -2.3274438f, 0.765625f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 7.656251f, -2.3274438f, 0.765625f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 6.6725574f, -1.3437513f, 0.76171875f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 6.6725574f, -1.3437513f, 0.76171875f, 0.1015625f);
			faces[39] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 7.500001f, -2.5980768f, 0.765625f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 7.500001f, -2.5980768f, 0.765625f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 9.000001f, -3.0f, 0.76953125f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 9.000001f, -3.0f, 0.76953125f, 0.09765625f);
			faces[40] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 9.000001f, -2.6875f, 0.76953125f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 9.000001f, -2.6875f, 0.76953125f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 7.656251f, -2.3274438f, 0.765625f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 7.656251f, -2.3274438f, 0.765625f, 0.1015625f);
			faces[41] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 9.000001f, -3.0f, 0.76953125f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 9.000001f, -3.0f, 0.76953125f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 10.500001f, -2.5980759f, 0.7734375f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 10.500001f, -2.5980759f, 0.7734375f, 0.09765625f);
			faces[42] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 10.343751f, -2.327443f, 0.7734375f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 10.343751f, -2.327443f, 0.7734375f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 9.000001f, -2.6875f, 0.76953125f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 9.000001f, -2.6875f, 0.76953125f, 0.1015625f);
			faces[43] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 10.500001f, -2.5980759f, 0.7734375f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 10.500001f, -2.5980759f, 0.7734375f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 11.598076f, -1.4999996f, 0.77734375f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 11.598076f, -1.4999996f, 0.77734375f, 0.09765625f);
			faces[44] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 11.327443f, -1.3437496f, 0.77734375f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 11.327443f, -1.3437496f, 0.77734375f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 10.343751f, -2.327443f, 0.7734375f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 10.343751f, -2.327443f, 0.7734375f, 0.1015625f);
			faces[45] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 11.598076f, -1.4999996f, 0.77734375f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.5313f, 11.598076f, -1.4999996f, 0.77734375f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.5313f, 12.0f, 2.6226834E-7f, 0.78125f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.5938f, 12.0f, 2.6226834E-7f, 0.78125f, 0.09765625f);
			faces[46] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.5938f, 11.6875f, 2.3494871E-7f, 0.78125f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.5313f, 11.6875f, 2.3494871E-7f, 0.78125f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.5313f, 11.327443f, -1.3437496f, 0.77734375f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.5938f, 11.327443f, -1.3437496f, 0.77734375f, 0.1015625f);
			faces[47] = new TexturedPolygon(vertices);
			//
			Signal[10].copyTo(new TexturedVertex[0], faces);
		}//LEGACY CONVERTER END
		...
		{//LEGACY CONVERTER START
			TexturedPolygon[] faces = new TexturedPolygon[48]; TexturedVertex[] vertices = null;
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 11.598076f, 1.5000006f, 0.7011719f, 0.096086234f);
			vertices[1] = new TexturedVertex(3.4688f, 11.327443f, 1.3437505f, 0.7001953f, 0.09439478f);
			vertices[2] = new TexturedVertex(3.4688f, 11.6875f, 2.3494871E-7f, 0.6953125f, 0.095703125f);
			vertices[3] = new TexturedVertex(3.4688f, 12.0f, 2.6226834E-7f, 0.6953125f, 0.09765625f);
			faces[0] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 10.5f, 2.5980763f, 0.70546126f, 0.091796875f);
			vertices[1] = new TexturedVertex(3.4688f, 10.34375f, 2.3274434f, 0.7037698f, 0.09082031f);
			vertices[2] = new TexturedVertex(3.4688f, 11.327443f, 1.3437505f, 0.7001953f, 0.09439478f);
			vertices[3] = new TexturedVertex(3.4688f, 11.598076f, 1.5000006f, 0.7011719f, 0.096086234f);
			faces[1] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 9.0f, 3.0f, 0.70703125f, 0.0859375f);
			vertices[1] = new TexturedVertex(3.4688f, 9.0f, 2.6875f, 0.7050781f, 0.0859375f);
			vertices[2] = new TexturedVertex(3.4688f, 10.34375f, 2.3274434f, 0.7037698f, 0.09082031f);
			vertices[3] = new TexturedVertex(3.4688f, 10.5f, 2.5980763f, 0.70546126f, 0.091796875f);
			faces[2] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 7.5f, 2.5980763f, 0.70546126f, 0.080078125f);
			vertices[1] = new TexturedVertex(3.4688f, 7.65625f, 2.3274434f, 0.7037698f, 0.08105469f);
			vertices[2] = new TexturedVertex(3.4688f, 9.0f, 2.6875f, 0.7050781f, 0.0859375f);
			vertices[3] = new TexturedVertex(3.4688f, 9.0f, 3.0f, 0.70703125f, 0.0859375f);
			faces[3] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.401924f, 1.5000005f, 0.7011719f, 0.075788766f);
			vertices[1] = new TexturedVertex(3.4688f, 6.672557f, 1.3437505f, 0.7001953f, 0.07748022f);
			vertices[2] = new TexturedVertex(3.4688f, 7.65625f, 2.3274434f, 0.7037698f, 0.08105469f);
			vertices[3] = new TexturedVertex(3.4688f, 7.5f, 2.5980763f, 0.70546126f, 0.080078125f);
			faces[4] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.0f, -5.245367E-7f, 0.6953125f, 0.07421875f);
			vertices[1] = new TexturedVertex(3.4688f, 6.3125f, -4.6989743E-7f, 0.6953125f, 0.076171875f);
			vertices[2] = new TexturedVertex(3.4688f, 6.672557f, 1.3437505f, 0.7001953f, 0.07748022f);
			vertices[3] = new TexturedVertex(3.4688f, 6.401924f, 1.5000005f, 0.7011719f, 0.075788766f);
			faces[5] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.4019246f, -1.5000014f, 0.6894531f, 0.075788766f);
			vertices[1] = new TexturedVertex(3.4688f, 6.6725574f, -1.3437513f, 0.6904297f, 0.07748022f);
			vertices[2] = new TexturedVertex(3.4688f, 6.3125f, -4.6989743E-7f, 0.6953125f, 0.076171875f);
			vertices[3] = new TexturedVertex(3.4688f, 6.0f, -5.245367E-7f, 0.6953125f, 0.07421875f);
			faces[6] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 7.500001f, -2.5980768f, 0.68516374f, 0.080078125f);
			vertices[1] = new TexturedVertex(3.4688f, 7.656251f, -2.3274438f, 0.6868552f, 0.08105469f);
			vertices[2] = new TexturedVertex(3.4688f, 6.6725574f, -1.3437513f, 0.6904297f, 0.07748022f);
			vertices[3] = new TexturedVertex(3.4688f, 6.4019246f, -1.5000014f, 0.6894531f, 0.075788766f);
			faces[7] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 9.000001f, -3.0f, 0.68359375f, 0.0859375f);
			vertices[1] = new TexturedVertex(3.4688f, 9.000001f, -2.6875f, 0.6855469f, 0.0859375f);
			vertices[2] = new TexturedVertex(3.4688f, 7.656251f, -2.3274438f, 0.6868552f, 0.08105469f);
			vertices[3] = new TexturedVertex(3.4688f, 7.500001f, -2.5980768f, 0.68516374f, 0.080078125f);
			faces[8] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 10.500001f, -2.5980759f, 0.68516374f, 0.091796875f);
			vertices[1] = new TexturedVertex(3.4688f, 10.343751f, -2.327443f, 0.6868552f, 0.09082031f);
			vertices[2] = new TexturedVertex(3.4688f, 9.000001f, -2.6875f, 0.6855469f, 0.0859375f);
			vertices[3] = new TexturedVertex(3.4688f, 9.000001f, -3.0f, 0.68359375f, 0.0859375f);
			faces[9] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 11.598076f, -1.4999996f, 0.6894531f, 0.096086234f);
			vertices[1] = new TexturedVertex(3.4688f, 11.327443f, -1.3437496f, 0.6904297f, 0.09439478f);
			vertices[2] = new TexturedVertex(3.4688f, 10.343751f, -2.327443f, 0.6868552f, 0.09082031f);
			vertices[3] = new TexturedVertex(3.4688f, 10.500001f, -2.5980759f, 0.68516374f, 0.091796875f);
			faces[10] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 12.0f, 2.6226834E-7f, 0.6953125f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4688f, 11.6875f, 2.3494871E-7f, 0.6953125f, 0.095703125f);
			vertices[2] = new TexturedVertex(3.4688f, 11.327443f, -1.3437496f, 0.6904297f, 0.09439478f);
			vertices[3] = new TexturedVertex(3.4688f, 11.598076f, -1.4999996f, 0.6894531f, 0.096086234f);
			faces[11] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 12.0f, 2.6226834E-7f, 0.71875f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 11.6875f, 2.3494871E-7f, 0.71875f, 0.095703125f);
			vertices[2] = new TexturedVertex(3.4063f, 11.327443f, 1.3437505f, 0.7236328f, 0.09439478f);
			vertices[3] = new TexturedVertex(3.4063f, 11.598076f, 1.5000006f, 0.7246094f, 0.096086234f);
			faces[12] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 11.598076f, 1.5000006f, 0.7246094f, 0.096086234f);
			vertices[1] = new TexturedVertex(3.4063f, 11.327443f, 1.3437505f, 0.7236328f, 0.09439478f);
			vertices[2] = new TexturedVertex(3.4063f, 10.34375f, 2.3274434f, 0.7272073f, 0.09082031f);
			vertices[3] = new TexturedVertex(3.4063f, 10.5f, 2.5980763f, 0.72889876f, 0.091796875f);
			faces[13] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 10.5f, 2.5980763f, 0.72889876f, 0.091796875f);
			vertices[1] = new TexturedVertex(3.4063f, 10.34375f, 2.3274434f, 0.7272073f, 0.09082031f);
			vertices[2] = new TexturedVertex(3.4063f, 9.0f, 2.6875f, 0.7285156f, 0.0859375f);
			vertices[3] = new TexturedVertex(3.4063f, 9.0f, 3.0f, 0.73046875f, 0.0859375f);
			faces[14] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 9.0f, 3.0f, 0.73046875f, 0.0859375f);
			vertices[1] = new TexturedVertex(3.4063f, 9.0f, 2.6875f, 0.7285156f, 0.0859375f);
			vertices[2] = new TexturedVertex(3.4063f, 7.65625f, 2.3274434f, 0.7272073f, 0.08105469f);
			vertices[3] = new TexturedVertex(3.4063f, 7.5f, 2.5980763f, 0.72889876f, 0.080078125f);
			faces[15] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 7.5f, 2.5980763f, 0.72889876f, 0.080078125f);
			vertices[1] = new TexturedVertex(3.4063f, 7.65625f, 2.3274434f, 0.7272073f, 0.08105469f);
			vertices[2] = new TexturedVertex(3.4063f, 6.672557f, 1.3437505f, 0.7236328f, 0.07748022f);
			vertices[3] = new TexturedVertex(3.4063f, 6.401924f, 1.5000005f, 0.7246094f, 0.075788766f);
			faces[16] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 6.401924f, 1.5000005f, 0.7246094f, 0.075788766f);
			vertices[1] = new TexturedVertex(3.4063f, 6.672557f, 1.3437505f, 0.7236328f, 0.07748022f);
			vertices[2] = new TexturedVertex(3.4063f, 6.3125f, -4.6989743E-7f, 0.71875f, 0.076171875f);
			vertices[3] = new TexturedVertex(3.4063f, 6.0f, -5.245367E-7f, 0.71875f, 0.07421875f);
			faces[17] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 6.0f, -5.245367E-7f, 0.71875f, 0.07421875f);
			vertices[1] = new TexturedVertex(3.4063f, 6.3125f, -4.6989743E-7f, 0.71875f, 0.076171875f);
			vertices[2] = new TexturedVertex(3.4063f, 6.6725574f, -1.3437513f, 0.7138672f, 0.07748022f);
			vertices[3] = new TexturedVertex(3.4063f, 6.4019246f, -1.5000014f, 0.7128906f, 0.075788766f);
			faces[18] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 6.4019246f, -1.5000014f, 0.7128906f, 0.075788766f);
			vertices[1] = new TexturedVertex(3.4063f, 6.6725574f, -1.3437513f, 0.7138672f, 0.07748022f);
			vertices[2] = new TexturedVertex(3.4063f, 7.656251f, -2.3274438f, 0.7102927f, 0.08105469f);
			vertices[3] = new TexturedVertex(3.4063f, 7.500001f, -2.5980768f, 0.70860124f, 0.080078125f);
			faces[19] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 7.500001f, -2.5980768f, 0.70860124f, 0.080078125f);
			vertices[1] = new TexturedVertex(3.4063f, 7.656251f, -2.3274438f, 0.7102927f, 0.08105469f);
			vertices[2] = new TexturedVertex(3.4063f, 9.000001f, -2.6875f, 0.7089844f, 0.0859375f);
			vertices[3] = new TexturedVertex(3.4063f, 9.000001f, -3.0f, 0.70703125f, 0.0859375f);
			faces[20] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 9.000001f, -3.0f, 0.70703125f, 0.0859375f);
			vertices[1] = new TexturedVertex(3.4063f, 9.000001f, -2.6875f, 0.7089844f, 0.0859375f);
			vertices[2] = new TexturedVertex(3.4063f, 10.343751f, -2.327443f, 0.7102927f, 0.09082031f);
			vertices[3] = new TexturedVertex(3.4063f, 10.500001f, -2.5980759f, 0.70860124f, 0.091796875f);
			faces[21] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 10.500001f, -2.5980759f, 0.70860124f, 0.091796875f);
			vertices[1] = new TexturedVertex(3.4063f, 10.343751f, -2.327443f, 0.7102927f, 0.09082031f);
			vertices[2] = new TexturedVertex(3.4063f, 11.327443f, -1.3437496f, 0.7138672f, 0.09439478f);
			vertices[3] = new TexturedVertex(3.4063f, 11.598076f, -1.4999996f, 0.7128906f, 0.096086234f);
			faces[22] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4063f, 11.598076f, -1.4999996f, 0.7128906f, 0.096086234f);
			vertices[1] = new TexturedVertex(3.4063f, 11.327443f, -1.3437496f, 0.7138672f, 0.09439478f);
			vertices[2] = new TexturedVertex(3.4063f, 11.6875f, 2.3494871E-7f, 0.71875f, 0.095703125f);
			vertices[3] = new TexturedVertex(3.4063f, 12.0f, 2.6226834E-7f, 0.71875f, 0.09765625f);
			faces[23] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 12.0f, 2.6226834E-7f, 0.68359375f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 12.0f, 2.6226834E-7f, 0.68359375f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 11.598076f, 1.5000006f, 0.6875f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 11.598076f, 1.5000006f, 0.6875f, 0.09765625f);
			faces[24] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 11.327443f, 1.3437505f, 0.6875f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 11.327443f, 1.3437505f, 0.6875f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 11.6875f, 2.3494871E-7f, 0.68359375f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 11.6875f, 2.3494871E-7f, 0.68359375f, 0.1015625f);
			faces[25] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 11.598076f, 1.5000006f, 0.6875f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 11.598076f, 1.5000006f, 0.6875f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 10.5f, 2.5980763f, 0.69140625f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 10.5f, 2.5980763f, 0.69140625f, 0.09765625f);
			faces[26] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 10.34375f, 2.3274434f, 0.69140625f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 10.34375f, 2.3274434f, 0.69140625f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 11.327443f, 1.3437505f, 0.6875f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 11.327443f, 1.3437505f, 0.6875f, 0.1015625f);
			faces[27] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 10.5f, 2.5980763f, 0.69140625f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 10.5f, 2.5980763f, 0.69140625f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 9.0f, 3.0f, 0.6953125f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 9.0f, 3.0f, 0.6953125f, 0.09765625f);
			faces[28] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 9.0f, 2.6875f, 0.6953125f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 9.0f, 2.6875f, 0.6953125f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 10.34375f, 2.3274434f, 0.69140625f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 10.34375f, 2.3274434f, 0.69140625f, 0.1015625f);
			faces[29] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 9.0f, 3.0f, 0.6953125f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 9.0f, 3.0f, 0.6953125f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 7.5f, 2.5980763f, 0.69921875f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 7.5f, 2.5980763f, 0.69921875f, 0.09765625f);
			faces[30] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 7.65625f, 2.3274434f, 0.69921875f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 7.65625f, 2.3274434f, 0.69921875f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 9.0f, 2.6875f, 0.6953125f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 9.0f, 2.6875f, 0.6953125f, 0.1015625f);
			faces[31] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 7.5f, 2.5980763f, 0.69921875f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 7.5f, 2.5980763f, 0.69921875f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 6.401924f, 1.5000005f, 0.703125f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 6.401924f, 1.5000005f, 0.703125f, 0.09765625f);
			faces[32] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.672557f, 1.3437505f, 0.703125f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 6.672557f, 1.3437505f, 0.703125f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 7.65625f, 2.3274434f, 0.69921875f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 7.65625f, 2.3274434f, 0.69921875f, 0.1015625f);
			faces[33] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.401924f, 1.5000005f, 0.703125f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 6.401924f, 1.5000005f, 0.703125f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 6.0f, -5.245367E-7f, 0.70703125f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 6.0f, -5.245367E-7f, 0.70703125f, 0.09765625f);
			faces[34] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.3125f, -4.6989743E-7f, 0.70703125f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 6.3125f, -4.6989743E-7f, 0.70703125f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 6.672557f, 1.3437505f, 0.703125f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 6.672557f, 1.3437505f, 0.703125f, 0.1015625f);
			faces[35] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.0f, -5.245367E-7f, 0.70703125f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 6.0f, -5.245367E-7f, 0.70703125f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 6.4019246f, -1.5000014f, 0.7109375f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 6.4019246f, -1.5000014f, 0.7109375f, 0.09765625f);
			faces[36] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.6725574f, -1.3437513f, 0.7109375f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 6.6725574f, -1.3437513f, 0.7109375f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 6.3125f, -4.6989743E-7f, 0.70703125f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 6.3125f, -4.6989743E-7f, 0.70703125f, 0.1015625f);
			faces[37] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 6.4019246f, -1.5000014f, 0.7109375f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 6.4019246f, -1.5000014f, 0.7109375f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 7.500001f, -2.5980768f, 0.71484375f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 7.500001f, -2.5980768f, 0.71484375f, 0.09765625f);
			faces[38] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 7.656251f, -2.3274438f, 0.71484375f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 7.656251f, -2.3274438f, 0.71484375f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 6.6725574f, -1.3437513f, 0.7109375f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 6.6725574f, -1.3437513f, 0.7109375f, 0.1015625f);
			faces[39] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 7.500001f, -2.5980768f, 0.71484375f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 7.500001f, -2.5980768f, 0.71484375f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 9.000001f, -3.0f, 0.71875f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 9.000001f, -3.0f, 0.71875f, 0.09765625f);
			faces[40] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 9.000001f, -2.6875f, 0.71875f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 9.000001f, -2.6875f, 0.71875f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 7.656251f, -2.3274438f, 0.71484375f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 7.656251f, -2.3274438f, 0.71484375f, 0.1015625f);
			faces[41] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 9.000001f, -3.0f, 0.71875f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 9.000001f, -3.0f, 0.71875f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 10.500001f, -2.5980759f, 0.72265625f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 10.500001f, -2.5980759f, 0.72265625f, 0.09765625f);
			faces[42] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 10.343751f, -2.327443f, 0.72265625f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 10.343751f, -2.327443f, 0.72265625f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 9.000001f, -2.6875f, 0.71875f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 9.000001f, -2.6875f, 0.71875f, 0.1015625f);
			faces[43] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 10.500001f, -2.5980759f, 0.72265625f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 10.500001f, -2.5980759f, 0.72265625f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 11.598076f, -1.4999996f, 0.7265625f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 11.598076f, -1.4999996f, 0.7265625f, 0.09765625f);
			faces[44] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 11.327443f, -1.3437496f, 0.7265625f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 11.327443f, -1.3437496f, 0.7265625f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 10.343751f, -2.327443f, 0.72265625f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 10.343751f, -2.327443f, 0.72265625f, 0.1015625f);
			faces[45] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 11.598076f, -1.4999996f, 0.7265625f, 0.09765625f);
			vertices[1] = new TexturedVertex(3.4063f, 11.598076f, -1.4999996f, 0.7265625f, 0.1015625f);
			vertices[2] = new TexturedVertex(3.4063f, 12.0f, 2.6226834E-7f, 0.73046875f, 0.1015625f);
			vertices[3] = new TexturedVertex(3.4688f, 12.0f, 2.6226834E-7f, 0.73046875f, 0.09765625f);
			faces[46] = new TexturedPolygon(vertices);
			vertices = new TexturedVertex[4];
			vertices[0] = new TexturedVertex(3.4688f, 11.6875f, 2.3494871E-7f, 0.73046875f, 0.1015625f);
			vertices[1] = new TexturedVertex(3.4063f, 11.6875f, 2.3494871E-7f, 0.73046875f, 0.10546875f);
			vertices[2] = new TexturedVertex(3.4063f, 11.327443f, -1.3437496f, 0.7265625f, 0.10546875f);
			vertices[3] = new TexturedVertex(3.4688f, 11.327443f, -1.3437496f, 0.7265625f, 0.1015625f);
			faces[47] = new TexturedPolygon(vertices);
			//
			Signal[12].copyTo(new TexturedVertex[0], faces);
		}//LEGACY CONVERTER END
