...
public class ModelBridgePillar extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[3] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 6
		...
		bodyModel[6] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 9
		bodyModel[7] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 10
		bodyModel[8] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 11
		bodyModel[9] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 12
		bodyModel[10] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 13
		bodyModel[11] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 14
		...
		bodyModel[0].setRotationPoint(-6.4F, -8F, -6.4F);
		...
		bodyModel[1].setRotationPoint(-6.4F, 3.6F, -8F);
		...
		bodyModel[2].setRotationPoint(-6.4F, -5.6F, -8F);
		...
		bodyModel[3].setRotationPoint(-6.4F, -8F, 3.4F);
		...
		bodyModel[4].setRotationPoint(-8F, -5.6F, -6.4F);
		...
		bodyModel[5].setRotationPoint(-8F, -5.6F, 3.4F);
		...
		bodyModel[6].setRotationPoint(-8F, 3.6F, -6.4F);
		...
		bodyModel[7].setRotationPoint(-8F, 3.6F, 3.4F);
		...
		bodyModel[8].setRotationPoint(3.4F, 3.6F, -8F);
		...
		bodyModel[9].setRotationPoint(3.4F, -5.6F, -8F);
		...
		bodyModel[10].setRotationPoint(3.4F, -8F, -6.4F);
		...
		bodyModel[11].setRotationPoint(3.4F, -8F, 3.4F);
	}
}