...
public class EntityTender_C41 extends GenericRailTransport {
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{0.1f, 0.2f, 0.0f}};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/C41Tender.png","C41Tender", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{0.875f,2.1f,1.1f};}
    @Override
