...
@Override
    ...
    public ItemStack[] getRecipe() {
        return new ItemStack[]{
                new ItemStack(TiMOres.ingotSteel, 2), new ItemStack(TiMItems.wheelWood, 2), new ItemStack(TiMItems.frameSteel, 2),
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{4.4f,2.15f,1.4f};}
    @Override
    public float[] rotationPoints() {return new float[]{1.25f, -1.275f};}
