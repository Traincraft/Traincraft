...
public class EntityTenderGS4 extends GenericRailTransport {
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{0.1f, 0f, 0.05f}};}
    @Override
    ...
    public ItemStack[] getRecipe() {
        return new ItemStack[]{
                new ItemStack(Items.coal, 2), new ItemStack(TiMItems.wheelSteel, 2), new ItemStack(TiMItems.frameSteel, 1),
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{5.1f,2.4f,1.5f};}
    @Override
