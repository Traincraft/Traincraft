...
public class EntityPassengerRheingoldPanorama extends GenericRailTransport {
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/Rheingold_passenger_panorama_Blue.png","Blue", description));
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/Rheingold_passenger_panorama_Red.png","Red", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{1.975000023841858f,2.1f,1.1f};}
    @Override
