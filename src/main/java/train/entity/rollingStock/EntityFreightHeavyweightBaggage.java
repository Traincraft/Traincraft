...
public class EntityFreightHeavyweightBaggage extends GenericRailTransport {
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{0.0f, 0.03f, 0f}};}
    @Override
    ...
    public ItemStack[] getRecipe() {
        return new ItemStack[]{
                new ItemStack(TiMOres.ingotSteel, 4), new ItemStack(TiMItems.wheelSteel, 2), new ItemStack(TiMItems.frameSteel, 2),
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{10.35f,2.6f,1.4f};}
    @Override
    public float[] rotationPoints() {return new float[]{3.8f, -3.7f};}
