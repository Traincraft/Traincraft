...
public class EntityFreightHeavyweightBaggage extends GenericRailTransport {
    ...
    @Override
    public float[][] modelOffsets(){return new float[][]{{0.0f, 0.1f, -0.05f}};}
    @Override
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/heavyweightBoxcar_Red.png","Red", description));
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/heavyweightBoxcar_Grey.png","Grey", description));
    }
    @Override
