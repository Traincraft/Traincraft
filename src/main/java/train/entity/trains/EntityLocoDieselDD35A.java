...
public class EntityLocoDieselDD35A extends EntityTrainCore {
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/dd35a_Orange.png","Orange", description));
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/dd35a_Black.png","Black", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-4.100000023841858f,2.1f,1.1f};}
    @Override
