...
public class EntityLocoSteamCoranationClass extends EntityTrainCore {
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),
            new skin(Info.modID,"textures/trains/CoranationClass.png","CoranationClass", description));
    }
    @Override
    ...
    @Override
    public float[] getHitboxSize(){return new float[]{-5.550000011920929f,2.1f,1.1f};}
    @Override
