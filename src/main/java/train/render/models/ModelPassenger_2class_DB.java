...
import train.render.models.blocks.ModelLights;
...
public class ModelPassenger_2class_DB extends ModelBase {
	...
	public ModelPassenger_2class_DB() {
		...
		box49 = new CustomModelRenderer(this, 121, 55, 256, 128);
		...
		box51 = new CustomModelRenderer(this, 124, 75, 256, 128);
		...
		box62 = new CustomModelRenderer(this, 175, 62, 256, 128);
