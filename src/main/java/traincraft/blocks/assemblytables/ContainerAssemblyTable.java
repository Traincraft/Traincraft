...
public class ContainerAssemblyTable extends Container {
    ...
    public ContainerAssemblyTable(InventoryPlayer playerInventory, World thisWorld, TileAssemblyTable tileAssemblyTable) {
        ...
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 0, 25, 27));
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 1, 79, 27));
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 2, 115, 27));
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 3, 145, 27));
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 4, 25, 61));
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 5, 79, 61));
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 6, 115, 61));
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 7, 43, 93)); //play around
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 8, 79, 93));
        this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getCraftingInventory(), 9, 145, 93));

        //create the assembly table storage slots
        for (int i = 0; i < 2; ++i) {
            for (int j = 0; j < 4; ++j) {
                this.addSlotToContainer(new SlotItemHandler(tileAssemblyTable.getStorageInventory(), j + i * 4, 8 + j * 18, (128) + i * 18));
            }
        }
        ...
        for (int i = 0; i < 2; ++i) {
            for (int j = 0; j < 4; ++j) {
                this.addSlotToContainer(new SlotCraftingResult(playerInventory.player, tileAssemblyTable.getCraftingInventory(), tileAssemblyTable.getOutputInventory(), j + i * 4, 92 + j * 18, (128) + i * 18));
            }
        }
