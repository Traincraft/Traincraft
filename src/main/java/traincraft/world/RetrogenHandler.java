 ...
 *
 * This file ("RetrogenHandler.java") is part of the Traincraft mod for Minecraft.
            ...
            if(event.phase == TickEvent.Phase.END){
                for(Chunk chunk : (ArrayList<Chunk>) chunksToRetroGen.clone()){
                    ...
                    if(chunk.getWorld() instanceof WorldServer){
                        ...
                        WorldGenWorld.INSTANCE.generate(rand, chunk.x, chunk.z, world, world.getChunkProvider().chunkGenerator, world.getChunkProvider());
