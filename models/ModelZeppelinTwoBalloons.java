...
public class ModelZeppelinTwoBalloons extends ModelBase {
	...
	public ModelZeppelinTwoBalloons() {
		l = 24;
		zepSides = new ModelRendererTurbo[l];

		lastframe = System.nanoTime();
		helice = 0.0F;

		zepSides[2] = new ModelRendererTurbo(this, 5, 127, 512, 256);
		zepSides[11] = new ModelRendererTurbo(this, 24, 137, 512, 256);
		zepSides[22] = new ModelRendererTurbo(this, 246, 17, 512, 256);
		zepSides[19] = new ModelRendererTurbo(this, 103, 144, 512, 256);
		zepSides[0] = new ModelRendererTurbo(this, 1, 71, 512, 256);
		zepSides[13] = new ModelRendererTurbo(this, 4, 116, 512, 256);
		zepSides[21] = new ModelRendererTurbo(this, 394, 133, 512, 256);
		zepSides[9] = new ModelRendererTurbo(this, 2, 42, 512, 256);
		zepSides[7] = new ModelRendererTurbo(this, 133, 2, 512, 256);
		zepSides[14] = new ModelRendererTurbo(this, 104, 83, 512, 256);
		zepSides[20] = new ModelRendererTurbo(this, 103, 144, 512, 256);
		zepSides[5] = new ModelRendererTurbo(this, 104, 131, 512, 256);
		zepSides[10] = new ModelRendererTurbo(this, 100, 99, 512, 256);
		zepSides[23] = new ModelRendererTurbo(this, 1, 72, 512, 256);
		zepSides[18] = new ModelRendererTurbo(this, 105, 82, 512, 256);
		zepSides[12] = new ModelRendererTurbo(this, 4, 116, 512, 256);
		zepSides[3] = new ModelRendererTurbo(this, 5, 127, 512, 256);
		zepSides[16] = new ModelRendererTurbo(this, 4, 116, 512, 256);
		zepSides[6] = new ModelRendererTurbo(this, 133, 2, 512, 256);
		zepSides[4] = new ModelRendererTurbo(this, 101, 130, 512, 256);
		zepSides[8] = new ModelRendererTurbo(this, 98, 87, 512, 256);
		zepSides[15] = new ModelRendererTurbo(this, 4, 116, 512, 256);
		zepSides[1] = new ModelRendererTurbo(this, 1, 79, 512, 256);
		zepSides[17] = new ModelRendererTurbo(this, 246, 17, 512, 256);
	...
	public ModelRendererTurbo zepSides[];
