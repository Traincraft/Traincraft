...
public class ModelSmallFreightCart extends ModelBase {
	...
	public ModelSmallFreightCart() {
		...
		roof = new ModelRendererTurbo(this, 118, 61, 256, 128);
		roof.mirror = true;
		roof.addBox(0F, 0F, 0F, 16, 1, 42);
		roof.setPosition(22F, 25F, -8F);
		roof.rotateAngleY = -1.5707963267948966F;

		top = new ModelRendererTurbo(this, 115, 17, 256, 128);
		top.mirror = true;
	...
	// variables init:
	public ModelRendererTurbo attach;
	public ModelRendererTurbo bogey;
	public ModelRendererTurbo bogeyframe;
	...
	public ModelRendererTurbo carbase;
	public ModelRendererTurbo freightbox;
	public ModelRendererTurbo roof;
	public ModelRendererTurbo top;
